...
test("a.console.info", function() {
	...
	strictEqual(trace["info"][0], "one information", "Testing information trace");
	strictEqual(trace["info"][1], "second information", "Testing information trace");
	strictEqual(trace["info"][2], "third information", "Testing information trace");
});
...
test("a.console.trace", function() {
	...
	// Now we send more than 2000 request on log, we check the trace remove too old data
