...
a.language = (function() {
    ...
    var storageSupported = (!a.isNone(a.storage) && a.storage.persistent.support === true);
            ...
            if(text.indexOf("{{") >= 0 && text.indexOf("}}") >= 0) {
                ...
                for(var g=0, h=varList.length; g<h; ++g) {
                    var element = __convertVariable(varList[g]),
                        ...
                        global  = (a.isNone(__global[name])) ? null : __global[name];
        ...
        for(var e=0, f=ett.length; e<f; ++e) {
            ...
            if(!a.isNone(hash)) {
                ...
                if(!a.isNone(customTag)) {
                    ...
                    // We try using DOM
                    } else if(!a.isNone(node.childNodes)) {
