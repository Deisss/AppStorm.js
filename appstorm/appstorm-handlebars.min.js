(function(){var c=this,b=c._,d={},f=Array.prototype,g=Object.prototype,m=f.push,n=f.slice,t=f.concat,q=g.toString,l=g.hasOwnProperty,y=f.forEach,w=f.map,p=f.reduce,x=f.reduceRight,e=f.filter,r=f.every,k=f.some,s=f.indexOf,B=f.lastIndexOf,g=Array.isArray,v=Object.keys,u=Function.prototype.bind,h=function(b){return b instanceof h?b:this instanceof h?(this._wrapped=b,void 0):new h(b)};"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=h),exports._=h):c._=
h;h.VERSION="1.5.2";var A=h.each=h.forEach=function(b,e,c){if(null!=b)if(y&&b.forEach===y)b.forEach(e,c);else if(b.length===+b.length)for(var k=0,l=b.length;l>k&&e.call(c,b[k],k,b)!==d;k++);else for(var r=h.keys(b),k=0,l=r.length;l>k&&e.call(c,b[r[k]],r[k],b)!==d;k++);};h.map=h.collect=function(b,e,c){var k=[];return null==b?k:w&&b.map===w?b.map(e,c):(A(b,function(b,F,h){k.push(e.call(c,b,F,h))}),k)};h.reduce=h.foldl=h.inject=function(b,e,c,k){var d=2<arguments.length;if(null==b&&(b=[]),p&&b.reduce===
p)return k&&(e=h.bind(e,k)),d?b.reduce(e,c):b.reduce(e);if(A(b,function(b,F,h){d?c=e.call(k,c,b,F,h):(c=b,d=!0)}),!d)throw new TypeError("Reduce of empty array with no initial value");return c};h.reduceRight=h.foldr=function(b,e,c,k){var d=2<arguments.length;if(null==b&&(b=[]),x&&b.reduceRight===x)return k&&(e=h.bind(e,k)),d?b.reduceRight(e,c):b.reduceRight(e);var l=b.length;if(l!==+l)var r=h.keys(b),l=r.length;if(A(b,function(h,s,p){s=r?r[--l]:--l;d?c=e.call(k,c,b[s],s,p):(c=b[s],d=!0)}),!d)throw new TypeError("Reduce of empty array with no initial value");
return c};h.find=h.detect=function(b,e,c){var k;return D(b,function(b,F,h){return e.call(c,b,F,h)?(k=b,!0):void 0}),k};h.filter=h.select=function(b,c,k){var h=[];return null==b?h:e&&b.filter===e?b.filter(c,k):(A(b,function(b,e,F){c.call(k,b,e,F)&&h.push(b)}),h)};h.reject=function(b,e,c){return h.filter(b,function(b,k,F){return!e.call(c,b,k,F)},c)};h.every=h.all=function(b,e,c){e||(e=h.identity);var k=!0;return null==b?k:r&&b.every===r?b.every(e,c):(A(b,function(b,F,h){return(k=k&&e.call(c,b,F,h))?
void 0:d}),!!k)};var D=h.some=h.any=function(b,e,c){e||(e=h.identity);var l=!1;return null==b?l:k&&b.some===k?b.some(e,c):(A(b,function(b,k,h){return l||(l=e.call(c,b,k,h))?d:void 0}),!!l)};h.contains=h.include=function(b,e){return null==b?!1:s&&b.indexOf===s?-1!=b.indexOf(e):D(b,function(b){return b===e})};h.invoke=function(b,e){var c=n.call(arguments,2),k=h.isFunction(e);return h.map(b,function(b){return(k?e:b[e]).apply(b,c)})};h.pluck=function(b,e){return h.map(b,function(b){return b[e]})};h.where=
...
e,c){var k=C(e);return h.pluck(h.map(b,function(b,e,h){return{value:b,index:e,criteria:k.call(c,b,e,h)}}).sort(function(b,e){var c=b.criteria,k=e.criteria;if(c!==k){if(c>k||void 0===c)return 1;if(k>c||void 0===k)return-1}return b.index-e.index}),"value")};var z=function(b){return function(e,c,k){var d={},l=null==c?h.identity:C(c);return A(e,function(c,h){var r=l.call(k,c,h,e);b(d,r,c)}),d}};h.groupBy=z(function(b,e,c){(h.has(b,e)?b[e]:b[e]=[]).push(c)});h.indexBy=z(function(b,e,c){b[e]=c});h.countBy=
z(function(b,e){h.has(b,e)?b[e]++:b[e]=1});h.sortedIndex=function(b,e,c,k){c=null==c?h.identity:C(c);e=c.call(k,e);for(var d=0,l=b.length;l>d;){var r=d+l>>>1;c.call(k,b[r])<e?d=r+1:l=r}return d};h.toArray=function(b){return b?h.isArray(b)?n.call(b):b.length===+b.length?h.map(b,h.identity):h.values(b):[]};h.size=function(b){return null==b?0:b.length===+b.length?b.length:h.keys(b).length};h.first=h.head=h.take=function(b,e,c){return null==b?void 0:null==e||c?b[0]:n.call(b,0,e)};h.initial=function(b,
e,c){return n.call(b,0,b.length-(null==e||c?1:e))};h.last=function(b,e,c){return null==b?void 0:null==e||c?b[b.length-1]:n.call(b,Math.max(b.length-e,0))};h.rest=h.tail=h.drop=function(b,e,c){return n.call(b,null==e||c?1:e)};h.compact=function(b){return h.filter(b,h.identity)};var E=function(b,e,c){return e&&h.every(b,h.isArray)?t.apply(c,b):(A(b,function(b){h.isArray(b)||h.isArguments(b)?e?m.apply(c,b):E(b,e,c):c.push(b)}),c)};h.flatten=function(b,e){return E(b,e,[])};h.without=function(b){return h.difference(b,
n.call(arguments,1))};h.uniq=h.unique=function(b,e,c,k){h.isFunction(e)&&(k=c,c=e,e=!1);c=c?h.map(b,c,k):b;var d=[],l=[];return A(c,function(c,k){(e?k&&l[l.length-1]===c:h.contains(l,c))||(l.push(c),d.push(b[k]))}),d};h.union=function(){return h.uniq(h.flatten(arguments,!0))};h.intersection=function(b){var e=n.call(arguments,1);return h.filter(h.uniq(b),function(b){return h.every(e,function(e){return 0<=h.indexOf(e,b)})})};h.difference=function(b){var e=t.apply(f,n.call(arguments,1));return h.filter(b,
function(b){return!h.contains(e,b)})};h.zip=function(){for(var b=h.max(h.pluck(arguments,"length").concat(0)),e=Array(b),c=0;b>c;c++)e[c]=h.pluck(arguments,""+c);return e};h.object=function(b,e){if(null==b)return{};for(var c={},k=0,h=b.length;h>k;k++)e?c[b[k]]=e[k]:c[b[k][0]]=b[k][1];return c};h.indexOf=function(b,e,c){if(null==b)return-1;var k=0,d=b.length;if(c){if("number"!=typeof c)return k=h.sortedIndex(b,e),b[k]===e?k:-1;k=0>c?Math.max(0,d+c):c}if(s&&b.indexOf===s)return b.indexOf(e,c);for(;d>
k;k++)if(b[k]===e)return k;return-1};h.lastIndexOf=function(b,e,c){if(null==b)return-1;var k=null!=c;if(B&&b.lastIndexOf===B)return k?b.lastIndexOf(e,c):b.lastIndexOf(e);for(c=k?c:b.length;c--;)if(b[c]===e)return c;return-1};h.range=function(b,e,c){1>=arguments.length&&(e=b||0,b=0);c=arguments[2]||1;for(var k=Math.max(Math.ceil((e-b)/c),0),h=0,d=Array(k);k>h;)d[h++]=b,b+=c;return d};var J=function(){};h.bind=function(b,e){var c,k;if(u&&b.bind===u)return u.apply(b,n.call(arguments,1));if(!h.isFunction(b))throw new TypeError;
return c=n.call(arguments,2),k=function(){if(!(this instanceof k))return b.apply(e,c.concat(n.call(arguments)));J.prototype=b.prototype;var h=new J;J.prototype=null;var d=b.apply(h,c.concat(n.call(arguments)));return Object(d)===d?d:h}};h.partial=function(b){var e=n.call(arguments,1);return function(){return b.apply(this,e.concat(n.call(arguments)))}};h.bindAll=function(b){var e=n.call(arguments,1);if(0===e.length)throw Error("bindAll must be passed function names");return A(e,function(e){b[e]=h.bind(b[e],
b)}),b};h.memoize=function(b,e){var c={};return e||(e=h.identity),function(){var k=e.apply(this,arguments);return h.has(c,k)?c[k]:c[k]=b.apply(this,arguments)}};h.delay=function(b,e){var c=n.call(arguments,2);return setTimeout(function(){return b.apply(null,c)},e)};h.defer=function(b){return h.delay.apply(h,[b,1].concat(n.call(arguments,1)))};h.throttle=function(b,e,c){var k,h,d,l=null,r=0;c||(c={});var s=function(){r=!1===c.leading?0:new Date;l=null;d=b.apply(k,h)};return function(){var p=new Date;
r||!1!==c.leading||(r=p);var f=e-(p-r);return k=this,h=arguments,0>=f?(clearTimeout(l),l=null,r=p,d=b.apply(k,h)):l||!1===c.trailing||(l=setTimeout(s,f)),d}};h.debounce=function(b,e,c){var k,h,d,l,r;return function(){d=this;h=arguments;l=new Date;var s=function(){var p=new Date-l;e>p?k=setTimeout(s,e-p):(k=null,c||(r=b.apply(d,h)))},p=c&&!k;return k||(k=setTimeout(s,e)),p&&(r=b.apply(d,h)),r}};h.once=function(b){var e,c=!1;return function(){return c?e:(c=!0,e=b.apply(this,arguments),b=null,e)}};h.wrap=
function(b,e){return function(){var c=[b];return m.apply(c,arguments),e.apply(this,c)}};h.compose=function(){var b=arguments;return function(){for(var e=arguments,c=b.length-1;0<=c;c--)e=[b[c].apply(this,e)];return e[0]}};h.after=function(b,e){return function(){return 1>--b?e.apply(this,arguments):void 0}};h.keys=v||function(b){if(b!==Object(b))throw new TypeError("Invalid object");var e=[],c;for(c in b)h.has(b,c)&&e.push(c);return e};h.values=function(b){for(var e=h.keys(b),c=e.length,k=Array(c),
d=0;c>d;d++)k[d]=b[e[d]];return k};h.pairs=function(b){for(var e=h.keys(b),c=e.length,k=Array(c),d=0;c>d;d++)k[d]=[e[d],b[e[d]]];return k};h.invert=function(b){for(var e={},c=h.keys(b),k=0,d=c.length;d>k;k++)e[b[c[k]]]=c[k];return e};h.functions=h.methods=function(b){var e=[],c;for(c in b)h.isFunction(b[c])&&e.push(c);return e.sort()};h.extend=function(b){return A(n.call(arguments,1),function(e){if(e)for(var c in e)b[c]=e[c]}),b};h.pick=function(b){var e={},c=t.apply(f,n.call(arguments,1));return A(c,
function(c){c in b&&(e[c]=b[c])}),e};h.omit=function(b){var e={},c=t.apply(f,n.call(arguments,1)),k;for(k in b)h.contains(c,k)||(e[k]=b[k]);return e};h.defaults=function(b){return A(n.call(arguments,1),function(e){if(e)for(var c in e)void 0===b[c]&&(b[c]=e[c])}),b};h.clone=function(b){return h.isObject(b)?h.isArray(b)?b.slice():h.extend({},b):b};h.tap=function(b,e){return e(b),b};var K=function(b,e,c,k){if(b===e)return 0!==b||1/b==1/e;if(null==b||null==e)return b===e;b instanceof h&&(b=b._wrapped);
e instanceof h&&(e=e._wrapped);var d=q.call(b);if(d!=q.call(e))return!1;switch(d){case "[object String]":return b==String(e);case "[object Number]":return b!=+b?e!=+e:0==b?1/b==1/e:b==+e;case "[object Date]":case "[object Boolean]":return+b==+e;case "[object RegExp]":return b.source==e.source&&b.global==e.global&&b.multiline==e.multiline&&b.ignoreCase==e.ignoreCase}if("object"!=typeof b||"object"!=typeof e)return!1;for(var l=c.length;l--;)if(c[l]==b)return k[l]==e;var l=b.constructor,r=e.constructor;
if(l!==r&&!(h.isFunction(l)&&l instanceof l&&h.isFunction(r)&&r instanceof r))return!1;c.push(b);k.push(e);l=0;r=!0;if("[object Array]"==d){if(l=b.length,r=l==e.length)for(;l--&&(r=K(b[l],e[l],c,k)););}else{for(var s in b)if(h.has(b,s)&&(l++,!(r=h.has(e,s)&&K(b[s],e[s],c,k))))break;if(r){for(s in e)if(h.has(e,s)&&!l--)break;r=!l}}return c.pop(),k.pop(),r};h.isEqual=function(b,e){return K(b,e,[],[])};h.isEmpty=function(b){if(null==b)return!0;if(h.isArray(b)||h.isString(b))return 0===b.length;for(var e in b)if(h.has(b,
e))return!1;return!0};h.isElement=function(b){return!(!b||1!==b.nodeType)};h.isArray=g||function(b){return"[object Array]"==q.call(b)};h.isObject=function(b){return b===Object(b)};A("Arguments Function String Number Date RegExp".split(" "),function(b){h["is"+b]=function(e){return q.call(e)=="[object "+b+"]"}});h.isArguments(arguments)||(h.isArguments=function(b){return!(!b||!h.has(b,"callee"))});"function"!=typeof/./&&(h.isFunction=function(b){return"function"==typeof b});h.isFinite=function(b){return isFinite(b)&&
!isNaN(parseFloat(b))};h.isNaN=function(b){return h.isNumber(b)&&b!=+b};h.isBoolean=function(b){return!0===b||!1===b||"[object Boolean]"==q.call(b)};h.isNull=function(b){return null===b};h.isUndefined=function(b){return void 0===b};h.has=function(b,e){return l.call(b,e)};h.noConflict=function(){return c._=b,this};h.identity=function(b){return b};h.times=function(b,e,c){for(var k=Array(Math.max(0,b)),h=0;b>h;h++)k[h]=e.call(c,h);return k};h.random=function(b,e){return null==e&&(e=b,b=0),b+Math.floor(Math.random()*
...
h[e]=b[e];h.prototype[e]=function(){var b=[this._wrapped];m.apply(b,arguments);b=c.apply(h,b);return this._chain?h(b).chain():b}})};var G=0;h.uniqueId=function(b){var e=++G+"";return b?b+e:e};h.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var L=/(.)^/,N={"'":"'","\\":"\\","\r":"r","\n":"n"," ":"t","\u2028":"u2028","\u2029":"u2029"},O=/\\|'|\r|\n|\t|\u2028|\u2029/g;h.template=function(b,e,c){var k;c=h.defaults({},c,h.templateSettings);var d=
RegExp([(c.escape||L).source,(c.interpolate||L).source,(c.evaluate||L).source].join("|")+"|$","g"),l=0,r="__p+='";b.replace(d,function(e,c,k,h,d){return r+=b.slice(l,d).replace(O,function(b){return"\\"+N[b]}),c&&(r+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'"),k&&(r+="'+\n((__t=("+k+"))==null?'':__t)+\n'"),h&&(r+="';\n"+h+"\n__p+='"),l=d+e.length,e});r+="';\n";c.variable||(r="with(obj||{}){\n"+r+"}\n");r="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+
r+"return __p;\n";try{k=new Function(c.variable||"obj","_",r)}catch(s){throw s.source=r,s;}if(e)return k(e,h);e=function(b){return k.call(this,b,h)};return e.source="function("+(c.variable||"obj")+"){\n"+r+"}",e};h.chain=function(b){return h(b).chain()};h.mixin(h);A("pop push reverse shift sort splice unshift".split(" "),function(b){var e=f[b];h.prototype[b]=function(){var c=this._wrapped;return e.apply(c,arguments),"shift"!=b&&"splice"!=b||0!==c.length||delete c[0],this._chain?h(c).chain():c}});
A(["concat","join","slice"],function(b){var e=f[b];h.prototype[b]=function(){var b=e.apply(this._wrapped,arguments);return this._chain?h(b).chain():b}});h.extend(h.prototype,{chain:function(){return this._chain=!0,this},value:function(){return this._wrapped}})}).call(this);var Handlebars=function(){var c=function(){function b(c){this.string=c}b.prototype.toString=function(){return""+this.string};return b}(),b=function(b){function c(b){return f[b]||"&amp;"}var d={},f={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},l=/[&<>"'`]/g,g=/[&<>"'`]/;d.extend=function(b,c){for(var k in c)c.hasOwnProperty(k)&&(b[k]=c[k])};var w=Object.prototype.toString;d.toString=w;var p=function(b){return"function"===typeof b};p(/x/)&&(p=function(b){return"function"===
typeof b&&"[object Function]"===w.call(b)});d.isFunction=p;var x=Array.isArray||function(b){return b&&"object"===typeof b?"[object Array]"===w.call(b):!1};d.isArray=x;d.escapeExpression=function(e){if(e instanceof b)return e.toString();if(!e&&0!==e)return"";e=""+e;return g.test(e)?e.replace(l,c):e};d.isEmpty=function(b){return b||0===b?x(b)&&0===b.length?!0:!1:!0};return d}(c),d=function(){function b(){for(var d=Error.prototype.constructor.apply(this,arguments),f=0;f<c.length;f++)this[c[f]]=d[c[f]]}
var c="description fileName lineNumber message name number stack".split(" ");b.prototype=Error();return b}(),f=function(b,c){function d(b,e){this.helpers=b||{};this.partials=e||{};f(this)}function f(b){b.registerHelper("helperMissing",function(b){if(2!==arguments.length)throw Error("Missing helper: '"+b+"'");});b.registerHelper("blockHelperMissing",function(e,c){var k=c.inverse||function(){},d=c.fn;x(e)&&(e=e.call(this));return!0===e?d(this):!1===e||null==e?k(this):p(e)?0<e.length?b.helpers.each(e,
c):k(this):d(e)});b.registerHelper("each",function(b,e){var c=e.fn,d=e.inverse,l=0,r="",s;x(b)&&(b=b.call(this));e.data&&(s=k(e.data));if(b&&"object"===typeof b)if(p(b))for(var f=b.length;l<f;l++)s&&(s.index=l,s.first=0===l,s.last=l===b.length-1),r+=c(b[l],{data:s});else for(f in b)b.hasOwnProperty(f)&&(s&&(s.key=f),r+=c(b[f],{data:s}),l++);0===l&&(r=d(this));return r});b.registerHelper("if",function(b,e){x(b)&&(b=b.call(this));return!e.hash.includeZero&&!b||w.isEmpty(b)?e.inverse(this):e.fn(this)});
b.registerHelper("unless",function(e,c){return b.helpers["if"].call(this,e,{fn:c.inverse,inverse:c.fn,hash:c.hash})});b.registerHelper("with",function(b,e){x(b)&&(b=b.call(this));if(!w.isEmpty(b))return e.fn(b)});b.registerHelper("log",function(e,c){var k=c.data&&null!=c.data.level?parseInt(c.data.level,10):1;b.log(k,e)})}function l(b,e){r.log(b,e)}var g={},w=b;g.VERSION="1.1.2";g.COMPILER_REVISION=4;g.REVISION_CHANGES={1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:">= 1.0.0"};var p=w.isArray,
x=w.isFunction,e=w.toString;g.HandlebarsEnvironment=d;d.prototype={constructor:d,logger:r,log:l,registerHelper:function(b,k,d){if("[object Object]"===e.call(b)){if(d||k)throw new c("Arg not supported with multiple helpers");w.extend(this.helpers,b)}else d&&(k.not=d),this.helpers[b]=k},registerPartial:function(b,c){"[object Object]"===e.call(b)?w.extend(this.partials,b):this.partials[b]=c}};var r={methodMap:{0:"debug",1:"info",2:"warn",3:"error"},DEBUG:0,INFO:1,WARN:2,ERROR:3,level:3,log:function(b,
e){if(r.level<=b){var c=r.methodMap[b];"undefined"!==typeof console&&console[c]&&console[c].call(console,e)}}};g.logger=r;g.log=l;var k=function(b){var e={};w.extend(e,b);return e};g.createFrame=k;return g}(b,d),g=function(b,c,d){function f(b,e,c){var d=Array.prototype.slice.call(arguments,3),l=function(b,k){k=k||{};return e.apply(this,[b,k.data||c].concat(d))};l.program=b;l.depth=d.length;return l}function l(b,e,c){var d=function(b,k){k=k||{};return e(b,k.data||c)};d.program=b;d.depth=0;return d}
function g(b,e,c,d,l,h){d={partial:!0,helpers:d,partials:l,data:h};if(void 0===b)throw new x("The partial "+e+" could not be found");if(b instanceof Function)return b(c,d)}function w(){return""}var p={},x=c,e=d.COMPILER_REVISION,r=d.REVISION_CHANGES;p.template=function(c,d){if(!d)throw Error("No environment passed to template");var p={escapeExpression:b.escapeExpression,invokePartial:d.compile?function(b,e,c,k,l,r){var p=g.apply(this,arguments);if(p)return p;p={helpers:k,partials:l,data:r};l[e]=d.compile(b,
{data:void 0!==r},d);return l[e](c,p)}:function(b,e){var c=g.apply(this,arguments);if(c)return c;throw new x("The partial "+e+" could not be compiled when running in runtime-only mode");},programs:[],program:function(b,e,c){var k=this.programs[b];c?k=l(b,e,c):k||(k=this.programs[b]=l(b,e));return k},merge:function(e,c){var k=e||c;e&&c&&e!==c&&(k={},b.extend(k,c),b.extend(k,e));return k},programWithDepth:f,noop:w,compilerInfo:null};return function(b,l){l=l||{};var h=l.partial?l:d,f,q;l.partial||(f=
l.helpers,q=l.partials);h=c.call(p,h,b,f,q,l.data);if(!l.partial&&(q=(f=p.compilerInfo)&&f[0]||1,q!==e)){if(q<e)throw Error("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version ("+r[e]+") or downgrade your runtime to an older version ("+r[q]+").");throw Error("Template was precompiled with a newer version of Handlebars than the current runtime. Please update your runtime to a newer version ("+f[1]+").");}return h}};
p.programWithDepth=f;p.program=l;p.invokePartial=g;p.noop=w;return p}(b,d,f),c=function(b,c,d,f,l){var g=function(){var p=new b.HandlebarsEnvironment;f.extend(p,b);p.SafeString=c;p.Exception=d;p.Utils=f;p.VM=l;p.template=function(b){return l.template(b,p)};return p},w=g();w.create=g;return w}(f,c,d,b,g),b=function(b){function c(b,d,f){this.type="program";this.statements=b;this.strip={};f?(this.inverse=new c(f,d),this.strip.right=d.left):d&&(this.strip.left=d.right)}var d={};d.ProgramNode=c;d.MustacheNode=
...
e="",r=0,k=0,s=0;this.lexer.setInput(b);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;this.yy.parser=this;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});b=this.lexer.yylloc;f.push(b);var q=this.lexer.options&&this.lexer.options.ranges;"function"===typeof this.yy.parseError&&(this.parseError=this.yy.parseError);for(var v,n,h,m,t={},C,z;;){h=c[c.length-1];if(this.defaultActions[h])m=this.defaultActions[h];else{if(null===v||"undefined"==typeof v)v=this.lexer.lex()||1,"number"!==typeof v&&
(v=this.symbols_[v]||v);m=g[h]&&g[h][v]}if("undefined"===typeof m||!m.length||!m[0]){var E="";if(!s){z=[];for(C in g[h])this.terminals_[C]&&2<C&&z.push("'"+this.terminals_[C]+"'");E=this.lexer.showPosition?"Parse error on line "+(r+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+z.join(", ")+", got '"+(this.terminals_[v]||v)+"'":"Parse error on line "+(r+1)+": Unexpected "+(1==v?"end of input":"'"+(this.terminals_[v]||v)+"'");this.parseError(E,{text:this.lexer.match,token:this.terminals_[v]||v,
line:this.lexer.yylineno,loc:b,expected:z})}}if(m[0]instanceof Array&&1<m.length)throw Error("Parse Error: multiple actions possible at state: "+h+", token: "+v);switch(m[0]){case 1:c.push(v);d.push(this.lexer.yytext);f.push(this.lexer.yylloc);c.push(m[1]);v=null;n?(v=n,n=null):(k=this.lexer.yyleng,e=this.lexer.yytext,r=this.lexer.yylineno,b=this.lexer.yylloc,0<s&&s--);break;case 2:z=this.productions_[m[1]][1];t.$=d[d.length-z];t._$={first_line:f[f.length-(z||1)].first_line,last_line:f[f.length-1].last_line,
first_column:f[f.length-(z||1)].first_column,last_column:f[f.length-1].last_column};q&&(t._$.range=[f[f.length-(z||1)].range[0],f[f.length-1].range[1]]);h=this.performAction.call(t,e,k,r,this.yy,m[1],d,f);if("undefined"!==typeof h)return h;z&&(c=c.slice(0,-2*z),d=d.slice(0,-1*z),f=f.slice(0,-1*z));c.push(this.productions_[m[1]][0]);d.push(t.$);f.push(t._$);m=g[c[c.length-2]][c[c.length-1]];c.push(m);break;case 3:return!0}}return!0}},f=function(){return{EOF:1,parseError:function(b,c){if(this.yy.parser)this.yy.parser.parseError(b,
...
";");this.isChild||(this.source[1]+="\n"+this.context.programs.join("\n")+"\n");this.environment.isSimple||this.pushSource("return buffer;");c=this.isChild?["depth0","data"]:["Handlebars","depth0","helpers","partials","data"];d=0;for(var s=this.environment.depths.list.length;d<s;d++)c.push("depth"+this.environment.depths.list[d]);d=this.mergeSource();this.isChild||(d="this.compilerInfo = ["+f+",'"+g[f]+"'];\n"+d);if(b)return c.push(d),Function.apply(this,c);b="function "+(this.name||"")+"("+c.join(",")+
...
return{params:f,name:b,callParams:["depth0"].concat(f).join(", "),helperMissingParams:d&&["depth0",this.quotedString(c)].concat(f).join(", ")}},setupParams:function(b,c,d){var f=[],p=[],g=[],l,h;f.push("hash:"+this.popStack());l=this.popStack();if((h=this.popStack())||l)h||(this.context.aliases.self="this",h="self.noop"),l||(this.context.aliases.self="this",l="self.noop"),f.push("inverse:"+l),f.push("fn:"+h);for(h=0;h<b;h++)l=this.popStack(),c.push(l),this.options.stringParams&&(g.push(this.popStack()),
p.push(this.popStack()));this.options.stringParams&&(f.push("contexts:["+p.join(",")+"]"),f.push("types:["+g.join(",")+"]"),f.push("hashContexts:hashContexts"),f.push("hashTypes:hashTypes"));this.options.data&&f.push("data:data");f="{"+f.join(",")+"}";d?(this.register("options",f),c.push("options")):c.push(f);return c.join(", ")}};b="break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield".split(" ");
for(var w=d.RESERVED_WORDS={},p=0,x=b.length;p<x;p++)w[b[p]]=!0;d.isValidJavaScriptVariableName=function(b){return!d.RESERVED_WORDS[b]&&/^[a-zA-Z_$][0-9a-zA-Z_$]+$/.test(b)?!0:!1};return d}(f),d=function(b,c,d,f){function g(){}var y={},w=c.parse;y.Compiler=g;g.prototype={compiler:g,disassemble:function(){for(var b=this.opcodes,c,d=[],f,k,g=0,l=b.length;g<l;g++)if(c=b[g],"DECLARE"===c.opcode)d.push("DECLARE "+c.name+"="+c.value);else{f=[];for(var q=0;q<c.args.length;q++)k=c.args[q],"string"===typeof k&&
...
this.addDepth(d.depth),this.opcode("getContext",d.depth||0),this.opcode("pushStringParam",d.stringModeValue,d.type);else this[d.type](d)},setupMustacheParams:function(b){var c=b.params;this.pushParams(c);b.hash?this.hash(b.hash):this.opcode("emptyHash");return c},setupFullMustacheParams:function(b,c,d){var f=b.params;this.pushParams(f);this.opcode("pushProgram",c);this.opcode("pushProgram",d);b.hash?this.hash(b.hash):this.opcode("emptyHash");return f}};y.precompile=function(c,n){if(null==c||"string"!==
typeof c&&c.constructor!==f.ProgramNode)throw new b("You must pass a string or Handlebars AST to Handlebars.precompile. You passed "+c);n=n||{};"data"in n||(n.data=!0);var e=w(c),e=(new g).compile(e,n);return(new d).compile(e,n)};y.compile=function(c,n,e){if(null==c||"string"!==typeof c&&c.constructor!==f.ProgramNode)throw new b("You must pass a string or Handlebars AST to Handlebars.compile. You passed "+c);n=n||{};"data"in n||(n.data=!0);var r;return function(b,f){if(!r){var q=w(c),q=(new g).compile(q,
n),q=(new d).compile(q,n,void 0,!0);r=e.template(q)}return r.call(this,b,f)}};return y}(d,g,f,b);return function(b,c,d,f,g){var y=d.parser,w=d.parse,p=f.Compiler,x=f.compile,e=f.precompile,r=b.create;d=function(){var b=r();b.compile=function(c,d){return x(c,d,b)};b.precompile=e;b.AST=c;b.Compiler=p;b.JavaScriptCompiler=g;b.Parser=y;b.parse=w;return b};b=d();b.create=d;return b}(c,b,g,d,f)}();(function(c,b,d){function f(b,c,d){b.addEventListener?b.addEventListener(c,d,!1):b.attachEvent("on"+c,d)}function g(b){if("keypress"==b.type){var c=String.fromCharCode(b.which);b.shiftKey||(c=c.toLowerCase());return c}return e[b.which]?e[b.which]:r[b.which]?r[b.which]:String.fromCharCode(b.which).toLowerCase()}function m(b){b=b||{};var c=!1,d;for(d in h)b[d]?c=!0:h[d]=0;c||(z=!1)}function n(b,c,d,e,f,k){var g,l,r=[],q=d.type;if(!v[b])return[];"keyup"==q&&y(b)&&(c=[b]);for(g=0;g<v[b].length;++g)if(l=
v[b][g],!(!e&&l.seq&&h[l.seq]!=l.level||q!=l.action||("keypress"!=q||d.metaKey||d.ctrlKey)&&c.sort().join(",")!==l.modifiers.sort().join(","))){var n=e&&l.seq==e&&l.level==k;(!e&&l.combo==f||n)&&v[b].splice(g,1);r.push(l)}return r}function t(b){var c=[];b.shiftKey&&c.push("shift");b.altKey&&c.push("alt");b.ctrlKey&&c.push("ctrl");b.metaKey&&c.push("meta");return c}function q(b,c,d){E.stopCallback(c,c.target||c.srcElement,d)||!1!==b(c,d)||(c.preventDefault&&c.preventDefault(),c.stopPropagation&&c.stopPropagation(),
c.returnValue=!1,c.cancelBubble=!0)}function l(b){"number"!==typeof b.which&&(b.which=b.keyCode);var c=g(b);c&&("keyup"==b.type&&D===c?D=!1:E.handleKey(c,t(b),b))}function y(b){return"shift"==b||"ctrl"==b||"alt"==b||"meta"==b}function w(b,c,d,e){function f(c){return function(){z=c;++h[b];clearTimeout(A);A=setTimeout(m,1E3)}}function k(c){q(d,c,b);"keyup"!==e&&(D=g(c));setTimeout(m,10)}for(var l=h[b]=0;l<c.length;++l){var r=l+1===c.length?k:f(e||p(c[l+1]).action);x(c[l],r,e,b,l)}}function p(b,c){var d,
f,h,g=[];d="+"===b?["+"]:b.split("+");for(h=0;h<d.length;++h)f=d[h],s[f]&&(f=s[f]),c&&"keypress"!=c&&k[f]&&(f=k[f],g.push("shift")),y(f)&&g.push(f);d=f;h=c;if(!h){if(!B){B={};for(var l in e)95<l&&112>l||e.hasOwnProperty(l)&&(B[e[l]]=l)}h=B[d]?"keydown":"keypress"}"keypress"==h&&g.length&&(h="keydown");return{key:f,modifiers:g,action:h}}function x(b,c,d,e,f){u[b+":"+d]=c;b=b.replace(/\s+/g," ");var k=b.split(" ");1<k.length?w(b,k,c,d):(d=p(b,d),v[d.key]=v[d.key]||[],n(d.key,d.modifiers,{type:d.action},
e,b,f),v[d.key][e?"unshift":"push"]({callback:c,modifiers:d.modifiers,action:d.action,seq:e,level:f,combo:b}))}var e={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},r={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},k={"~":"`","!":"1",
"@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},s={option:"alt",command:"meta","return":"enter",escape:"esc",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},B,v={},u={},h={},A,D=!1,C=!1,z=!1;for(d=1;20>d;++d)e[111+d]="f"+d;for(d=0;9>=d;++d)e[d+96]=d;f(b,"keypress",l);f(b,"keydown",l);f(b,"keyup",l);var E={bind:function(b,c,d){b=b instanceof Array?b:[b];for(var e=0;e<b.length;++e)x(b[e],c,d);return this},
...
a.isArray=function(c){return c instanceof Array};a.setDefaultAjaxOptions=function(c){a.isObject(c)&&(this.__defaultAjaxOptions=c)};a.getDefaultAjaxOptions=function(){return this.__defaultAjaxOptions};(function(){var c=document.getElementById("a-core");c&&"undefined"!==typeof c.src&&(a.url=c.src.replace(/\/[^/]*$/,"/"))})();a.environment=new function(){var c={verbose:2,console:"log"};this.get=function(b){return b in c?c[b]:null};this.set=function(b,d){a.isNone(b)||(c[b]=d,a.message.dispatch("a.environment.add",{key:b,value:d}))};this.remove=function(b){a.isNone(c[b])||(delete c[b],a.message.dispatch("a.environment.remove",{key:b}))};this.clear=function(){c={verbose:2,console:"log"}}};a.console=function(){function c(c,f,g,m){a.isArray(b[c])||(c="log");b[c].push(f);if(!a.isNone(window.console)&&a.isFunction(window.console.log)&&!1!==m)switch(a.environment.get("console")){case "error":if("error"!==c)break;case "warning":case "warn":if("warn"!==c&&"error"!==c)break;case "info":if("log"===c)break;default:m=!0;var n=!1;if(a.isString(f)&&0<=f.indexOf(":"))for(var t=f.substr(0,f.indexOf(":")).split("."),q=t.length;q--;){var l="verbose-"+t.join("."),l=a.environment.get(l);if(!a.isNone(l)){n=
!0;m=l<g?!1:!0;break}t.pop()}n||(a.isNone(a.environment.get("verbose"))||a.isNone(g))||parseInt(a.environment.get("verbose"),10)<g&&(m=!1);if(m)window.console[c](f)}for(;2E3<b[c].length;)b[c].shift()}var b={log:[],warn:[],info:[],error:[]};return{log:function(b,f,g){c("log",b,f,g)},warn:function(b,f,g){c("warn",b,f,g)},info:function(b,f,g){c("info",b,f,g)},error:function(b,f,g){c("error",b,f,g)},trace:function(c){return a.isString(c)&&c in b?b[c]:b},clear:function(){b={log:[],warn:[],info:[],error:[]}}}}();a.eventEmitter=function(){function c(c){for(var f in b.__list)1>b.__list[f].length&&delete b.__list[f]}var b=function(){this.__list={};this.__base="a.message"};b.prototype.setName=function(b){this.__base=""+b};b.prototype.addListener=function(b,c){a.isFunction(c)?(a.isNone(this.__list[b])&&(this.__list[b]=[]),this.__list[b].push(c),this.dispatch(this.__base+".add",{type:b,fct:c})):a.console.warn(this.__base+".addListener : unable to bind function, this is not a function",1)};b.prototype.add=b.prototype.on=
b.prototype.bind=b.prototype.addListener;b.prototype.addListenerOnce=function(b,c){var g=this,m=function(n){c(n);g.removeListener(b,m)};this.addListener(b,m)};b.prototype.once=b.prototype.onOnce=b.prototype.bindOnce=b.prototype.addListenerOnce;b.prototype.removeListener=function(b,f){if(!a.isNone(this.__list[b])){var g=this.__list[b].length;if(a.isFunction(f))for(;g--;)this.__list[b][g]===f&&this.__list[b].splice(g,1);this.dispatch(this.__base+".remove",{type:b,fct:f});c(b)}};b.prototype.remove=b.prototype.off=
b.prototype.unbind=b.prototype.removeListener;b.prototype.removeAllListeners=function(b){a.isNone(this.__list[b])||(this.__list[b]=[],c(b))};b.prototype.removeAll=b.prototype.offAll=b.prototype.unbindAll=b.prototype.removeAllListeners;b.prototype.clear=function(){var b=this.__base+".clear",c;for(c in this.__list)c!==b&&delete this.__list[c];this.dispatch(b,{})};b.prototype.dispatch=function(b,c){var g=this.__list[b];if(!a.isNone(g))for(var m=0,n=g.length;m<n;++m)(function(b){setTimeout(function(){b(c)},
0)})(g[m])};return b}();a.message=new a.eventEmitter;a.message.setName=function(){};a.isNone(JSON)&&(a.isNone(JSON.parser)||a.isNone(JSON.stringify))&&function(){function c(c){var e,k,h,l="json"==c;if(l||"json-stringify"==c||"json-parse"==c){if("json-stringify"==c||l){if(e="function"==typeof q.stringify&&A){(h=function(){return 1}).toJSON=h;try{e="0"===q.stringify(0)&&"0"===q.stringify(new Number)&&'""'==q.stringify(new String)&&q.stringify(g)===b&&q.stringify(b)===b&&q.stringify()===b&&"1"===q.stringify(h)&&"[1]"==q.stringify([h])&&"[null]"==q.stringify([b])&&"null"==q.stringify(f)&&
"[null,null,null]"==q.stringify([b,g,f])&&'{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==q.stringify({A:[h,d,!1,f,"\x00\b\n\f\r\t"]})&&"1"===q.stringify(f,h)&&"[\n 1,\n 2\n]"==q.stringify([1,2],f,1)&&'"-271821-04-20T00:00:00.000Z"'==q.stringify(new Date(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==q.stringify(new Date(864E13))&&'"-000001-01-01T00:00:00.000Z"'==q.stringify(new Date(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==q.stringify(new Date(-1))}catch(r){e=!1}}if(!l)return e}if("json-parse"==
c||l){if("function"==typeof q.parse)try{if(0===q.parse("0")&&!q.parse(!1)&&(h=q.parse('{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'),k=5==h.a.length&&1==h.a[0])){try{k=!q.parse('"\t"')}catch(n){}if(k)try{k=1!=q.parse("01")}catch(s){}}}catch(v){k=!1}if(!l)return k}return e&&k}}var b=void 0,d=!0,f=null,g={}.toString,m,n,t="function"===typeof define&&define.c,q=!t&&"object"==typeof exports&&exports;q||t?"object"==typeof JSON&&JSON?t?q=JSON:(q.stringify=JSON.stringify,q.parse=JSON.parse):t&&(q=
this.JSON={}):q=this.JSON||(this.JSON={});var l,y,w,p,x,e,r,k,s,B,v,u,h,A=new Date(-0xc782b5b800cec),D,C,z;try{A=-109252==A.getUTCFullYear()&&0===A.getUTCMonth()&&1==A.getUTCDate()&&10==A.getUTCHours()&&37==A.getUTCMinutes()&&6==A.getUTCSeconds()&&708==A.getUTCMilliseconds()}catch(E){}c("json")||(A||(D=Math.floor,C=[0,31,59,90,120,151,181,212,243,273,304,334],z=function(b,c){return C[c]+365*(b-1970)+D((b-1969+(c=+(1<c)))/4)-D((b-1901+c)/100)+D((b-1601+c)/400)}),(m={}.hasOwnProperty)||(m=function(b){var c=
{},d;(c.__proto__=f,c.__proto__={toString:1},c).toString!=g?m=function(b){var c=this.__proto__;b=b in(this.__proto__=f,this);this.__proto__=c;return b}:(d=c.constructor,m=function(b){var c=(this.constructor||d).prototype;return b in this&&!(b in c&&this[b]===c[b])});c=f;return m.call(this,b)}),n=function(b,c){var d=0,e,k,h;(e=function(){this.valueOf=0}).prototype.valueOf=0;k=new e;for(h in k)m.call(k,h)&&d++;e=k=f;d?d=2==d?function(b,c){var d={},e="[object Function]"==g.call(b),k;for(k in b)e&&"prototype"==
k||m.call(d,k)||(d[k]=1)&&m.call(b,k)&&c(k)}:function(b,c){var d="[object Function]"==g.call(b),e,k;for(e in b)d&&"prototype"==e||!m.call(b,e)||(k="constructor"===e)||c(e);(k||m.call(b,e="constructor"))&&c(e)}:(k="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),d=function(b,c){var d="[object Function]"==g.call(b),e;for(e in b)d&&"prototype"==e||!m.call(b,e)||c(e);for(d=k.length;e=k[--d];m.call(b,e)&&c(e));});d(b,c)},c("json-stringify")||(l=
{"\\":"\\\\",'"':'\\"',"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"},y=function(b,c){return("000000"+(c||0)).slice(-b)},w=function(b){for(var c='"',d=0,e;e=b.charAt(d);d++)c+=-1<'\\"\b\f\n\r\t'.indexOf(e)?l[e]:l[e]=" ">e?"\\u00"+y(2,e.charCodeAt(0).toString(16)):e;return c+'"'},p=function(c,e,k,h,l,r,q){var s=e[c],v,u,B,t,x,A,C,E,H;if("object"==typeof s&&s)if(v=g.call(s),"[object Date]"!=v||m.call(s,"toJSON"))"function"==typeof s.toJSON&&("[object Number]"!=v&&"[object String]"!=v&&"[object Array]"!=
v||m.call(s,"toJSON"))&&(s=s.toJSON(c));else if(s>-1/0&&s<1/0){if(z){B=D(s/864E5);for(v=D(B/365.2425)+1970-1;z(v+1,0)<=B;v++);for(u=D((B-z(v,0))/30.42);z(v,u+1)<=B;u++);B=1+B-z(v,u);t=(s%864E5+864E5)%864E5;x=D(t/36E5)%24;A=D(t/6E4)%60;C=D(t/1E3)%60;t%=1E3}else v=s.getUTCFullYear(),u=s.getUTCMonth(),B=s.getUTCDate(),x=s.getUTCHours(),A=s.getUTCMinutes(),C=s.getUTCSeconds(),t=s.getUTCMilliseconds();s=(0>=v||1E4<=v?(0>v?"-":"+")+y(6,0>v?-v:v):y(4,v))+"-"+y(2,u+1)+"-"+y(2,B)+"T"+y(2,x)+":"+y(2,A)+":"+
y(2,C)+"."+y(3,t)+"Z"}else s=f;k&&(s=k.call(e,c,s));if(s===f)return"null";v=g.call(s);if("[object Boolean]"==v)return""+s;if("[object Number]"==v)return s>-1/0&&s<1/0?""+s:"null";if("[object String]"==v)return w(s);if("object"==typeof s){for(c=q.length;c--;)if(q[c]===s)throw TypeError();q.push(s);E=[];e=r;r+=l;if("[object Array]"==v){u=0;for(c=s.length;u<c;H||(H=d),u++)v=p(u,s,k,h,l,r,q),E.push(v===b?"null":v);c=H?l?"[\n"+r+E.join(",\n"+r)+"\n"+e+"]":"["+E.join(",")+"]":"[]"}else n(h||s,function(c){var e=
p(c,s,k,h,l,r,q);e!==b&&E.push(w(c)+":"+(l?" ":"")+e);H||(H=d)}),c=H?l?"{\n"+r+E.join(",\n"+r)+"\n"+e+"}":"{"+E.join(",")+"}":"{}";q.pop();return c}},q.stringify=function(b,c,d){var e,k,f,h,l,s;if("function"==typeof c||"object"==typeof c&&c)if("[object Function]"==g.call(c))k=c;else if("[object Array]"==g.call(c))for(f={},h=0,l=c.length;h<l;s=c[h++],("[object String]"==g.call(s)||"[object Number]"==g.call(s))&&(f[s]=1));if(d)if("[object Number]"==g.call(d)){if(0<(d-=d%1))for(e="",10<d&&(d=10);e.length<
d;e+=" ");}else"[object String]"==g.call(d)&&(e=10>=d.length?d:d.slice(0,10));return p("",(s={},s[""]=b,s),k,f,e,"",[])}),c("json-parse")||(x=String.fromCharCode,e={"\\":"\\",'"':'"',"/":"/",b:"\b",t:"\t",n:"\n",f:"\f",r:"\r"},r=function(){u=h=f;throw SyntaxError();},k=function(){for(var b=h,c=b.length,k,g,l,s,q;u<c;)if(k=b.charAt(u),-1<"\t\r\n ".indexOf(k))u++;else{if(-1<"{}[]:,".indexOf(k))return u++,k;if('"'==k){g="@";for(u++;u<c;)if(k=b.charAt(u)," ">k)r();else if("\\"==k)if(k=b.charAt(++u),-1<
'\\"/btnfr'.indexOf(k))g+=e[k],u++;else if("u"==k){l=++u;for(s=u+4;u<s;u++)k=b.charAt(u),"0"<=k&&"9">=k||"a"<=k&&"f">=k||"A"<=k&&"F">=k||r();g+=x("0x"+b.slice(l,u))}else r();else{if('"'==k)break;g+=k;u++}if('"'==b.charAt(u))return u++,g}else{l=u;"-"==k&&(q=d,k=b.charAt(++u));if("0"<=k&&"9">=k){for("0"==k&&(k=b.charAt(u+1),"0"<=k&&"9">=k)&&r();u<c&&(k=b.charAt(u),"0"<=k&&"9">=k);u++);if("."==b.charAt(u)){for(s=++u;s<c&&(k=b.charAt(s),"0"<=k&&"9">=k);s++);s==u&&r();u=s}k=b.charAt(u);if("e"==k||"E"==
k){k=b.charAt(++u);"+"!=k&&"-"!=k||u++;for(s=u;s<c&&(k=b.charAt(s),"0"<=k&&"9">=k);s++);s==u&&r();u=s}return+b.slice(l,u)}q&&r();if("true"==b.slice(u,u+4))return u+=4,d;if("false"==b.slice(u,u+5))return u+=5,!1;if("null"==b.slice(u,u+4))return u+=4,f}r()}return"$"},s=function(b){var c,e;"$"==b&&r();if("string"==typeof b){if("@"==b.charAt(0))return b.slice(1);if("["==b){for(c=[];;e||(e=d)){b=k();if("]"==b)break;e&&(","==b?(b=k(),"]"==b&&r()):r());","==b&&r();c.push(s(b))}return c}if("{"==b){for(c=
{};;e||(e=d)){b=k();if("}"==b)break;e&&(","==b?(b=k(),"}"==b&&r()):r());","!=b&&"string"==typeof b&&"@"==b.charAt(0)&&":"==k()||r();c[b.slice(1)]=s(k())}return c}r()}return b},v=function(c,d,e){e=B(c,d,e);e===b?delete c[d]:c[d]=e},B=function(b,c,d){var e=b[c],k;if("object"==typeof e&&e)if("[object Array]"==g.call(e))for(k=e.length;k--;)v(e,k,d);else n(e,function(b){v(e,b,d)});return d.call(b,c,e)},q.parse=function(b,c){var d,e;u=0;h=b;d=s(k());"$"!=k()&&r();u=h=f;return c&&"[object Function]"==g.call(c)?
B((e={},e[""]=d,e),"",c):d}));t&&define(function(){return q})}();
...
g=d.length;if(1<g){for(;g--;)for(var m=this.tag(d[g],b).getElements(),n=m.length;n--;)a.contains(f,m[n])||f.push(m[n]);return new a.dom.children(f)}f=b.querySelectorAll?b.querySelectorAll(c):b.getElementsByTagName(c);return new a.dom.children(f)},attr:function(c,b,d){function f(b,c){for(var d=c.length;d--;)a.contains(b,c[d])||b.push(c[d])}if(a.isNone(d)){a.isNone(b)&&(b=document);if(a.isObject(b)&&!a.isArray(b))return this.attr(c,null,b);d=document}if(c&&(a.isArray(c)||0<=c.indexOf(","))){var g=a.isString(c)?
c.replace(/ /g,"").split(","):c,m=g.length;if(1<m){for(var n=[];m--;){var t=this.attr(g[m],b,d),t=t.getElements();f(n,t)}return new a.dom.children(n)}}if(b&&(a.isArray(b)||0<b.indexOf(","))&&(g=a.isString(b)?b.replace(/ /g,"").split(","):b,m=g.length,1<m)){for(n=[];m--;)t=this.attr(c,g[m],d),t=t.getElements(),f(n,t);return new a.dom.children(n)}g=a.isString(b);n=[];c=c.replace(/ /g,"");b=b.replace(/ /g,"");if("class"==c)n=d.getElementsByClassName(b);else if("id"==c)n=[d.getElementById(b)],a.isNull(n[0])&&
n.pop();else if(d.querySelectorAll)n=d.querySelectorAll(g?"["+c+'="'+b+'"]':"["+c+"]");else for(d=d.getElementsByTagName("*"),m=d.length;m--;){var t=d[m],q=t.getAttribute(c);q&&(g&&q==b||!g)&&(a.contains(n,t)||n.push(t))}return new a.dom.children(n)}};
a.dom.event=new function(){function c(b,c,d){b.addEventListener(c,d,!1)}function b(b,c,d){b.removeEventListener(c,d,!1)}function d(b,c,d){b.attachEvent("on"+c,d)}function f(b,c,d){b.detachEvent("on"+c,d)}function g(b,c,d){b["on"+c]=d}function m(b,c,d){b["on"+c]=null}var n=null,t=null;a.isFunction(window.addEventListener)?(n=c,t=b):a.isFunction(document.attachEvent)?(n=d,t=f):(n=g,t=m);this.bind=n;this.unbind=t};
a.dom.children=function(c){this.elementList=c="undefined"===typeof c.length?[c]:c;this.length=c.length};
a.dom.children.prototype={_perform:function(){var c=[],b=this.elementList,d=Array.prototype.slice.call(arguments),f=d[0],d=d.slice(1),g=d.length,m=b.length;for(d.push(null);m--;){d[g]=b[m];for(var n=f.apply(a.dom,d).getElements(),t=n.length;t--;)a.contains(c,n[t])||c.push(n[t])}this.elementList=c;this.length=c.length;return this},get:function(c){return this.elementList[c]||null},getElements:function(){return this.elementList},id:function(c){return this._perform(a.dom.id,c)},cls:function(c){return this._perform(a.dom.cls,
c)},css:function(c,b){if("undefined"===typeof b){for(var d=[],f=this.elementList,g=f.length;g--;){var m=f[g].style[c];a.isNone(m)||d.push(m)}return 1>=d.length?d[0]||"":d}this.each(function(){this.style[c]=b})},addClass:function(c){this.each(function(){this.classList?this.classList.add(c):this.className.match(RegExp("(\\s|^)"+c+"(\\s|$)"))||(this.className+=" "+c)});return this},hasClass:function(c){c=RegExp("(\\s|^)"+c+"(\\s|$)");for(var b=this.elementList,d=b.length;d--;)if(!b[d].className.match(c))return!1;
...
d[i]&&this.each(function(c){a.dom.event.bind(this,c,b)},d[i].toLowerCase());return this},unbind:function(c,b){var d=a.isString(c)?c.split(" "):c;for(i=d.length;i--;)d[i]&&""!=d[i]&&this.each(function(c){a.dom.event.unbind(this,c,b)},d[i].toLowerCase());return this},tag:function(c){return this._perform(a.dom.tag,c)},attr:function(c,b){return this._perform(a.dom.attr,c,b)},attribute:function(c,b){if("undefined"===typeof b){for(var d=[],f=this.elementList,g=f.length;g--;)try{var m=f[g].getAttribute();
a.isNone(m)||a.contains(d,m)||d.push(m)}catch(n){}return d}this.each(function(){try{this.setAttribute(c,b)}catch(d){}});return this},data:function(c,b){return this.attribute("data-"+c,b)},parent:function(){for(var c=this.elementList,b=c.length;b--;)c[b]=c[b].parentNode;return this},children:function(){for(var c=this.elementList,b=[],d=c.length;d--;)b.push(a.toArray(c[d].childNodes));this.elementList=a.union.apply(this,b)},insertBefore:function(c){this.each(function(){this.parentNode.insertBefore(c,
...
this.elementList,b=Array.prototype.slice.call(arguments),d=b[0],b=b.slice(1),d=a.isFunction(d)?d:function(){},f=0,g=c.length;f<g;++f)d.apply(c[f],b);return this}};a.ajax=function(c,b,d){var f=a.getDefaultAjaxOptions();this.params={url:"",method:"GET",type:"raw",async:!0,cache:!1,data:{},header:{}};for(var g in this.params)"data"!==g&&"header"!==g&&(g in f&&typeof f[g]===typeof this.params[g]&&(this.params[g]=f[g]),g in c&&typeof c[g]===typeof this.params[g]&&(this.params[g]=c[g]));if(a.isObject(f.data))for(var m in f.data)this.params.data[m]=f.data[m];if(a.isObject(f.header))for(var n in f.header)this.params.header[n]=f.header[n];if(a.isString(c.data))this.params.data=
...
a.ajax.prototype.send=function(){var c=this.params.method.toUpperCase();if(!1===this.params.cache){var b=Math.floor(1E5*Math.random())+1;try{this.params.data.cachedisable=b}catch(d){}}b="";if(a.isString(this.params.data))b=this.params.data;else{for(var f in this.params.data)b+=encodeURIComponent(f)+"="+encodeURIComponent(this.params.data[f])+"&";b=b.slice(0,-1)}var g=this.params.url;f=this.params.async;"GET"===c&&""!==b&&(g+="?"+b);if(!0===f){var m={success:this.success,params:this.params,error:this.error,
request:this.request,parseResult:this.parseResult};this.request.onreadystatechange=function(){if(4===m.request.readyState){var b=200<=m.request.status&&400>m.request.status;b?m.success(m.parseResult(m.params,m.request),m.request.status):m.error(g,m.request.status);a.message.dispatch("a.ajax",{success:b,status:m.request.status,url:m.params.url,method:m.method,params:m.params})}}}this.request.open(c,g,f);var n=["Content-Type","Content-type","content-type"],t=!1,q;for(q in this.params.header)this.request.setRequestHeader(q,
this.params.header[q]),!t&&a.contains(n,q)&&(t=!0);t||"POST"!==c||this.request.setRequestHeader("Content-type","application/x-www-form-urlencoded");this.request.send(b);return!1===f?this.parseResult(this.params,this.request):"No return in async mode"};a.loader=function(){function c(b,c){if(a.isNone(b))return!1;for(var d=0,g=f.length;d<g;++d)if(f[d]===b)return a.isFunction(c)&&c(),!0;return!1}function b(b,c,d,l,m,w){for(var p in c)b.setAttribute(p,c[p]);!a.isNone(m)&&m.id&&b.setAttribute("id",m.id);var x=!1,e=function(c){x||(x=!0,a.isFunction(d)&&d(b),(a.isNone(m)||!1!==m.cache)&&f.push(l))};b.addEventListener?b.addEventListener("load",e,!1):b.readyState?b.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||e()}:
b.onload=e;if("text/css"===c.type){var r=document.styleSheets.length;g++;var k=a.timer.add(function(){document.styleSheets.length>r+g-1&&(g--,a.timer.remove(k),e())},null,50)}document.getElementsByTagName("head")[0].appendChild(b)}function d(b,c,d,g){var y={url:b,method:"GET",type:"raw",async:!0,cache:!0,data:{},header:{}};a.console.log("a.loader: load resource (url: "+b+")",3);a.isNone(d)||(a.contains(m,d.method)&&(y.method=d.method),a.isNone(d.type)||"json"!==d.type&&"xml"!==d.type||(y.type=d.type),
a.isObject(d.data)&&(y.data=d.data),a.isObject(d.header)&&(y.header=d.header),a.isBoolean(d.cache)&&(y.cache=d.cache));g=a.isFunction(g)?g:function(){};(new a.ajax(y,function(g,l){a.isFunction(c)&&c(g,l);(a.isNone(d)||!1!==d.cache)&&f.push(b)},g)).send()}var f=[],g=0,m="GET POST PUT DELETE HEAD OPTIONS".split(" ");return{js:function(b,d,f,g){c(b,d)||this.jsonp(b,d,f,g)},jsonp:function(c,d,f,g){var m=a.isObject(f)&&f.type?f.type:"text/javascript";a.console.log("a.loader: load resource (url: "+c+")",
3);b(document.createElement("script"),{type:m,src:c},d,c,f,g)},json:function(b,c,f,g){a.isObject(f)||(f={});f.type="json";a.isObject(f.header)||(f.header={});f.header.accept="application/json, text/javascript";d(b,c,f,g)},xml:function(b,c,f,g){a.isObject(f)||(f={});f.type="xml";a.isObject(f.header)||(f.header={});f.header.accept="application/xml, text/xml";d(b,c,f,g)},css:function(d,f,g,l){c(d,f)||(a.console.log("a.loader: load resource (url: "+d+")",3),b(document.createElement("link"),{rel:"stylesheet",
...
(f.version?f.version:"1.3")+"/dtfx.js",function(){javafx({archive:b,width:f.width||1,height:f.height||1,code:f.code,name:f.id})});var m=null,w=2E3,m=a.timer.add(function(){0<w--&&!a.isNone(document.getElementById(f.id).Packages)?(a.timer.remove(m),a.isFunction(d)&&d()):0>=w&&a.isFunction(g)&&g(b,408)},null,200)}},flash:function(b,d,f,g){a.isNone(f)||a.isNone(f.rootId)||a.isNone(f.id)?a.console.warn("a.loader.flash : the system need args parameters : rootId, id, setted to be able to load any flash resource... This uri will not be loaded : "+
...
b,3);else if(!c(b,d)){a.console.log("a.loader: load resource (url: "+b+")",3);var m=document.createElement("object");m.id=f.id;m.data="data:application/x-silverlight-2,";m.type="application/x-silverlight-2";a.isArray(f.params)||(f.params=[]);f.params.push({name:"source",value:b});for(var w=0,p=f.params.length;w<p;++w){var x=document.createElement("param");x.name=f.params[w].name;x.value=f.params[w].value;m.appendChild(x)}document.getElementById(f.rootId).appendChild(m);var e=null,r=2E3,e=a.timer.add(function(){0<
r--&&!a.isNone(document.getElementById(f.id).Content)?(a.timer.remove(e),d()):0>=r&&a.isFunction(g)&&g(b,408)},null,200)}},trace:function(){return f}}}();a.keyboard=function(c){return a.isNone(c)?(a.console.error("a.keyboard.global: error, Mousetrap is undefined, the plugin a.keyboard will not work",1),{addListener:function(){},removeListener:function(){},reset:function(){},clear:function(){}}):{addListener:function(b,d){a.console.log("a.keyboard.addListener: bind key: "+b,3);c.bind(b,d)},removeListener:function(b){a.console.log("a.keyboard.removeLister: remove listener on key: "+b,3);c.unbind(b)},reset:function(){a.console.log("a.keyboard.reset: clear all keys",
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.callback={};
a.callback.synchronizer=function(){function c(){t--;0>=t&&!1===w?(y=!1,x.prototype.dispatch("a.callback.synchronizer.success",{}),q(p)):0>=t&&(y=w=!1)}function b(){!0===y&&(w=!0,y=!1,x.prototype.dispatch("a.callback.synchronizer.error",{}),l.apply(this,arguments))}function d(b,c){p[b]=c}function f(b){a.isObject(b)&&(p=b)}function g(b){return a.isNone(p[b])?null:p[b]}function m(){return p}var n=[],t=0,q=function(){return!0},l=function(){return!0},y=!1,w=!1,p={},x=function(){};x.prototype=new a.eventEmitter;
x.prototype.constructor=this;x.prototype.setSuccess=function(b){q=a.isFunction(b)?b:q};x.prototype.setDone=x.prototype.setSuccess;x.prototype.setFail=function(b){l=a.isFunction(b)?b:l};x.prototype.setError=x.prototype.setFail;x.prototype.addCallback=function(){for(var e=[],e=!a.isNone(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,k=0,s=e.length;k<s;++k){var l=e[k];a.isFunction(l)&&(t++,n.push(l),!0===y&&l({success:c,done:c,getData:g,getFullData:m,setData:d,setFullData:f,fail:b,error:b}))}!0===
y&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};x.prototype.removeCallback=function(b){for(var c=n.length-1;0<=c;--c)n[c]===b&&(!0===y&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),t--,n.splice(c,1))};x.prototype.start=function(e,k){if(0>=t)c();else{y=!0;p={};for(var s=0,l=n.length;s<l;++s)n[s]({success:c,done:c,getData:g,getFullData:m,setData:d,
...
a.callback.chainer=function(){function c(){0==l.length?(l=[],t(y),w.prototype.dispatch("a.callback.chainer.success",{})):w.prototype.start(arguments)}function b(){l=[];q.apply(this,arguments);w.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){y[b]=c}function f(b){a.isObject(b)&&(y=b)}function g(b){return a.isNone(y[b])?null:y[b]}function m(){return y}var n=[],t=function(){return!0},q=function(){return!0},l=[],y={},w=function(){};w.prototype=new a.eventEmitter;w.prototype.constructor=
this;w.prototype.setSuccess=function(b){t=a.isFunction(b)?b:t};w.prototype.setDone=w.prototype.setSuccess;w.prototype.setFail=function(b){q=a.isFunction(b)?b:q};w.prototype.setError=w.prototype.setFail;w.prototype.addCallback=function(){for(var b=[],b=!a.isNone(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,d=b.length;c<d;++c){var k=b[c];a.isFunction(k)&&(n.push(k),!0===w.prototype.isRunning()&&l.push(k))}!0===w.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};w.prototype.removeCallback=function(b){for(var c=n.length-1;0<=c;--c)if(n[c]===b){if(!0===w.prototype.isRunning()){for(var d=l.length-1;0<=d;--d)l[d]===b&&l.splice(d,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}n.splice(c,1)}};w.prototype.start=function(){if(0==l.length){for(var p=0,e=n.length;p<e;++p)l.push(n[p]);w.prototype.dispatch("a.callback.chainer.start",{});y={};0==l.length&&c()}p=l.shift();a.isFunction(p)&&p({success:c,
done:c,getData:g,getFullData:m,setData:d,setFullData:f,fail:b,error:b},arguments)};w.prototype.isRunning=function(){return 0==l.length?!1:!0};var p=new w;p.setName("a.callback.chainer");return p};a.storage={__printGetItem:function(c,b,d){"__test_support"!==b&&a.console.log("a.storage.type."+c+".getItem: get element (key: "+b+", value: "+d+")",3)},__printGetErrorItem:function(c,b){"__test_support"!==b&&a.console.log("a.storage.type."+c+".getItem: unable to find key ("+b+") in store",2)},__printSetItem:function(c,b,d){"__test_support"!==b&&a.console.log("a.storage.type."+c+".setItem: add element (key: "+b+", value: "+d+")",3)},__printRemoveItem:function(c,b){"__test_support"!==b&&a.console.log("a.storage.type."+
c+".removeItem: remove element (key: "+b+")",3)},type:{}};
a.storage.type.cookie=function(){var c=!1,b={support:!1,engine:"cookie",setItem:function(b,c,g){var m="";a.storage.__printSetItem("cookie",b,c);g&&(m=new Date,m.setTime(m.getTime()+864E5*g),m="; expires="+m.toGMTString());document.cookie=b+"="+escape(a.parser.json.stringify(c))+m+"; path=/"},getItem:function(b){if(0<document.cookie.length){var c=document.cookie.indexOf(b+"=");if(-1!=c){var c=c+b.length+1,g=document.cookie.indexOf(";",c);-1==g&&(g=document.cookie.length);c=a.parser.json.parse(unescape(document.cookie.substring(c,
...
{key:d}))}}}();
a.storage.type.flash=function(){function c(c){if(!1===b&&!1===d){var m=document.createElement("div");m.id="flashstoragecontent";document.body.appendChild(m);var n={id:f,rootId:m.id,flashvars:{},params:{wmode:"transparent",menu:"false",scale:"noScale",allowFullscreen:"true",allowScriptAccess:"always"}};a.loader.flash(a.url+"vendor/storage/flash/localStorage.swf",function(f){d=!0;f=document.getElementById(n.id);!0===f.testData()&&(b=!0,f.setDatabase("a_flashStorage"));!0===b&&a.isFunction(c)&&c(b)},
n)}else!0===b&&a.isFunction(c)&&c(b)}var b=!1,d=!1,f="flashstorage";return{support:function(){return b},ready:function(){return d},engine:"flash",start:function(b){c(b)},getItem:function(c){this.start();if(!0===b){var d=document.getElementById(f).getData(c);if(a.isNone(d))return a.storage.__printGetErrorItem("flash",c),null;a.storage.__printGetItem("flash",c,d);return d}return null},setItem:function(c,d){this.start();!0===b&&(a.storage.__printSetItem("flash",c,d),document.getElementById(f).setData(c,
...
a.storage.type.silverlight=function(){function c(c){if(!1===b&&!1===d){var m=document.createElement("div");m.id="__silverlightstorage";document.body.appendChild(m);var n={id:f,rootId:m.id,params:[{name:"minRuntimeVersion",value:"2.0.31005.0"},{name:"autoUpgrade",value:"true"}]};a.loader.silverlight(a.url+"vendor/storage/silverlight/silverlightStorage.xap",function(f){d=!0;!0===document.getElementById(n.id).Content.store.testData()&&(b=!0);!0===b&&a.isFunction(c)&&c(b)},n)}else!0===b&&a.isFunction(c)&&
...
null==a.storage.persistent&&(a.storage.persistent={},a.storage.persistent.support=!1,a.storage.persistent.engine=function(){return"none"},a.storage.persistent.getItem=function(){return null},a.storage.persistent.setItem=function(){},a.storage.persistent.removeItem=function(){});a.storage.support=a.storage.persistent.support;a.storage.engine=a.storage.persistent.engine;a.storage.getItem=a.storage.persistent.getItem;a.storage.setItem=a.storage.persistent.setItem;a.storage.removeItem=a.storage.persistent.removeItem;a.language=function(){function c(b,c){if(a.isNone(t[b]))return null;var d=t[b][c];if(a.isNone(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(d,e){var f=c(m,d);if(!a.isNone(f)){var g=f;if(a.isArray(e))for(var l=0,u=e.length;l<u;++l)var h=b(l+1),h=RegExp(h,"gi"),g=g.replace(h,
e[l]);else for(l in e)h=b(l),h=RegExp(h,"gi"),g=g.replace(h,e[l]);if(0<=g.indexOf("{{")&&0<=g.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],l=0,u=f.length;l<u;++l){var h=b(f[l]),p=f[l].replace("{{","").replace("}}",""),p=a.isNone(w[p])?null:w[p];a.isNone(p)||(h=RegExp(h,"gi"),g=g.replace(h,p))}return g=g.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return d}function f(b,c){a.isString(c)||(c=l);try{return b.getAttribute(c)}catch(d){return null}}function g(b){a.isNone(b)&&(b=document);var e=[];
a.isNone(f(b))||e.push(b);var g=[];b.querySelectorAll?(g=b.querySelectorAll("*["+l+"]"),0===g.length&&(g=b.querySelectorAll("*"))):g=b.getElementsByTagName("*");b=0;for(var p=g.length;b<p;++b)a.isNone(f(g[b]))||e.push(g[b]);g=0;for(b=e.length;g<b;++g){var v=e[g],p=f(v);if(!a.isNone(p)){var u=c(m,p),h={};a.isNone(u)&&(u=p);for(var u=u.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],n=0,t=u.length;n<t;++n){var x=u[n].replace("{{","").replace("}}",""),z=f(v,l+"-"+x);a.isNone(z)?(z="undefined"===w[x]?null:w[x],a.isNone(z)||
(h[x]=z)):h[x]=z}u=d(p,h);p=f(v,y);if(!a.isNone(p))try{v[p]=u}catch(E){}else if(v)if("INPUT"!==v.nodeName||"submit"!==v.type&&"reset"!==v.type)if("INPUT"===v.nodeName)try{v.placeholder=u}catch(J){}else if("FIELDSET"===v.nodeName)v.title=u;else if(!a.isNone(v.text)&&document.all)v.text=u;else if(a.isNone(v.childNodes))v.innerHTML=u;else if(p=v.childNodes.length,h=document.createTextNode(u),"leave"===q){for(u=!1;p--;)n=v.childNodes[p],3===n.nodeType&&(u||(v.insertBefore(h,n),u=!0),v.removeChild(n));
u||v.appendChild(h)}else{for(;p--;)v.removeChild(v.firstChild);v.appendChild(h)}else v.value=u}}}var m="en",n=["en","fr","de","sp"],t={},q="leave",l="data-tr",y="data-tr-attr",w={},p=!a.isNone(a.storage)&&!0===a.storage.persistent.support;if(p){var x=a.storage.persistent.getItem("a_language_store_language"),e=a.storage.persistent.getItem("a_language_store_allowed");a.isString(x)&&(m=x,g(document));a.isArray(e)&&(n=e)}return{setBehavior:function(b){q="erase"===b?"erase":"leave"},getBehavior:function(){return q},
getCurrent:function(){return m},setCurrent:function(b,c){!a.isString(b)||0>=b.length?a.console.error("a.language.setCurrent: setting a non-string lang, or empty string, as default language: "+b,1):(a.isNone(c)&&(c=!0),a.contains(n,b)||a.console.warn("a.language.setCurrent: unable to find language in available language list (value: "+b+", available: "+n.join(";")+")",2),m=b,a.isNone(t[m])&&(t[m]={}),a.console.log("a.language.setCurrent: set current language to "+m+", request update ? "+c,3),a.message.dispatch("a.language.change",
{value:m}),p&&a.storage.persistent.setItem("a_language_store_language",m),this.translate(document,c))},getAllowed:function(){return n},setAllowed:function(b){a.isString(b)&&(b=[b]);if(a.isArray(b)){n=b;var c=0;for(b=b.length;c<b;++c)a.isNone(t[c])&&(t[c]={});p&&(a.console.log("a.language.setAllowed: set allowed language to "+n,3),a.storage.persistent.setItem("a_language_store_allowed",n))}else a.console.error("a.language.setAllowed: the allowed language must be an Array (value: "+b+")",1)},getSingleTranslation:function(b,
c){return d(b,c)},addSingleTranslation:function(b,c,d,e){a.isNone(t[b])&&(a.console.warn("a.language.addSingleTranslation: be carefull, the language you submit does not seems to exist in dict (value: "+b+", dict: "+n.join(";")+")",1),t[b]={});t[b][c]=d;this.translate(document,e)},addTranslation:function(b,c,d){a.isNone(t[b])&&(t[b]={});for(var e in c)t[b][e]=c[e];this.translate(document,d)},getTranslation:function(b){return a.isString(b)?t[b]:t},translate:function(b,c){!1!==c&&g(b)},addVariable:function(b,
c){a.console.log("a.language.addVariable: add global variable (key: "+b+", value: "+c+")",3);w[b]=c},getVariable:function(b){return"undefined"===w[b]?null:w[b]},removeVariable:function(b){a.console.log("a.language.removeVariable: remove global variable (key: "+b+")",3);delete w[b]},clear:function(){t={}}}}();a.form=function(){function c(b,c){return a.isNone(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],d=b.length;d--;)c.push(b[d]);return c}function d(b){var d=c(b,"name");if(a.isNone(d)||""===d)if(d=c(b,"id"),a.isNone(d)||""===d)d=c(b,"class");return d}function f(d){var f=d.getElementsByTagName("input"),g=d.getElementsByTagName("textarea");d=d.getElementsByTagName("select");for(var f=b(f),p=f.length;p--;){var m=c(f[p],"type");a.contains(q,m)||a.isNone(m)||f.splice(p,1)}return f.concat(b(g),
b(d))}function g(b,d,f,g){var m="";a.isNone(f)||""===f||(m=c(b,"data-error-"+f));if(a.isNone(m)||""===m)m=c(b,"data-error");(a.isNone(m)||""===m)&&a.console.warn("A data-error tag has not been setted for "+d+" with value "+g+", can't proceed error show",3);a.isNone(a.language)||(m=a.language.getSingleTranslation(m,{name:f,value:g}));return{el:b,id:d,error:m}}var m="text search url tel email password".split(" "),n="number range date datetime datetime-local month time week".split(" "),t=m.concat(n,
["number","checkbox","radio","file"]),q=n.concat(m,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=f(b);for(var g={},m=b.length;m--;){var p=b[m],n=d(p),e;e=p;var q=c(e,"type"),k=e.tagName.toLowerCase();e="input"===k||"textarea"===k?"checkbox"===q?e.checked:e.value:"select"===k?e.options[e.selectedIndex].value:void 0;null!==n&&""!==n&&(a.isNone(p)||"radio"!==c(p,"type")?g[n]=""===e?null:e:p.checked&&(g[n]=""===e?null:e))}a.console.log("a.form.get: found element list:",
3);a.console.log(g,3);return g},validate:function(b){if(!a.isNone(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=f(b);for(var q=[],w="number range text search url email password color checkbox hidden radio".split(" "),p=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),x=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),e=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),r=b.length;r--;){var k=b[r],s=k.tagName.toLowerCase();if("select"!==s&&a.isNone(c(k,"formnovalidate"))){var B=c(k,"type"),v=d(k),
u=k.value,h=c(k,"required"),A=c(k,"pattern");c(k,"multiple");var D=c(k,"min"),C=c(k,"max"),z=c(k,"step"),D=a.isNone(D)||""===D?null:parseFloat(D),C=a.isNone(C)||""===C?null:parseFloat(C),z=a.isNone(z)||""===z?null:parseFloat(z);"input"!==s||a.contains(w,B)||a.isNone(B)?"number"!==B&&"range"!==B||a.isNumber(u)?"url"!==B||p.test(u)?"email"!==B||x.test(u)?"color"!==B||e.test(u)?null!==h&&a.contains(t,B)&&(""===u||a.isNone(u))?q.push(g(k,v,"required",u)):null===A||"textarea"!==s&&!a.contains(m,B)&&!a.isNone(B)||
RegExp(A).test(u)?null===D&&null==C&&null==z||!a.contains(n,B)||(s=parseFloat(u),null!==D&&s<D?q.push(g(k,v,"min",u)):null!==C&&s>C?q.push(g(k,v,"max",u)):null!==z&&0!==s%z&&q.push(g(k,v,"step",u))):q.push(g(k,v,"pattern",u)):q.push(g(k,v,null,u)):q.push(g(k,v,null,u)):q.push(g(k,v,null,u)):q.push(g(k,v,null,u)):a.console.warn("Type "+B+" for input "+v+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(q,3);return q},validateAndGet:function(b){b=
{errorList:this.validate(b),error:!1,contentList:this.get(b)};0<b.errorList.length&&(b.error=!0);return b}}}();a.state=function(){function c(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=e;e===b||0>=e;)e=Math.floor(1E5*Math.random());return e}function d(b,c){var d=[],e=b.length;c=a.isFunction(c)?c:function(){return!0};for(var f=0;f<e;++f){for(var h=!1,g=0;g<e;++g)if(f!=g&&b[f].id===b[g].id&&c(b[f])){h=!0;break}h||d.push(b[f].id)}return d}function f(b){for(var c=0,d=[],e=a.state.helper.tree.selectLevel(b,q,c);0<e.length;)d.push(e),c++,e=a.state.helper.tree.selectLevel(b,q,c);
return d}function g(b){b=m(b);for(var c=x.length,d=[];c--;){for(var e=x[c].hashtagList,f=e.length,h=!1;f--&&(h=b({hash:e[f]}),!0!==h););h||(d=d.concat(x[c].itemList.slice()),x.splice(c,1))}return d}function m(b){return function(c){if(a.isObject(c)&&0<c.hash.length){if(c.hash===b)return!0;if(0<=c.hash.indexOf("{{")&&0<=c.hash.indexOf("}}")){var d=a.state.helper.parameter.extract(c.hash);c=c.hash;for(var e=d.length;e--;)c=a.state.helper.parameter.replace(c,d[e]);return RegExp("^"+c+"$","gi").test(b)}}return!1}}
function n(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function t(b,c){var d=n(c),e=m(b);return function(b){return!0===d(b)||!0===e(b)?!0:!1}}function q(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function l(b){return a.isObject(b)?b.id:-1}function y(b){return a.isObject(b)&&a.isObject(b.error)?b.error:null}function w(c){var e=a.deepClone(p),n=a.deepClone(p),v=a.deepClone(p),u=g(c.value),h=m(c.old),u=t(c.old,u),r=m(c.value);a.state.helper.tree.selectBranch(e,
q,u);a.state.helper.tree.selectBranch(n,q,r);a.state.helper.tree.selectBranch(v,q,m("*"));var u=a.state.helper.tree.flat(e.concat(n),q),w=d(u,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,q,r)&&!a.state.helper.tree.isInBranch(b,q,h)?!1:!0}),x=a.state.helper.tree.flat(v,q,l),e=f(e),y=f(n);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+w+" (does not mean all of them will be loaded)",3);var E=
b();a.state.helper.chainer("unload",e,w,-1,function(){a.state.helper.chainer("load",y,w,E,function(){0<v.length?(v=[v],a.console.log("a.state: wildcard allowed to proceed change: "+x+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",v,x,-1,function(){a.state.helper.chainer("load",v,x,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var p=[],x=[],e=-1,r=[];a.message.addListener("a.page.event.hash",w);a.message.addListener("a.message.clear",
function(){a.message.addListener("a.page.event.hash",w)});return{clear:function(){p=[]},tree:function(){return a.deepClone(p)},add:function(b,d){if(!a.isObject(b))return null;if(a.isArray(b))for(var e=0,f=b.length;e<f;++e)this.add(b[e]);else{b.hash=a.isString(b.hash)?b.hash:"";a.isObject(b.include)||(b.include={});b.include.css=c(b.include.css);b.include.js=c(b.include.js);b.include.translate=c(b.include.translate);b.include.html=a.isString(b.include.html)?b.include.html:null;for(var g=["preLoad",
...
1),e&&a.console.warn("a.state.add : The wildcard has children (not allowed)",1),b.parent=null,h=!1,b.children=[]);g=[];e&&(g=b.children.slice());b.children=[];a.isNone(b.id)&&(b.id=1);for(;!a.isNone(a.state.helper.tree.getItem(p,q,n(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(h){h=a.state.helper.tree.getItem(p,q,n(b.parent));if(a.isNone(h))return null;h.children.push(b)}else p.push(b);h=b.id;e=0;for(f=g.length;e<f;++e)a.isObject(g[e])&&(g[e].parent=h,this.add(g[e]));"*"===b.hash&&a.state.helper.chainer("load",
[[b]],[h],-1,function(){});!0===b.bootOnLoad&&(g=a.deepClone(b),g.data=g.converter=g.options=null,g.preLoad=g.load=g.postLoad=null,g.preUnload=g.unload=g.postUnload=null,d=a.isFunction(d)?d:function(){},a.state.helper.chainer("load",[[g]],[h],-1,d));return h}},getById:function(b){return a.state.helper.tree.getItem(p,q,n(b))},removeById:function(b){var c=a.state.helper.tree.getItem(p,q,n(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(p,q,function(b){return b===
c?!1:!0})},loadById:function(b,e,g){var v=a.deepClone(p),u=a.page.event.hash.getHash(),h=a.deepClone(p);a.state.helper.tree.selectBranch(v,q,n(b));a.state.helper.tree.selectBranch(h,q,m(u));var r=a.state.helper.tree.flat(v,q),h=a.state.helper.tree.flat(h,q),h=d(h.concat(r)),v=f(v);g=a.isFunction(g)?g:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+h+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",v,h,-1,g);a.isNone(e)&&(e=u);b={id:b,
itemList:a.state.helper.tree.flat(r,q,l),hashtagList:c(e)};x.push(b)},unloadById:function(b,c){for(var d=this.getById(b),d=f([d]),e=[],g=x.length;g--;)e=e.concat(x[g].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+e+" (does not mean all of them will be unloaded)",3);g=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",d,e,-1,g)},forceReloadById:function(c,d){for(var e=a.isFunction(d)?d:function(){},g=x.length,n=[],h=a.deepClone(x);g--;)a.contains(x[g].itemList,
c)&&n.push(x[g].hashtagList);if(0<n.length)this.unloadById(c,function(){for(var b=n.length;b--;)a.state.loadById(c,n[b]);x=h;e()});else{var g=a.deepClone(p),r=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(g,q,m(r));for(var r=a.state.helper.tree.flat(g,q),t=r.length;t--;)if(r[t].id===c){var w=f([r[t]]),y=a.state.helper.tree.flat(g,q,l);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+y+" (does not mean all of them will be loaded/unloaded)",3);var E=b();a.state.helper.chainer("unload",
w,y,-1,function(){a.state.helper.chainer("load",w,y,E,e)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(p,q,m(b)):!1},__currentGeneratedId:function(){return e},__getError:function(b,c){var d=b.id;c="_"+c;var e=a.deepClone(p);a.state.helper.tree.selectBranch(e,q,n(d));for(var d=a.state.helper.tree.flat(e,q,y),e=[c,c.substring(0,c.length-1)+"x",c.substring(0,c.length-2)+"xx","generic","_generic"],f=0,h=e.length;f<h;++f){var g;a:{g=e[f];for(var l=d.length;l--;){var m=
d[l];if(!a.isNone(m))for(var r in m)if(r==g){g=m[r];break a}}g=null}if(!a.isNone(g))return g}return null},type:{add:function(b,c){r[b]=c},get:function(b){return a.isFunction(r[b])?r[b]:null},list:function(){return r}},helper:{tree:{},chainer:{},parameter:{}}}}();
a.state.helper.tree={flat:function(c,b,d){var f=[];if(!a.isArray(c)||!a.isFunction(b))return[];d=a.isFunction(d)?d:function(b){return b};for(var g=0,m=c.length;g<m;++g){var n=this.flat(b(c[g]),b,d);f.push(d(c[g]));0<n.length&&(f=f.concat(n))}return f},getItem:function(c,b,d){if(!a.isArray(c)||!a.isFunction(d)||!a.isFunction(b))return null;for(var f=0,g=c.length;f<g;++f){if(!0===d(c[f]))return c[f];var m=this.getItem(b(c[f]),b,d);if(!a.isNone(m))return m}return null},isInBranch:function(c,b,d){c=this.getItem(c,
b,d);return a.isNone(c)?!1:!0},selectBranch:function(c,b,d){if(a.isArray(c)&&a.isFunction(b)&&a.isFunction(d))for(var f=c.length;f--;){var g=b(c[f]);!1===d(c[f])&&a.isNone(this.getItem(g,b,d))?c.splice(f,1):0<g.length&&this.selectBranch(g,b,d)}},selectLevel:function(c,b,d){if(!a.isArray(c)||!a.isFunction(b))return[];var f=[],g=c.length;if(a.isNone(d)||isNaN(d)||0>=d)return c;for(d--;g--;){var m=b(c[g]);0<m.length&&(f=f.concat(this.selectLevel(m,b,d)))}return f}};
a.state.helper.chainer=function(c,b,d,f,g){function m(b,c){var d={};a.isNone(b)||(d.resource=b);a.isNone(c)||(d.status=c);var f=a.state.__getError(e,c);a.message.dispatch("a.state.error",d);a.isNone(f)||(a.isString(f)?window.location.href="#"+f:a.isFunction(f)?f(e.id,b,c):a.console.error("a.state.helper.chainer.__error: error resolver cannot determine action to perform, please check your different error handler (status: "+c+", state id: "+e.id+")"))}function n(b){return function(c){p(b,function(){c.done()})}}
...
{};a.isObject(e.a)||(e.a=e.appstorm={},e.a.parameter=e.appstorm.parameter={});a.isNone(b)?e=c:(e.a.parameter[b]=c,e.appstorm.parameter=e.a.parameter,a.isNone(e[b])&&(e[b]=c));d.setData("data",e);d.done()}):function(c){a.isNone(c.getData("data"))&&c.setData("data",{});(new a.ajax(f,function(d){if(a.isNone(b))c.setData("data",d);else{var e=c.getData("data");e[b]=d;c.setData("data",e)}c.done()},m)).send()}}function y(b,c){for(var d=new a.callback.synchronizer,e=b.include.css,f=b.include.js,g=b.include.html,
k=b.include.translate,n=b.data,p=b.title,q=b.options,r=b.converter,w=b.hash,x=e.length,y=f.length;x--;)d.addCallback(t("css",e[x]));for(;y--;)d.addCallback(t("js",f[y]));if(!a.isNone(a.language)&&0<k.length)for(e=k.length;e--;)d.addCallback(t("json",k[e],function(b){for(var c in b)a.language.addTranslation(c,b[c],!0)}));a.isString(g)&&(g=a.state.helper.parameter.extrapolate(g,a.page.event.hash.getHash(),w),d.addCallback(function(b){b.setData("html",g);a.page.template.get(g,{},b.done,m)}));if(a.isString(n)||
a.isObject(n))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(n))d.addCallback(l(null,n,q,w));else for(var G in n)a.isObject(n[G])&&a.isString(n[G].url)?(a.isObject(n[G].options)||(n[G].options={type:"json"}),d.addCallback(l(G,n[G].url,n[G].options,w))):d.addCallback(l(G,n[G],q,w));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNone(r)||r(b.data);a.isNone(p)||(p=a.state.helper.parameter.extrapolate(p,a.page.event.hash.getHash(),
w),a.isNone(a.language)?document.title=p:document.title=a.language.getSingleTranslation(p));var d=b.data,e=b.html,d=a.isNone(d)?{}:d;a.isNone(e)?a.isFunction(c)&&c(b,null):a.page.template.get(e,d,function(d){a.isFunction(c)&&c(b,d)})});d.setFail(m);d.start()}function w(b,d){e=b;var g=new a.callback.chainer;"unload"===c?g.addCallback(b.preUnload,b.unload,b.postUnload):g.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==f||0<=f&&a.state.__currentGeneratedId()===f)?b.preLoad(c):c.done()},function(c){y(b,
function(d,e){a.isFunction(b.load)&&(-1==f||0<=f&&a.state.__currentGeneratedId()===f)&&b.load(e);var g=c.getFullData()||{};if(a.isObject(d.data))for(var k in d.data)g[k]=d.data[k];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==f||0<=f&&a.state.__currentGeneratedId()===f)?b.postLoad(c):c.done()},function(c){var d={id:b.id,value:b.id};a.message.dispatch("a.state.load",d);a.message.dispatch("a.state.load-"+b.id,d);c.done()});g.setSuccess(d);g.setFail(m);g.start()}function p(b,
c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){w(b,function(){c.done()})})}(b[f]);e.setSuccess(c);e.setFail(m);e.start()}var x=b.length,e=null;c="unload"===c?"unload":"load";d=d||[];var r=new a.callback.chainer;if("unload"===c)for(;x--;)r.addCallback(n(b[x]));else for(var k=0;k<x;)r.addCallback(n(b[k])),k++;r.setSuccess(g);r.setFail(m);r.start()};
a.state.helper.parameter={extract:function(c,b){var d=/\{\{(\s*\w+\s*:\s*[a-z0-9_\-\[\]\(\)\^.\|\+\*\?\\\/]+\s*)\}\}/gmi,f=/^\s+|\s+$/g,g=!a.isNone(b);g&&(d=b);for(var m=[],n;n=d.exec(c);){var t=null,t=g?["hash",n[1]]:n[1].split(":",2);m.push({original:n[0].replace(f,""),name:t[0].replace(f,""),regex:t[1].replace(f,""),start:n.index})}return m},replace:function(c,b,d){d=a.isNone(d)?"("+b.regex+")":d;return c.substr(0,b.start)+d+c.substr(b.start+b.original.length)},extrapolate:function(c,b,d,f){if(a.isString(c)&&
0<=c.indexOf("{{")&&0<=c.indexOf("}}")){for(var g=this.extract(c),m=this.extract(d),n=this.extract(c,/\{\{(\s*\w+\s*)\}\}/gmi),g=g.concat(n),n=m.length;n--;)d=this.replace(d,m[n]);if(n=RegExp("^"+d+"$","gi").exec(b)){b=0;for(d=m.length;b<d;++b)m[b].value=n[b+1];for(var n=0,t=g.length;n<t;++n)for(b=0;b<d;++b)m[b].name===g[n].regex&&"hash"===g[n].name&&(g[n].value=m[b].value)}m=g.length;for(f=!1===f?function(b,c,d){return d}:this.replace;m--;){b=g[m];"hash"!==b.name&&"hashtag"!==b.name||a.isNone(b.value)||
...
(d=a.state.type.list(),a.isObject(d)))for(var q in d)q===b.name&&(n=d[q],c=a.isFunction(n)?f(c,b,n(b.regex)):f(c,b,n))}}return c}};a.page={};
a.page.template={__tmpl:{},get:function(c,b,d,f){var g=null;a.isObject(window.Handlebars)&&(g=window.Handlebars);if(null==g)a.console.error("a.page.template.get: unable to find Handlebars.JS ! Can't proceed",1);else{var m=c.replace(/[^a-zA-Z0-9\\-]/g,"_"),n="a_tmpl_"+m+"_a",t=function(b,c,d){a.isFunction(b)&&(a.isNone(g.to_html)?(c=g.compile(a.page.template.__tmpl[c]),b(c(d))):b(g.to_html(a.page.template.__tmpl[c],d)))};a.isString(this.__tmpl[n])?(a.console.log("a.page.template.get: loading "+n+" from cache",
3),t(d,n,b)):document.getElementById(n)?(this.__tmpl[n]||(a.console.log("a.page.template.get: loading "+n+" from inner html page",3),this.__tmpl[n]=document.getElementById(n).innerHTML),t(d,n,b)):document.getElementById(m)?(this.__tmpl[m]||(a.console.log("a.page.template.get: loading "+m+" from inner html page",3),this.__tmpl[m]=document.getElementById(m).innerHTML),t(d,m,b)):(a.console.log("a.page.template.get: loading "+c+" from external resource",3),a.loader.html(c,function(c,f,g){a.page.template.__tmpl[n]||
(a.page.template.__tmpl[n]=c);t(d,n,b)},{},f))}},htmlToDom:function(c){var b=document.createElement("div");b.innerHTML=c.replace(/^\s+|\s+$/g,"");c=b.childNodes;for(var b=[],d=0,f=c.length;d<f;++d){var g=c.item(d);!a.isObject(g)||"1"!==g.nodeType.toString()&&"3"!==g.nodeType.toString()||b.push(g)}return b},remove:function(c,b){for(;c.firstChild;)c.removeChild(c.firstChild);a.isFunction(b)&&b()},append:function(c,b,d){var f=this.htmlToDom(b);if(a.isObject(f))for(var g=0,m=f.length;g<m;++g)c.appendChild(f[g]);
a.isNone(a.language)||a.language.translate(c);a.isFunction(d)&&d(b)},replace:function(c,b,d){this.remove(c);this.append(c,b,d)}};
a.page.event=function(){function c(b,c){a.isObject(c)||(c={});return function(){a.message.dispatch("a.page.event."+b,c)}}function b(){var b=(new Date).getTime();b>n+2*m&&(a.console.log("a.page.event.hibernate: hibernate mode has been detected",3),c("hibernate")());n=b}function d(b,c){window.addEventListener?window.addEventListener(b,c,!1):window.attachEvent&&window.attachEvent("on"+b,c)}function f(b){var d=window.location.hash?window.location.hash.substring(1):null;if(t!==d){if(!0!==b){for(q.push({hash:d,
time:(new Date).getTime()});1E3<q.length;)q.shift();a.console.log("a.page.event.hash: hash change (previous: "+t+", new: "+d+")",3);c("hash",{value:d,old:t})()}t=d}}var g={},m=1E4,n=(new Date).getTime(),t=null,q=[];g.hash={getHash:function(){return window.location.hash?window.location.hash.substring(1):null},getPreviousHash:function(){return t},setPreviousHash:function(b){a.console.log("a.page.event.hash.setPreviousHash: change previous hash to "+b,3);t=b},trace:function(){return q}};f(!0);!a.isNone(window.onhashchange)&&
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=f:a.timer.add(f,null,50);var l=["resize","load","unload"],y;for(y in l)d(l[y],c(l[y]));d("load",function(){a.timer.add(b,null,m)});return g}();a.translate=a.i18n=function(){function c(b,c){return b.getAttribute(c)||b.getAttribute("a-"+c)||b.getAttribute("data-"+c)||""}function b(b,d){var e=c(b,p);if(e&&""!=e)try{b[e]=d}catch(f){}else if("INPUT"==b.nodeName)if("submit"==b.type||"reset"==b.type)b.value=d;else try{b.placeholder=d}catch(g){}else if("FIELDSET"===b.nodeName)b.title=d;else if(""!==c(b,x))a.dom.el(b).empty().append(document.createTextNode(d));else{for(var e=d.split("<tag>"),h=0,l=e.length,m=0,n=b.childNodes.length;m<n&&h<l;++m){var q=
b.childNodes[m];3==q.nodeType&&(q.nodeValue=e[h],h++)}if(h!=l)for(;h<l;++h)b.appendChild(document.createTextNode(e[h]));if(m!=n)for(;n-- >m;)q=b.childNodes[n],3==q.nodeType&&b.removeChild(q)}}function d(d){d=d||document;d=a.dom.el(d);var f=l[q];d.attr(w+",a-"+w+",data-"+w).each(function(){var d=c(this,w),g=f[d]||"";""===g&&(g=d);for(var g=g.match(e),g=a.match(g,function(b){return b.replace("{{","").replace("}}","")}),k={},h=g.length;h--;){var l=g[h],m=c(this,w+"-"+l);m&&(k[l]=m)}d=t(d,k,!0);b(this,
d)})}function f(){return q}function g(b,c){q=b;!1!==c&&d()}function m(b,c,e,f){l[b]||(l[b]={});l[b][c]=e;!1!==f&&d()}function n(b,c,e){if(null===c)delete l[b];else for(var f in c)m(b,f,c[f],!1);!1!==e&&d()}function t(b,c,d){function f(b){for(var d=[c,y],e=0;2>e;++e)for(var g in d[e])if(b==="{{"+g+"}}")return d[e][g];return""}b=l[q][b]||null;if(a.isNull(b))return"";if(!1===d)return b;d=b.match(e)||[];for(var g=0,h=d.length;g<h;++g){var m=d[g];b=b.replace(m,f(m))}return b.replace(e,"")}var q="en-US",
l={},y={},w="tr",p="custom-tr",x="erase-tr",e=/\{\{[a-z0-9\-_]+\}\}/gi;if(a.storage&&a.storage.persistent.support){var r=a.storage.persistent.getItem("_app.language");a.isString(r)&&0<r.length&&(q=r,d())}return{getLanguage:f,getCurrent:f,setLanguage:g,setCurrent:g,translate:d,i18n:d,getDictionnary:function(b){return b?l[b]||{}:l},getGlobalVariable:function(b){return y[b]||""},setGlobalVariable:function(b,c){y[b]=c},add:m,addTranslation:m,get:t,getTranslation:t,set:n,setTranslation:n}}();
