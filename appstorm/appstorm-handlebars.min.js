...
this.params.header[l]),!r&&a.contains(p,l)&&(r=!0);r||"POST"!==e||this.request.setRequestHeader("Content-type","application/x-www-form-urlencoded");this.request.send(b);return!1===d?this.parseResult(this.params,this.request):"No return in async mode"};
