(function(){function e(c,f,b){c.addEventListener?c.addEventListener(f,b,!1):c.attachEvent("on"+f,b)}function b(c){if("keypress"==c.type){var f=String.fromCharCode(c.which);c.shiftKey||(f=f.toLowerCase());return f}return t[c.which]?t[c.which]:u[c.which]?u[c.which]:String.fromCharCode(c.which).toLowerCase()}function g(c){c=c||{};var f=!1,b;for(b in m)c[b]?f=!0:m[b]=0;f||(r=!1)}function d(f,b,p,s,d){var g,e,r=[],h=p.type;if(!c[f])return[];"keyup"==h&&q(f)&&(b=[f]);for(g=0;g<c[f].length;++g)(e=c[f][g],
e.seq&&m[e.seq]!=e.level||h!=e.action||("keypress"!=h||p.metaKey||p.ctrlKey)&&b.sort().join(",")!==e.modifiers.sort().join(","))||(s&&e.combo==d&&c[f].splice(g,1),r.push(e));return r}function h(c){var f=[];c.shiftKey&&f.push("shift");c.altKey&&f.push("alt");c.ctrlKey&&f.push("ctrl");c.metaKey&&f.push("meta");return f}function k(c,f,b){A.stopCallback(f,f.target||f.srcElement,b)||!1!==c(f,b)||(f.preventDefault&&f.preventDefault(),f.stopPropagation&&f.stopPropagation(),f.returnValue=!1,f.cancelBubble=
!0)}function n(c){"number"!==typeof c.which&&(c.which=c.keyCode);var f=b(c);f&&("keyup"==c.type&&s==f?s=!1:A.handleKey(f,h(c),c))}function q(c){return"shift"==c||"ctrl"==c||"alt"==c||"meta"==c}function l(c,f,b){if(!b){if(!z){z={};for(var p in t)95<p&&112>p||t.hasOwnProperty(p)&&(z[t[p]]=p)}b=z[c]?"keydown":"keypress"}"keypress"==b&&f.length&&(b="keydown");return b}function x(e,h,y,n,t){f[e+":"+y]=h;e=e.replace(/\s+/g," ");var A=e.split(" "),F,u,C=[];if(1<A.length){var z=e,I=y;m[z]=0;I||(I=l(A[0],
[]));e=function(){r=I;++m[z];clearTimeout(p);p=setTimeout(g,1E3)};y=function(c){k(h,c,z);"keyup"!==I&&(s=b(c));setTimeout(g,10)};for(n=0;n<A.length;++n)x(A[n],n<A.length-1?e:y,I,z,n)}else{u="+"===e?["+"]:e.split("+");for(A=0;A<u.length;++A)F=u[A],v[F]&&(F=v[F]),y&&"keypress"!=y&&w[F]&&(F=w[F],C.push("shift")),q(F)&&C.push(F);y=l(F,C,y);c[F]||(c[F]=[]);d(F,C,{type:y},!n,e);c[F][n?"unshift":"push"]({callback:h,modifiers:C,action:y,seq:n,level:t,combo:e})}}for(var t={8:"backspace",9:"tab",13:"enter",
...
"return":"enter",escape:"esc",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},z,c={},f={},m={},p,s=!1,r=!1,y=1;20>y;++y)t[111+y]="f"+y;for(y=0;9>=y;++y)t[y+96]=y;e(document,"keypress",n);e(document,"keydown",n);e(document,"keyup",n);var A={bind:function(c,f,b){c=c instanceof Array?c:[c];for(var p=0;p<c.length;++p)x(c[p],f,b);return this},unbind:function(c,f){return A.bind(c,function(){},f)},trigger:function(c,b){if(f[c+":"+b])f[c+":"+b]({},c);return this},reset:function(){c={};
f={};return this},stopCallback:function(c,f){return-1<(" "+f.className+" ").indexOf(" mousetrap ")?!1:"INPUT"==f.tagName||"SELECT"==f.tagName||"TEXTAREA"==f.tagName||f.contentEditable&&"true"==f.contentEditable},handleKey:function(c,f,b){f=d(c,f,b);var p,m={},s=0,e=!1;for(p=0;p<f.length;++p)f[p].seq&&(s=Math.max(s,f[p].level));for(p=0;p<f.length;++p)f[p].seq?f[p].level==s&&(e=!0,m[f[p].seq]=1,k(f[p].callback,b,f[p].combo)):e||k(f[p].callback,b,f[p].combo);b.type==r&&!q(c)&&g(m)}};window.Mousetrap=
A;"function"===typeof define&&define.amd&&define(A)})();(function(){function e(c){var f,p,m,s="json"==c;if(s||"json-stringify"==c||"json-parse"==c){if("json-stringify"==c||s){if(f="function"==typeof l.stringify&&A){(m=function(){return 1}).toJSON=m;try{f="0"===l.stringify(0)&&"0"===l.stringify(new Number)&&'""'==l.stringify(new String)&&l.stringify(h)===b&&l.stringify(b)===b&&l.stringify()===b&&"1"===l.stringify(m)&&"[1]"==l.stringify([m])&&"[null]"==l.stringify([b])&&"null"==l.stringify(d)&&"[null,null,null]"==l.stringify([b,h,d])&&'{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==
...
p=5==m.a.length&&1==m.a[0])){try{p=!l.parse('"\t"')}catch(r){}if(p)try{p=1!=l.parse("01")}catch(y){}}}catch(n){p=!1}if(!s)return p}return f&&p}}var b=void 0,g=!0,d=null,h={}.toString,k,n,q="function"===typeof define&&define.c,l=!q&&"object"==typeof exports&&exports;l||q?"object"==typeof JSON&&JSON?q?l=JSON:(l.stringify=JSON.stringify,l.parse=JSON.parse):q&&(l=this.JSON={}):l=this.JSON||(this.JSON={});var x,t,u,w,v,z,c,f,m,p,s,r,y,A=new Date(-0xc782b5b800cec),B,D,E;try{A=-109252==A.getUTCFullYear()&&
0===A.getUTCMonth()&&1==A.getUTCDate()&&10==A.getUTCHours()&&37==A.getUTCMinutes()&&6==A.getUTCSeconds()&&708==A.getUTCMilliseconds()}catch(G){}e("json")||(A||(B=Math.floor,D=[0,31,59,90,120,151,181,212,243,273,304,334],E=function(c,f){return D[f]+365*(c-1970)+B((c-1969+(f=+(1<f)))/4)-B((c-1901+f)/100)+B((c-1601+f)/400)}),(k={}.hasOwnProperty)||(k=function(c){var f={},p;(f.__proto__=d,f.__proto__={toString:1},f).toString!=h?k=function(c){var f=this.__proto__;c=c in(this.__proto__=d,this);this.__proto__=
f;return c}:(p=f.constructor,k=function(c){var f=(this.constructor||p).prototype;return c in this&&!(c in f&&this[c]===f[c])});f=d;return k.call(this,c)}),n=function(c,f){var p=0,b,m,s;(b=function(){this.valueOf=0}).prototype.valueOf=0;m=new b;for(s in m)k.call(m,s)&&p++;b=m=d;p?p=2==p?function(c,f){var p={},b="[object Function]"==h.call(c),m;for(m in c)b&&"prototype"==m||k.call(p,m)||(p[m]=1)&&k.call(c,m)&&f(m)}:function(c,f){var p="[object Function]"==h.call(c),b,m;for(b in c)p&&"prototype"==b||
!k.call(c,b)||(m="constructor"===b)||f(b);(m||k.call(c,b="constructor"))&&f(b)}:(m="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),p=function(c,f){var p="[object Function]"==h.call(c),b;for(b in c)p&&"prototype"==b||!k.call(c,b)||f(b);for(p=m.length;b=m[--p];k.call(c,b)&&f(b));});p(c,f)},e("json-stringify")||(x={"\\":"\\\\",'"':'\\"',"\b":"\\b","\f":"\\f","\n":"\\n","\r":"\\r","\t":"\\t"},t=function(c,f){return("000000"+(f||0)).slice(-c)},
u=function(c){for(var f='"',b=0,p;p=c.charAt(b);b++)f+=-1<'\\"\b\f\n\r\t'.indexOf(p)?x[p]:x[p]=" ">p?"\\u00"+t(2,p.charCodeAt(0).toString(16)):p;return f+'"'},w=function(c,f,p,m,s,e,r){var y=f[c],l,A,x,q,v,z,D,G,H;if("object"==typeof y&&y)if(l=h.call(y),"[object Date]"!=l||k.call(y,"toJSON"))"function"==typeof y.toJSON&&("[object Number]"!=l&&"[object String]"!=l&&"[object Array]"!=l||k.call(y,"toJSON"))&&(y=y.toJSON(c));else if(y>-1/0&&y<1/0){if(E){x=B(y/864E5);for(l=B(x/365.2425)+1970-1;E(l+1,0)<=
x;l++);for(A=B((x-E(l,0))/30.42);E(l,A+1)<=x;A++);x=1+x-E(l,A);q=(y%864E5+864E5)%864E5;v=B(q/36E5)%24;z=B(q/6E4)%60;D=B(q/1E3)%60;q%=1E3}else l=y.getUTCFullYear(),A=y.getUTCMonth(),x=y.getUTCDate(),v=y.getUTCHours(),z=y.getUTCMinutes(),D=y.getUTCSeconds(),q=y.getUTCMilliseconds();y=(0>=l||1E4<=l?(0>l?"-":"+")+t(6,0>l?-l:l):t(4,l))+"-"+t(2,A+1)+"-"+t(2,x)+"T"+t(2,v)+":"+t(2,z)+":"+t(2,D)+"."+t(3,q)+"Z"}else y=d;p&&(y=p.call(f,c,y));if(y===d)return"null";l=h.call(y);if("[object Boolean]"==l)return""+
y;if("[object Number]"==l)return y>-1/0&&y<1/0?""+y:"null";if("[object String]"==l)return u(y);if("object"==typeof y){for(c=r.length;c--;)if(r[c]===y)throw TypeError();r.push(y);G=[];f=e;e+=s;if("[object Array]"==l){A=0;for(c=y.length;A<c;H||(H=g),A++)l=w(A,y,p,m,s,e,r),G.push(l===b?"null":l);c=H?s?"[\n"+e+G.join(",\n"+e)+"\n"+f+"]":"["+G.join(",")+"]":"[]"}else n(m||y,function(c){var f=w(c,y,p,m,s,e,r);f!==b&&G.push(u(c)+":"+(s?" ":"")+f);H||(H=g)}),c=H?s?"{\n"+e+G.join(",\n"+e)+"\n"+f+"}":"{"+G.join(",")+
"}":"{}";r.pop();return c}},l.stringify=function(c,f,p){var b,m,s,e,d,g;if("function"==typeof f||"object"==typeof f&&f)if("[object Function]"==h.call(f))m=f;else if("[object Array]"==h.call(f))for(s={},e=0,d=f.length;e<d;g=f[e++],("[object String]"==h.call(g)||"[object Number]"==h.call(g))&&(s[g]=1));if(p)if("[object Number]"==h.call(p)){if(0<(p-=p%1))for(b="",10<p&&(p=10);b.length<p;b+=" ");}else"[object String]"==h.call(p)&&(b=10>=p.length?p:p.slice(0,10));return w("",(g={},g[""]=c,g),m,s,b,"",
[])}),e("json-parse")||(v=String.fromCharCode,z={"\\":"\\",'"':'"',"/":"/",b:"\b",t:"\t",n:"\n",f:"\f",r:"\r"},c=function(){r=y=d;throw SyntaxError();},f=function(){for(var f=y,p=f.length,b,m,s,e,h;r<p;)if(b=f.charAt(r),-1<"\t\r\n ".indexOf(b))r++;else{if(-1<"{}[]:,".indexOf(b))return r++,b;if('"'==b){m="@";for(r++;r<p;)if(b=f.charAt(r)," ">b)c();else if("\\"==b)if(b=f.charAt(++r),-1<'\\"/btnfr'.indexOf(b))m+=z[b],r++;else if("u"==b){s=++r;for(e=r+4;r<e;r++)b=f.charAt(r),"0"<=b&&"9">=b||"a"<=b&&"f">=
b||"A"<=b&&"F">=b||c();m+=v("0x"+f.slice(s,r))}else c();else{if('"'==b)break;m+=b;r++}if('"'==f.charAt(r))return r++,m}else{s=r;"-"==b&&(h=g,b=f.charAt(++r));if("0"<=b&&"9">=b){for("0"==b&&(b=f.charAt(r+1),"0"<=b&&"9">=b)&&c();r<p&&(b=f.charAt(r),"0"<=b&&"9">=b);r++);if("."==f.charAt(r)){for(e=++r;e<p&&(b=f.charAt(e),"0"<=b&&"9">=b);e++);e==r&&c();r=e}b=f.charAt(r);if("e"==b||"E"==b){b=f.charAt(++r);"+"!=b&&"-"!=b||r++;for(e=r;e<p&&(b=f.charAt(e),"0"<=b&&"9">=b);e++);e==r&&c();r=e}return+f.slice(s,
r)}h&&c();if("true"==f.slice(r,r+4))return r+=4,g;if("false"==f.slice(r,r+5))return r+=5,!1;if("null"==f.slice(r,r+4))return r+=4,d}c()}return"$"},m=function(b){var p,s;"$"==b&&c();if("string"==typeof b){if("@"==b.charAt(0))return b.slice(1);if("["==b){for(p=[];;s||(s=g)){b=f();if("]"==b)break;s&&(","==b?(b=f(),"]"==b&&c()):c());","==b&&c();p.push(m(b))}return p}if("{"==b){for(p={};;s||(s=g)){b=f();if("}"==b)break;s&&(","==b?(b=f(),"}"==b&&c()):c());","!=b&&"string"==typeof b&&"@"==b.charAt(0)&&":"==
f()||c();p[b.slice(1)]=m(f())}return p}c()}return b},s=function(c,f,m){m=p(c,f,m);m===b?delete c[f]:c[f]=m},p=function(c,f,b){var p=c[f],m;if("object"==typeof p&&p)if("[object Array]"==h.call(p))for(m=p.length;m--;)s(p,m,b);else n(p,function(c){s(p,c,b)});return b.call(c,f,p)},l.parse=function(b,s){var e,g;r=0;y=b;e=m(f());"$"!=f()&&c();r=y=d;return s&&"[object Function]"==h.call(s)?p((g={},g[""]=e,g),"",s):e}));q&&define(function(){return l})})();(function(e){var b={VERSION:"1.0.0",COMPILER_REVISION:4,REVISION_CHANGES:{1:"<= 1.0.rc.2",2:"== 1.0.0-rc.3",3:"== 1.0.0-rc.4",4:">= 1.0.0"},helpers:{},partials:{}},g=Object.prototype.toString;b.registerHelper=function(c,f,m){if("[object Object]"===g.call(c)){if(m||f)throw new b.Exception("Arg not supported with multiple helpers");b.Utils.extend(this.helpers,c)}else m&&(f.not=m),this.helpers[c]=f};b.registerPartial=function(c,f){"[object Object]"===g.call(c)?b.Utils.extend(this.partials,c):this.partials[c]=
f};b.registerHelper("helperMissing",function(c){if(2===arguments.length)return e;throw Error("Missing helper: '"+c+"'");});b.registerHelper("blockHelperMissing",function(c,f){var m=f.inverse||function(){},p=f.fn,s=g.call(c);"[object Function]"===s&&(c=c.call(this));return!0===c?p(this):!1===c||null==c?m(this):"[object Array]"===s?0<c.length?b.helpers.each(c,f):m(this):p(c)});b.K=function(){};b.createFrame=Object.create||function(c){b.K.prototype=c;c=new b.K;b.K.prototype=null;return c};b.logger={DEBUG:0,
INFO:1,WARN:2,ERROR:3,level:3,methodMap:{0:"debug",1:"info",2:"warn",3:"error"},log:function(c,f){if(b.logger.level<=c){var m=b.logger.methodMap[c];"undefined"!==typeof console&&console[m]&&console[m].call(console,f)}}};b.log=function(c,f){b.logger.log(c,f)};b.registerHelper("each",function(c,f){var m=f.fn,p=f.inverse,s=0,e="",d;"[object Function]"===g.call(c)&&(c=c.call(this));f.data&&(d=b.createFrame(f.data));if(c&&"object"===typeof c)if(c instanceof Array)for(var h=c.length;s<h;s++)d&&(d.index=
s),e+=m(c[s],{data:d});else for(h in c)c.hasOwnProperty(h)&&(d&&(d.key=h),e+=m(c[h],{data:d}),s++);0===s&&(e=p(this));return e});b.registerHelper("if",function(c,f){"[object Function]"===g.call(c)&&(c=c.call(this));return!c||b.Utils.isEmpty(c)?f.inverse(this):f.fn(this)});b.registerHelper("unless",function(c,f){return b.helpers["if"].call(this,c,{fn:f.inverse,inverse:f.fn})});b.registerHelper("with",function(c,f){"[object Function]"===g.call(c)&&(c=c.call(this));if(!b.Utils.isEmpty(c))return f.fn(c)});
...
23:[2,18],25:[2,18]}],defaultActions:{17:[2,1]},parseError:function(c,f){throw Error(c);},parse:function(c){var f=[0],b=[null],m=[],d=this.table,e="",g=0,h=0,l=0;this.lexer.setInput(c);this.lexer.yy=this.yy;this.yy.lexer=this.lexer;this.yy.parser=this;"undefined"==typeof this.lexer.yylloc&&(this.lexer.yylloc={});c=this.lexer.yylloc;m.push(c);var n=this.lexer.options&&this.lexer.options.ranges;"function"===typeof this.yy.parseError&&(this.parseError=this.yy.parseError);for(var k,x,t,q,v={},u,w;;){t=
f[f.length-1];if(this.defaultActions[t])q=this.defaultActions[t];else{if(null===k||"undefined"==typeof k)k=this.lexer.lex()||1,"number"!==typeof k&&(k=this.symbols_[k]||k);q=d[t]&&d[t][k]}if("undefined"===typeof q||!q.length||!q[0]){var z="";if(!l){w=[];for(u in d[t])this.terminals_[u]&&2<u&&w.push("'"+this.terminals_[u]+"'");z=this.lexer.showPosition?"Parse error on line "+(g+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+w.join(", ")+", got '"+(this.terminals_[k]||k)+"'":"Parse error on line "+
(g+1)+": Unexpected "+(1==k?"end of input":"'"+(this.terminals_[k]||k)+"'");this.parseError(z,{text:this.lexer.match,token:this.terminals_[k]||k,line:this.lexer.yylineno,loc:c,expected:w})}}if(q[0]instanceof Array&&1<q.length)throw Error("Parse Error: multiple actions possible at state: "+t+", token: "+k);switch(q[0]){case 1:f.push(k);b.push(this.lexer.yytext);m.push(this.lexer.yylloc);f.push(q[1]);k=null;x?(k=x,x=null):(h=this.lexer.yyleng,e=this.lexer.yytext,g=this.lexer.yylineno,c=this.lexer.yylloc,
0<l&&l--);break;case 2:w=this.productions_[q[1]][1];v.$=b[b.length-w];v._$={first_line:m[m.length-(w||1)].first_line,last_line:m[m.length-1].last_line,first_column:m[m.length-(w||1)].first_column,last_column:m[m.length-1].last_column};n&&(v._$.range=[m[m.length-(w||1)].range[0],m[m.length-1].range[1]]);t=this.performAction.call(v,e,h,g,this.yy,q[1],b,m);if("undefined"!==typeof t)return t;w&&(f=f.slice(0,-2*w),b=b.slice(0,-1*w),m=m.slice(0,-1*w));f.push(this.productions_[q[1]][0]);b.push(v.$);m.push(v._$);
q=d[f[f.length-2]][f[f.length-1]];f.push(q);break;case 3:return!0}}return!0}},b=function(){return{EOF:1,parseError:function(c,f){if(this.yy.parser)this.yy.parser.parseError(c,f);else throw Error(c);},setInput:function(c){this._input=c;this._more=this._less=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=this.matched=this.match="";this.conditionStack=["INITIAL"];this.yylloc={first_line:1,first_column:0,last_line:1,last_column:0};this.options.ranges&&(this.yylloc.range=[0,0]);this.offset=0;return this},
...
var k={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"},n=/[&<>"'`]/g,q=/[&<>"'`]/,l=function(c){return k[c]||"&amp;"};b.Utils={extend:function(c,f){for(var b in f)f.hasOwnProperty(b)&&(c[b]=f[b])},escapeExpression:function(c){if(c instanceof b.SafeString)return c.toString();if(null==c||!1===c)return"";c=c.toString();return q.test(c)?c.replace(n,l):c},isEmpty:function(c){return c||0===c?"[object Array]"===g.call(c)&&0===c.length?!0:!1:!0}};var x=b.Compiler=function(){};x.prototype=
{compiler:x,disassemble:function(){for(var c=this.opcodes,f,b=[],d,e,g=0,h=c.length;g<h;g++)if(f=c[g],"DECLARE"===f.opcode)b.push("DECLARE "+f.name+"="+f.value);else{d=[];for(var l=0;l<f.args.length;l++)e=f.args[l],"string"===typeof e&&(e='"'+e.replace("\n","\\n")+'"'),d.push(e);b.push(f.opcode+" "+d.join(" "))}return b.join("\n")},equals:function(c){var f=this.opcodes.length;if(c.opcodes.length!==f)return!1;for(var b=0;b<f;b++){var d=this.opcodes[b],e=c.opcodes[b];if(d.opcode!==e.opcode||d.args.length!==
...
c||"string"!==typeof c&&c.constructor!==b.AST.ProgramNode)throw new b.Exception("You must pass a string or Handlebars AST to Handlebars.compile. You passed "+c);f=f||{};"data"in f||(f.data=!0);var d;return function(p,g){if(!d){var h=b.parse(c),h=(new x).compile(h,f),h=(new b.JavaScriptCompiler).compile(h,f,e,!0);d=b.template(h)}return d.call(this,p,g)}};var t=function(c){this.value=c},u=b.JavaScriptCompiler=function(){};u.prototype={nameLookup:function(c,f){return/^[0-9]+$/.test(f)?c+"["+f+"]":u.isValidJavaScriptVariableName(f)?
...
" || "+d);this.replaceStack(function(c){return c+" ? "+c+".call("+b.callParams+") : helperMissing.call("+b.helperMissingParams+")"})},invokeKnownHelper:function(c,b){var d=this.setupHelper(c,b);this.push(d.name+".call("+d.callParams+")")},invokeAmbiguous:function(c,b){this.context.aliases.functionType='"function"';this.pushStackLiteral("{}");var d=this.setupHelper(0,c,b),e=this.lastHelper=this.nameLookup("helpers",c,"helper"),g=this.nameLookup("depth"+this.lastContext,c,"context"),h=this.nextStack();
this.source.push("if ("+h+" = "+e+") { "+h+" = "+h+".call("+d.callParams+"); }");this.source.push("else { "+h+" = "+g+"; "+h+" = typeof "+h+" === functionType ? "+h+".apply(depth0) : "+h+"; }")},invokePartial:function(c){c=[this.nameLookup("partials",c,"partial"),"'"+c+"'",this.popStack(),"helpers","partials"];this.options.data&&c.push("data");this.context.aliases.self="this";this.push("self.invokePartial("+c.join(", ")+")")},assignToHash:function(c){var b=this.popStack(),d,e;this.options.stringParams&&
(e=this.popStack(),d=this.popStack());var g=this.hash;d&&g.contexts.push("'"+c+"': "+d);e&&g.types.push("'"+c+"': "+e);g.values.push("'"+c+"': ("+b+")")},compiler:u,compileChildren:function(c,b){for(var d=c.children,e,g,h=0,l=d.length;h<l;h++){e=d[h];g=new this.compiler;var k=this.matchExistingProgram(e);null==k?(this.context.programs.push(""),k=this.context.programs.length,e.index=k,e.name="program"+k,this.context.programs[k]=g.compile(e,b,this.context),this.context.environments[k]=e):(e.index=k,
...
g=[],h=[],l,k;e.push("hash:"+this.popStack());l=this.popStack();if((k=this.popStack())||l)k||(this.context.aliases.self="this",k="self.noop"),l||(this.context.aliases.self="this",l="self.noop"),e.push("inverse:"+l),e.push("fn:"+k);for(k=0;k<c;k++)l=this.popStack(),b.push(l),this.options.stringParams&&(h.push(this.popStack()),g.push(this.popStack()));this.options.stringParams&&(e.push("contexts:["+g.join(",")+"]"),e.push("types:["+h.join(",")+"]"),e.push("hashContexts:hashContexts"),e.push("hashTypes:hashTypes"));
...
function(b,d){var e=this;this.addListener(b,function(k){d(k);e.removeListener(b,d)})};b.prototype.removeListener=function(b,d){if(!a.isNull(this.__list[b])){var h=this.__list[b].length;if(a.isFunction(d))for(;h--;)this.__list[b][h]===d&&this.__list[b].splice(h,1);this.dispatch(this.__base+".remove",{type:b,fct:d});e(b)}};b.prototype.removeAllListeners=function(b){a.isNull(this.__list[b])||(this.__list[b]=[],e(b))};b.prototype.clear=function(){var b=this.__base+".clear",d;for(d in this.__list)d!==
b&&delete this.__list[d];this.dispatch(b,{})};b.prototype.dispatch=function(b,d){var e=this.__list[b];if(!a.isNull(e))for(var k=0,n=e.length;k<n;++k)(function(b){setTimeout(function(){b(d)},0)})(e[k])};return b}();a.message=new a.eventEmitter;a.message.setName=function(){};
...
a.ajax=function(e,b,g){var d=a.getDefaultAjaxOptions();this.params={url:"",method:"GET",type:"raw",async:!0,cache:!1,data:{},header:{}};for(var h in this.params)"data"!==h&&"header"!==h&&(h in d&&typeof d[h]===typeof this.params[h]&&(this.params[h]=d[h]),h in e&&typeof e[h]===typeof this.params[h]&&(this.params[h]=e[h]));if(a.isObject(d.data))for(var k in d.data)this.params.data[k]=d.data[k];if(a.isObject(d.header))for(var n in d.header)this.params.header[n]=d.header[n];if(a.isString(e.data))this.params.data=
e.data;else if(a.isObject(e.data))for(var q in e.data)this.params.data[q]=e.data[q];if(a.isObject(e.header))for(var l in e.header)this.params.header[l]=e.header[l];this.success=a.isFunction(b)?b:function(){};this.error=a.isFunction(g)?g:function(){};this.request=null;if(a.isNull(window.XMLHttpRequest)){e=["Msxml2.XMLHTTP.6.0","Msxml2.XMLHTTP.3.0","Msxml2.XMLHTTP","Microsoft.XMLHTTP"];for(var x in e)try{this.request=new ActiveXObject(e[x])}catch(t){}}else this.request=new XMLHttpRequest};
a.ajax.prototype.parseResult=function(e,b){var g=e.type.toLowerCase();return"json"===g?a.parser.json.parse(b.responseText):"xml"===g?b.responseXML:b.responseText};a.ajax.prototype.abort=function(){try{this.request.abort()}catch(e){}};
...
request:this.request,parseResult:this.parseResult};this.request.onreadystatechange=function(){if(4===k.request.readyState){var b=200<=k.request.status&&400>k.request.status;b?k.success(k.parseResult(k.params,k.request),k.request.status):k.error(h,k.request.status);a.message.dispatch("a.ajax",{success:b,status:k.request.status,url:k.params.url,method:k.method,params:k.params})}}}this.request.open(e,h,d);if("POST"===e){for(var e=["Content-Type","Content-type","content-type"],n=e.length,q=!1;n--;){var l=
e[n];if(a.isString(l)&&0<l.length){q=!0;break}}q||this.request.setRequestHeader("Content-type","application/x-www-form-urlencoded")}for(var x in this.params.header)this.request.setRequestHeader(x,this.params.header[x]);this.request.send(b);return!1===d?this.parseResult(this.params,this.request):"No return in async mode"};
a.timer=function(){var e={};setInterval(function(){a.message.dispatch("a.timer.tick",{});for(var b in e){var g=e[b];g.current+=50;if(g.current>=g.timeout&&(g.current=0,a.isFunction(g.fct))){var d=a.isObject(g.scope)?g.scope:null;g.fct.call(d,null)}}},50);return{add:function(b,g,d){var h;for(h=Math.floor(1E6*Math.random());!a.isNull(e[h]);)h=Math.floor(1E6*Math.random());if(!a.isNumber(d)||0>=d)d=1E3,a.console.error("The timeout has not been setted properly into timer, timeout has been setted to 1000ms",
1);e[h]={fct:b,scope:g,timeout:d,current:0};return h},once:function(b,e,d){var h=this.add(function(){a.isFunction(b)&&b.call(this,null);a.timer.remove(h)},e,d);return h},get:function(b){b=e[b];return a.isNull(b)?null:b},remove:function(b){return a.isNull(e[b])?!1:(delete e[b],!0)},clear:function(){e={}}}}();
...
a.isObject(g.data)&&(t.data=g.data),a.isObject(g.header)&&(t.header=g.header),a.isBoolean(g.cache)&&(t.cache=g.cache));h=a.isFunction(h)?h:function(){};(new a.ajax(t,function(h,k){a.isFunction(e)&&e(h,k);(a.isNull(g)||!1!==g.cache)&&d.push(b)},h)).send()}var d=[],h=0,k="GET POST PUT DELETE HEAD OPTIONS".split(" ");return{js:function(b,d,g,h){e(b,d)||this.jsonp(b,d,g,h)},jsonp:function(e,d,g,h){var k=a.isObject(g)&&g.type?g.type:"text/javascript";a.console.log("a.loader: load resource (url: "+e+")",
3);b(document.createElement("script"),{type:k,src:e},d,e,g,h)},json:function(b,e,d,h){a.isObject(d)||(d={});d.type="json";a.isObject(d.header)||(d.header={});d.header.accept="application/json, text/javascript";g(b,e,d,h)},xml:function(b,e,d,h){a.isObject(d)||(d={});d.type="xml";a.isObject(d.header)||(d.header={});d.header.accept="application/xml, text/xml";g(b,e,d,h)},css:function(d,g,h,k){e(d,g)||(a.console.log("a.loader: load resource (url: "+d+")",3),b(document.createElement("link"),{rel:"stylesheet",
...
c--&&!a.isNull(document.getElementById(g.id).Content)?(a.timer.remove(z),d()):0>=c&&a.isFunction(h)&&h(b,408)},null,200)}},trace:function(){return d}}}();a.callback={};
a.callback.synchronizer=function(){function e(){q--;0>=q&&!1===u?(t=!1,v.prototype.dispatch("a.callback.synchronizer.success",{}),l(w)):0>=q&&(t=u=!1)}function b(){!0===t&&(u=!0,t=!1,v.prototype.dispatch("a.callback.synchronizer.error",{}),x.apply(this,arguments))}function g(b,f){w[b]=f}function d(b){a.isObject(b)&&(w=b)}function h(b){return a.isNull(w[b])?null:w[b]}function k(){return w}var n=[],q=0,l=function(){return!0},x=function(){return!0},t=!1,u=!1,w={},v=function(){};v.prototype=new a.eventEmitter;
v.prototype.constructor=this;v.prototype.setSuccess=function(b){l=a.isFunction(b)?b:l};v.prototype.setDone=v.prototype.setSuccess;v.prototype.setFail=function(b){x=a.isFunction(b)?b:x};v.prototype.setError=v.prototype.setFail;v.prototype.addCallback=function(){for(var c=[],c=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,f=0,m=c.length;f<m;++f){var p=c[f];a.isFunction(p)&&(q++,n.push(p),!0===t&&p({success:e,done:e,getData:h,getFullData:k,setData:g,setFullData:d,fail:b,error:b}))}!0===
t&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};v.prototype.removeCallback=function(b){for(var f=n.length-1;0<=f;--f)n[f]===b&&(!0===t&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),q--,n.splice(f,1))};v.prototype.start=function(c,f){if(0>=q)e();else{t=!0;w={};for(var m=0,p=n.length;m<p;++m)n[m]({success:e,done:e,getData:h,getFullData:k,setData:g,
...
a.callback.chainer=function(){function e(){0==x.length?(x=[],q(t),u.prototype.dispatch("a.callback.chainer.success",{})):u.prototype.start(arguments)}function b(){x=[];l.apply(this,arguments);u.prototype.dispatch("a.callback.chainer.error",{})}function g(b,d){t[b]=d}function d(b){a.isObject(b)&&(t=b)}function h(b){return a.isNull(t[b])?null:t[b]}function k(){return t}var n=[],q=function(){return!0},l=function(){return!0},x=[],t={},u=function(){};u.prototype=new a.eventEmitter;u.prototype.constructor=
this;u.prototype.setSuccess=function(b){q=a.isFunction(b)?b:q};u.prototype.setDone=u.prototype.setSuccess;u.prototype.setFail=function(b){l=a.isFunction(b)?b:l};u.prototype.setError=u.prototype.setFail;u.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,d=0,c=b.length;d<c;++d){var f=b[d];a.isFunction(f)&&(n.push(f),!0===u.prototype.isRunning()&&x.push(f))}!0===u.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};u.prototype.removeCallback=function(b){for(var d=n.length-1;0<=d;--d)if(n[d]===b){if(!0===u.prototype.isRunning()){for(var c=x.length-1;0<=c;--c)x[c]===b&&x.splice(c,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}n.splice(d,1)}};u.prototype.start=function(){if(0==x.length){for(var l=0,q=n.length;l<q;++l)x.push(n[l]);u.prototype.dispatch("a.callback.chainer.start",{});t={};0==x.length&&e()}l=x.shift();a.isFunction(l)&&l({success:e,
done:e,getData:h,getFullData:k,setData:g,setFullData:d,fail:b,error:b},arguments)};u.prototype.isRunning=function(){return 0==x.length?!1:!0};var w=new u;w.setName("a.callback.chainer");return w};a.form=function(){function e(b,d){return a.isNull(b.getAttribute)?null:b.getAttribute(d)}function b(b){for(var d=[],e=b.length;e--;)d.push(b[e]);return d}function g(b){var d=e(b,"name");if(a.isNull(d)||""===d)if(d=e(b,"id"),a.isNull(d)||""===d)d=e(b,"class");return d}function d(d){var g=d.getElementsByTagName("input"),h=d.getElementsByTagName("textarea");d=d.getElementsByTagName("select");for(var g=b(g),k=g.length;k--;){var n=e(g[k],"type");a.contains(l,n)||a.isNull(n)||g.splice(k,1)}return g.concat(b(h),
b(d))}function h(b,d,g,h){var k="";a.isNull(g)||""===g||(k=e(b,"data-error-"+g));if(a.isNull(k)||""===k)k=e(b,"data-error");(a.isNull(k)||""===k)&&a.console.warn("A data-error tag has not been setted for "+d+" with value "+h+", can't proceed error show",3);a.isNull(a.language)||(k=a.language.getSingleTranslation(k,{name:g,value:h}));return{el:b,id:d,error:k}}var k="text search url tel email password".split(" "),n="number range date datetime datetime-local month time week".split(" "),q=k.concat(n,
["number","checkbox","radio","file"]),l=n.concat(k,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=d(b);for(var h={},k=b.length;k--;){var l=b[k],n=g(l),q;q=l;var c=e(q,"type"),f=q.tagName.toLowerCase();q="input"===f||"textarea"===f?"checkbox"===c?q.checked:q.value:"select"===f?q.options[q.selectedIndex].value:void 0;null!==n&&""!==n&&(a.isNull(l)||"radio"!==e(l,"type")?h[n]=""===q?null:q:l.checked&&(h[n]=""===q?null:q))}a.console.log("a.form.get: found element list:",
3);a.console.log(h,3);return h},validate:function(b){if(!a.isNull(e(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=d(b);for(var l=[],u="number range text search url email password color checkbox hidden radio".split(" "),w=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),v=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),z=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),c=b.length;c--;){var f=b[c],m=f.tagName.toLowerCase();if("select"!==m&&a.isNull(e(f,"formnovalidate"))){var p=e(f,"type"),s=g(f),
r=f.value,y=e(f,"required"),A=e(f,"pattern");e(f,"multiple");var B=e(f,"min"),D=e(f,"max"),E=e(f,"step"),B=a.isNull(B)||""===B?null:parseFloat(B),D=a.isNull(D)||""===D?null:parseFloat(D),E=a.isNull(E)||""===E?null:parseFloat(E);"input"!==m||a.contains(u,p)||a.isNull(p)?"number"!==p&&"range"!==p||a.isNumber(r)?"url"!==p||w.test(r)?"email"!==p||v.test(r)?"color"!==p||z.test(r)?null!==y&&a.contains(q,p)&&(""===r||a.isNull(r))?l.push(h(f,s,"required",r)):null===A||"textarea"!==m&&!a.contains(k,p)&&!a.isNull(p)||
RegExp(A).test(r)?null===B&&null==D&&null==E||!a.contains(n,p)||(m=parseFloat(r),null!==B&&m<B?l.push(h(f,s,"min",r)):null!==D&&m>D?l.push(h(f,s,"max",r)):null!==E&&0!==m%E&&l.push(h(f,s,"step",r))):l.push(h(f,s,"pattern",r)):l.push(h(f,s,null,r)):l.push(h(f,s,null,r)):l.push(h(f,s,null,r)):l.push(h(f,s,null,r)):a.console.warn("Type "+p+" for input "+s+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(l,3);return l},validateAndGet:function(b){b=
...
3);e.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);e.reset()}}}(window.Mousetrap);a.language=function(){function e(b,f){if(a.isNull(q[b]))return null;var d=q[b][f];if(a.isNull(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+f+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function g(c,f){var d=e(k,c);if(!a.isNull(d)){var g=d;if(a.isArray(f))for(var h=0,r=f.length;h<r;++h)var l=b(h+1),l=RegExp(l,"gi"),g=g.replace(l,
f[h]);else for(h in f)l=b(h),l=RegExp(l,"gi"),g=g.replace(l,f[h]);if(0<=g.indexOf("{{")&&0<=g.indexOf("}}"))for(d=d.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],h=0,r=d.length;h<r;++h){var l=b(d[h]),n=d[h].replace("{{","").replace("}}",""),n=a.isNull(u[n])?null:u[n];a.isNull(n)||(l=RegExp(l,"gi"),g=g.replace(l,n))}return g=g.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return c}function d(b,f){a.isString(f)||(f=x);try{return b.getAttribute(f)}catch(d){return null}}function h(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(d(b))||f.push(b);var h=[];b.querySelectorAll?(h=b.querySelectorAll("*["+x+"]"),0===h.length&&(h=b.querySelectorAll("*"))):h=b.getElementsByTagName("*");b=0;for(var p=h.length;b<p;++b)a.isNull(d(h[b]))||f.push(h[b]);h=0;for(b=f.length;h<b;++h){var s=f[h],p=d(s);if(!a.isNull(p)){var r=e(k,p),n={};a.isNull(r)&&(r=p);for(var r=r.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],q=0,w=r.length;q<w;++q){var v=r[q].replace("{{","").replace("}}",""),z=d(s,x+"-"+v);a.isNull(z)?(z="undefined"===u[v]?null:u[v],a.isNull(z)||
(n[v]=z)):n[v]=z}r=g(p,n);p=d(s,t);if(!a.isNull(p))try{s[p]=r}catch(G){}else if(s)if("INPUT"!==s.nodeName||"submit"!==s.type&&"reset"!==s.type)if("INPUT"===s.nodeName)try{s.placeholder=r}catch(J){}else if("FIELDSET"===s.nodeName)s.title=r;else if(!a.isNull(s.text)&&document.all)s.text=r;else if(a.isNull(s.childNodes))s.innerHTML=r;else if(p=s.childNodes.length,n=document.createTextNode(r),"leave"===l){for(r=!1;p--;)q=s.childNodes[p],3===q.nodeType&&(r||(s.insertBefore(n,q),r=!0),s.removeChild(q));
r||s.appendChild(n)}else{for(;p--;)s.removeChild(s.firstChild);s.appendChild(n)}else s.value=r}}}var k="en",n=["en","fr","de","sp"],q={},l="leave",x="data-tr",t="data-tr-attr",u={},w=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(w){var v=a.storage.persistent.getItem("a_language_store_language"),z=a.storage.persistent.getItem("a_language_store_allowed");a.isString(v)&&(k=v,h(document));a.isArray(z)&&(n=z)}return{setBehavior:function(b){l="erase"===b?"erase":"leave"},getBehavior:function(){return l},
getCurrent:function(){return k},setCurrent:function(b,f){!a.isString(b)||0>=b.length?a.console.error("a.language.setCurrent: setting a non-string lang, or empty string, as default language: "+b,1):(a.isNull(f)&&(f=!0),a.contains(n,b)||a.console.warn("a.language.setCurrent: unable to find language in available language list (value: "+b+", available: "+n.join(";")+")",2),k=b,a.isNull(q[k])&&(q[k]={}),a.console.log("a.language.setCurrent: set current language to "+k+", request update ? "+f,3),a.message.dispatch("a.language.change",
{value:k}),w&&a.storage.persistent.setItem("a_language_store_language",k),this.translate(document,f))},getAllowed:function(){return n},setAllowed:function(b){a.isString(b)&&(b=[b]);if(a.isArray(b)){n=b;var f=0;for(b=b.length;f<b;++f)a.isNull(q[f])&&(q[f]={});w&&(a.console.log("a.language.setAllowed: set allowed language to "+n,3),a.storage.persistent.setItem("a_language_store_allowed",n))}else a.console.error("a.language.setAllowed: the allowed language must be an Array (value: "+b+")",1)},getSingleTranslation:function(b,
f){return g(b,f)},addSingleTranslation:function(b,f,d,e){a.isNull(q[b])&&(a.console.warn("a.language.addSingleTranslation: be carefull, the language you submit does not seems to exist in dict (value: "+b+", dict: "+n.join(";")+")",1),q[b]={});q[b][f]=d;this.translate(document,e)},addTranslation:function(b,f,d){a.isNull(q[b])&&(q[b]={});for(var e in f)q[b][e]=f[e];this.translate(document,d)},getTranslation:function(b){return a.isString(b)?q[b]:q},translate:function(b,f){!1!==f&&h(b)},addVariable:function(b,
f){a.console.log("a.language.addVariable: add global variable (key: "+b+", value: "+f+")",3);u[b]=f},getVariable:function(b){return"undefined"===u[b]?null:u[b]},removeVariable:function(b){a.console.log("a.language.removeVariable: remove global variable (key: "+b+")",3);delete u[b]},clear:function(){q={}}}}();a.page={};
a.page.template={__tmpl:{},get:function(e,b,g,d){var h=null;a.isObject(window.Mustache)?h=window.Mustache:a.isObject(window.Handlebars)&&(h=window.Handlebars);if(null==h)a.console.error("a.page.template.get: unable to find Mustache.JS or Handlebars.JS ! Can't proceed",1);else{var k=e.replace(/[^a-zA-Z0-9\\-]/g,"_"),n="a_tmpl_"+k+"_a",q=function(b,d,e){a.isFunction(b)&&(a.isNull(h.to_html)?(d=h.compile(a.page.template.__tmpl[d]),b(d(e))):b(h.to_html(a.page.template.__tmpl[d],e)))};a.isString(this.__tmpl[n])?(a.console.log("a.page.template.get: loading "+
n+" from cache",3),q(g,n,b)):document.getElementById(n)?(this.__tmpl[n]||(a.console.log("a.page.template.get: loading "+n+" from inner html page",3),this.__tmpl[n]=document.getElementById(n).innerHTML),q(g,n,b)):document.getElementById(k)?(this.__tmpl[k]||(a.console.log("a.page.template.get: loading "+k+" from inner html page",3),this.__tmpl[k]=document.getElementById(k).innerHTML),q(g,k,b)):(a.console.log("a.page.template.get: loading "+e+" from external resource",3),a.loader.html(e,function(d,e,
h){a.page.template.__tmpl[n]||(a.page.template.__tmpl[n]=d);q(g,n,b)},{},d))}},htmlToDom:function(e){var b=document.createElement("div");b.innerHTML=e.replace(/^\s+|\s+$/g,"");e=b.childNodes;for(var b=[],g=0,d=e.length;g<d;++g){var h=e.item(g);!a.isObject(h)||"1"!==h.nodeType.toString()&&"3"!==h.nodeType.toString()||b.push(h)}return b},remove:function(e,b){for(;e.firstChild;)e.removeChild(e.firstChild);a.isFunction(b)&&b()},append:function(e,b,g){var d=this.htmlToDom(b);if(a.isObject(d))for(var h=
...
a.page.event=function(){function e(b,d){a.isObject(d)||(d={});return function(){a.message.dispatch("a.page.event."+b,d)}}function b(){var b=(new Date).getTime();b>n+2*k&&(a.console.log("a.page.event.hibernate: hibernate mode has been detected",3),e("hibernate")());n=b}function g(b,d){window.addEventListener?window.addEventListener(b,d,!1):window.attachEvent&&window.attachEvent("on"+b,d)}function d(b){var d=window.location.hash?window.location.hash.substring(1):null;if(q!==d){if(!0!==b){for(l.push({hash:d,
time:(new Date).getTime()});1E3<l.length;)l.shift();a.console.log("a.page.event.hash: hash change (previous: "+q+", new: "+d+")",3);e("hash",{value:d,old:q})()}q=d}}var h={},k=1E4,n=(new Date).getTime(),q=null,l=[];h.hash={getHash:function(){return window.location.hash?window.location.hash.substring(1):null},getPreviousHash:function(){return q},setPreviousHash:function(b){a.console.log("a.page.event.hash.setPreviousHash: change previous hash to "+b,3);q=b},trace:function(){return l}};d(!0);!a.isNull(window.onhashchange)&&
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=d:a.timer.add(d,null,50);var x=["resize","load","unload"],t;for(t in x)g(x[t],e(x[t]));g("load",function(){a.timer.add(b,null,k)});return h}();a.state=function(){function e(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=z;z===b||0>=z;)z=Math.floor(1E5*Math.random());return z}function g(b,c){var d=[],e=b.length;c=a.isFunction(c)?c:function(){return!0};for(var g=0;g<e;++g){for(var h=!1,k=0;k<e;++k)if(g!=k&&b[g].id===b[k].id&&c(b[g])){h=!0;break}h||d.push(b[g].id)}return d}function d(b){for(var c=0,d=[],e=a.state.helper.tree.selectLevel(b,l,c);0<e.length;)d.push(e),c++,e=a.state.helper.tree.selectLevel(b,l,c);
...
function n(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function q(b,c){var d=n(c),e=k(b);return function(b){return!0===d(b)||!0===e(b)?!0:!1}}function l(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function x(b){return a.isObject(b)?b.id:-1}function t(b){return a.isObject(b)&&a.isObject(b.error)?b.error:null}function u(c){var e=a.clone(w),p=a.clone(w),s=a.clone(w),r=h(c.value),n=k(c.old),r=q(c.old,r),t=k(c.value);a.state.helper.tree.selectBranch(e,
l,r);a.state.helper.tree.selectBranch(p,l,t);a.state.helper.tree.selectBranch(s,l,k("*"));var r=a.state.helper.tree.flat(e.concat(p),l),u=g(r,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,l,t)&&!a.state.helper.tree.isInBranch(b,l,n)?!1:!0}),v=a.state.helper.tree.flat(s,l,x),e=d(e),z=d(p);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+u+" (does not mean all of them will be loaded)",3);var G=
...
1),d&&a.console.warn("a.state.add : The wildcard has children (not allowed)",1),b.parent=null,k=!1,b.children=[]);h=[];d&&(h=b.children.slice());b.children=[];a.isNull(b.id)&&(b.id=1);for(;!a.isNull(a.state.helper.tree.getItem(w,l,n(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(k){k=a.state.helper.tree.getItem(w,l,n(b.parent));if(a.isNull(k))return null;k.children.push(b)}else w.push(b);k=b.id;d=0;for(g=h.length;d<g;++d)a.isObject(h[d])&&(h[d].parent=k,this.add(h[d]));"*"===b.hash&&a.state.helper.chainer("load",
[[b]],[k],-1,function(){});!0===b.bootOnLoad&&(h=a.clone(b),h.data=h.converter=h.options=null,h.preLoad=h.load=h.postLoad=null,h.preUnload=h.unload=h.postUnload=null,c=a.isFunction(c)?c:function(){},a.state.helper.chainer("load",[[h]],[k],-1,c));return k}},getById:function(b){return a.state.helper.tree.getItem(w,l,n(b))},removeById:function(b){var c=a.state.helper.tree.getItem(w,l,n(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(w,l,function(b){return b===
c?!1:!0})},loadById:function(b,c,h){var s=a.clone(w),r=a.page.event.hash.getHash(),q=a.clone(w);a.state.helper.tree.selectBranch(s,l,n(b));a.state.helper.tree.selectBranch(q,l,k(r));var t=a.state.helper.tree.flat(s,l),q=a.state.helper.tree.flat(q,l),q=g(q.concat(t)),s=d(s);h=a.isFunction(h)?h:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+q+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",s,q,-1,h);a.isNull(c)&&(c=r);b={id:b,itemList:a.state.helper.tree.flat(t,
l,x),hashtagList:e(c)};v.push(b)},unloadById:function(b,c){for(var e=this.getById(b),e=d([e]),g=[],h=v.length;h--;)g=g.concat(v[h].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+g+" (does not mean all of them will be unloaded)",3);h=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",e,g,-1,h)},forceReloadById:function(c,e){for(var g=a.isFunction(e)?e:function(){},h=v.length,r=[],n=a.clone(v);h--;)a.contains(v[h].itemList,c)&&r.push(v[h].hashtagList);
if(0<r.length)this.unloadById(c,function(){for(var b=r.length;b--;)a.state.loadById(c,r[b]);v=n;g()});else{var h=a.clone(w),q=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,l,k(q));for(var q=a.state.helper.tree.flat(h,l),t=q.length;t--;)if(q[t].id===c){var u=d([q[t]]),z=a.state.helper.tree.flat(h,l,x);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+z+" (does not mean all of them will be loaded/unloaded)",3);var G=b();a.state.helper.chainer("unload",u,z,
-1,function(){a.state.helper.chainer("load",u,z,G,g)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(w,l,k(b)):!1},__currentGeneratedId:function(){return z},__getError:function(b,c){var d=b.id;c="_"+c;var e=a.clone(w);a.state.helper.tree.selectBranch(e,l,n(d));for(var d=a.state.helper.tree.flat(e,l,t),e=[c,c.substring(0,c.length-1)+"x",c.substring(0,c.length-2)+"xx","generic","_generic"],g=0,h=e.length;g<h;++g){var k;a:{k=e[g];for(var q=d.length;q--;){var u=
d[q];if(!a.isNull(u))for(var v in u)if(v==k){k=u[v];break a}}k=null}if(!a.isNull(k))return k}return null},type:{add:function(b,d){c[b]=d},get:function(b){return a.isFunction(c[b])?c[b]:null},list:function(){return c}},helper:{tree:{},chainer:{},parameter:{}}}}();
a.state.helper.tree={flat:function(e,b,g){var d=[];if(!a.isArray(e)||!a.isFunction(b))return[];g=a.isFunction(g)?g:function(b){return b};for(var h=0,k=e.length;h<k;++h){var n=this.flat(b(e[h]),b,g);d.push(g(e[h]));0<n.length&&(d=d.concat(n))}return d},getItem:function(e,b,g){if(!a.isArray(e)||!a.isFunction(g)||!a.isFunction(b))return null;for(var d=0,h=e.length;d<h;++d){if(!0===g(e[d]))return e[d];var k=this.getItem(b(e[d]),b,g);if(!a.isNull(k))return k}return null},isInBranch:function(e,b,g){e=this.getItem(e,
...
h=b.include.translate,l=b.data,n=b.title,t=b.options,u=b.converter,v=b.hash,w=e.length,z=f.length;w--;)d.addCallback(q("css",e[w]));for(;z--;)d.addCallback(q("js",f[z]));if(!a.isNull(a.language)&&0<h.length)for(e=h.length;e--;)d.addCallback(q("json",h[e],function(b){for(var c in b)a.language.addTranslation(c,b[c],!0)}));a.isString(g)&&(g=a.state.helper.parameter.extrapolate(g,a.page.event.hash.getHash(),v),d.addCallback(function(b){b.setData("html",g);a.page.template.get(g,{},b.done,k)}));if(a.isString(l)||
a.isObject(l))if(a.isObject(t)||(t={type:"json"}),a.isString(t.type)||(t.type="json"),a.isString(l))d.addCallback(x(null,l,t,v));else for(var C in l)a.isObject(l[C])&&a.isString(l[C].url)?(a.isObject(l[C].options)||(l[C].options={type:"json"}),d.addCallback(x(C,l[C].url,l[C].options,v))):d.addCallback(x(C,l[C],t,v));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNull(u)||u(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),
v),a.isNull(a.language)?document.title=n:document.title=a.language.getSingleTranslation(n));var d=b.data,e=b.html,d=a.isNull(d)?{}:d;a.isNull(e)?a.isFunction(c)&&c(b,null):a.page.template.get(e,d,function(d){a.isFunction(c)&&c(b,d)})});d.setFail(k);d.start()}function u(b,c){z=b;var f=new a.callback.chainer;"unload"===e?f.addCallback(b.preUnload,b.unload,b.postUnload):f.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==d||0<=d&&a.state.__currentGeneratedId()===d)?b.preLoad(c):c.done()},function(c){t(b,
function(e,f){a.isFunction(b.load)&&(-1==d||0<=d&&a.state.__currentGeneratedId()===d)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(e.data))for(var h in e.data)g[h]=e.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==d||0<=d&&a.state.__currentGeneratedId()===d)?b.postLoad(c):c.done()});f.setSuccess(c);f.setFail(k);f.start()}function w(b,c){for(var d=new a.callback.synchronizer,e=b.length;e--;)a.contains(g,b[e].id)&&function(b){d.addCallback(function(c){u(b,function(){c.done()})})}(b[e]);
d.setSuccess(c);d.setFail(k);d.start()}var v=b.length,z=null;e="unload"===e?"unload":"load";g=g||[];var c=new a.callback.chainer;if("unload"===e)for(;v--;)c.addCallback(n(b[v]));else for(var f=0;f<v;)c.addCallback(n(b[f])),f++;c.setSuccess(h);c.setFail(k);c.start()};
a.state.helper.parameter={extract:function(e,b){var g=/\{\{(\s*\w+\s*:\s*[a-z0-9_\-\[\]\(\)\^.\|\+\*\?\\\/]+\s*)\}\}/gmi,d=/^\s+|\s+$/g,h=!a.isNull(b);h&&(g=b);for(var k=[],n;n=g.exec(e);){var q=null,q=h?["hash",n[1]]:n[1].split(":",2);k.push({original:n[0].replace(d,""),name:q[0].replace(d,""),regex:q[1].replace(d,""),start:n.index})}return k},replace:function(e,b,g){g=a.isNull(g)?"("+b.regex+")":g;return e.substr(0,b.start)+g+e.substr(b.start+b.original.length)},extrapolate:function(e,b,g,d){if(a.isString(e)&&
0<=e.indexOf("{{")&&0<=e.indexOf("}}")){for(var h=this.extract(e),k=this.extract(g),n=this.extract(e,/\{\{(\s*\w+\s*)\}\}/gmi),h=h.concat(n),n=k.length;n--;)g=this.replace(g,k[n]);if(n=RegExp("^"+g+"$","gi").exec(b)){b=0;for(g=k.length;b<g;++b)k[b].value=n[b+1];for(var n=0,q=h.length;n<q;++n)for(b=0;b<g;++b)k[b].name===h[n].regex&&"hash"===h[n].name&&(h[n].value=k[b].value)}k=h.length;for(d=!1===d?function(b,d,e){return e}:this.replace;k--;){b=h[k];"hash"!==b.name&&"hashtag"!==b.name||a.isNull(b.value)||
...
{key:d}))}}}();
a.storage.type.flash=function(){function e(e){if(!1===b&&!1===g){var k=document.createElement("div");k.id="flashstoragecontent";document.body.appendChild(k);var n={id:d,rootId:k.id,flashvars:{},params:{wmode:"transparent",menu:"false",scale:"noScale",allowFullscreen:"true",allowScriptAccess:"always"}};a.loader.flash(a.url+"vendor/storage/flash/localStorage.swf",function(d){g=!0;d=document.getElementById(n.id);!0===d.testData()&&(b=!0,d.setDatabase("a_flashStorage"));!0===b&&a.isFunction(e)&&e(b)},
n)}else!0===b&&a.isFunction(e)&&e(b)}var b=!1,g=!1,d="flashstorage";return{support:function(){return b},ready:function(){return g},engine:"flash",start:function(b){e(b)},getItem:function(e){this.start();if(!0===b){var g=document.getElementById(d).getData(e);if(a.isNull(g))return a.storage.__printGetErrorItem("flash",e),null;a.storage.__printGetItem("flash",e,g);return g}return null},setItem:function(e,g){this.start();!0===b&&(a.storage.__printSetItem("flash",e,g),document.getElementById(d).setData(e,
...
a.storage.type.silverlight=function(){function e(e){if(!1===b&&!1===g){var k=document.createElement("div");k.id="__silverlightstorage";document.body.appendChild(k);var n={id:d,rootId:k.id,params:[{name:"minRuntimeVersion",value:"2.0.31005.0"},{name:"autoUpgrade",value:"true"}]};a.loader.silverlight(a.url+"vendor/storage/silverlight/silverlightStorage.xap",function(d){g=!0;!0===document.getElementById(n.id).Content.store.testData()&&(b=!0);!0===b&&a.isFunction(e)&&e(b)},n)}else!0===b&&a.isFunction(e)&&
