...
b&&delete this.__list[d];this.dispatch(b,{})};b.prototype.dispatch=function(b,d){var e=this.__list[b];if(!a.isNull(e))for(var k=0,p=e.length;k<p;++k)(function(b){setTimeout(function(){b(d)},0)})(e[k])};return b}();a.message=new a.eventEmitter;a.message.setName=function(){};
...
d.setSuccess(c);d.setFail(k);d.start()}var v=b.length,z=null;e="unload"===e?"unload":"load";g=g||[];var c=new a.callback.chainer;if("unload"===e)for(;v--;)c.addCallback(p(b[v]));else for(var f=0;f<v;)c.addCallback(p(b[f])),f++;c.setSuccess(h);c.setFail(k);c.start()};
