window.appstorm=window.a=function(){var c={},b={url:"",contains:function(b,d){if(b instanceof Array)for(var c=b.length;c--;){if(b[c]===d)return!0}else if(this.isObject(b))return d in b;return!1},clone:function(b){if(a.isObject(b)){if(a.isArray(b))for(var d=b.length,c=Array(d),h=0;h<d;++h)c[h]=a.clone(b[h]);else for(d in c={},a.isFunction(b.constructor)&&(c=new b.constructor),a.isObject(b.prototype)&&(c.prototype=b.prototype),b)c[d]=a.clone(b[d]);return c}return b},isNumber:function(b){return!isNaN(parseFloat(b))&&
...
(e.version?e.version:"1.3")+"/dtfx.js",function(){javafx({archive:b,width:e.width||1,height:e.height||1,code:e.code,name:e.id})});var g=null,m=2E3,g=a.timer.add(function(){0<m--&&!a.isNull(document.getElementById(e.id).Packages)?(a.timer.remove(g),a.isFunction(d)&&d()):0>=m&&a.isFunction(f)&&f(b,408)},null,200)}},flash:function(b,d,e,f){a.isNull(e)||a.isNull(e.rootId)||a.isNull(e.id)?a.console.warn("a.loader.flash : the system need args parameters : rootId, id, setted to be able to load any flash resource... This uri will not be loaded : "+
...
b,3);else if(!c(b,d)){a.console.log("a.loader: load resource (url: "+b+")",3);var g=document.createElement("object");g.id=e.id;g.data="data:application/x-silverlight-2,";g.type="application/x-silverlight-2";a.isArray(e.params)||(e.params=[]);e.params.push({name:"source",value:b});for(var m=0,t=e.params.length;m<t;++m){var n=document.createElement("param");n.name=e.params[m].name;n.value=e.params[m].value;g.appendChild(n)}document.getElementById(e.rootId).appendChild(g);var x=null,w=2E3,x=a.timer.add(function(){0<
w--&&!a.isNull(document.getElementById(e.id).Content)?(a.timer.remove(x),d()):0>=w&&a.isFunction(f)&&f(b,408)},null,200)}},trace:function(){return e}}}();a.eventEmitter=function(){function c(d){for(var c in b.__list)1>b.__list[c].length&&delete b.__list[c]}var b=function(){this.__list={};this.__base="a.message"};b.prototype.setName=function(b){this.__base=""+b};b.prototype.addListener=function(b,c){a.isFunction(c)?(a.isNull(this.__list[b])&&(this.__list[b]=[]),this.__list[b].push(c),this.dispatch(this.__base+".add",{type:b,fct:c})):a.console.warn(this.__base+".addListener : unable to bind function, this is not a function",1)};b.prototype.addListenerOnce=
...
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===m?(q=!1,n.prototype.dispatch("a.callback.synchronizer.success",{}),l(t)):0>=k&&(q=m=!1)}function b(){!0===q&&(m=!0,q=!1,n.prototype.dispatch("a.callback.synchronizer.error",{}),u.apply(this,arguments))}function d(b,c){t[b]=c}function e(b){a.isObject(b)&&(t=b)}function f(b){return a.isNull(t[b])?null:t[b]}function g(){return t}var h=[],k=0,l=function(){return!0},u=function(){return!0},q=!1,m=!1,t={},n=function(){};n.prototype=new a.eventEmitter;
n.prototype.constructor=this;n.prototype.setSuccess=function(b){l=a.isFunction(b)?b:l};n.prototype.setDone=n.prototype.setSuccess;n.prototype.setFail=function(b){u=a.isFunction(b)?b:u};n.prototype.setError=n.prototype.setFail;n.prototype.addCallback=function(){for(var w=[],w=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,v=0,y=w.length;v<y;++v){var s=w[v];a.isFunction(s)&&(k++,h.push(s),!0===q&&s({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
q&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};n.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===q&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};n.prototype.start=function(w,v){if(0>=k)c();else{q=!0;t={};for(var y=0,s=h.length;y<s;++y)h[y]({success:c,done:c,getData:f,getFullData:g,setData:d,
setFullData:e,fail:b,error:b},v);a.isNumber(w)&&0<w?setTimeout(function(){var c=parseInt(w,10);n.prototype.dispatch("a.callback.synchronizer.error",{timeout:c});b({timeout:c})},w):n.prototype.dispatch("a.callback.synchronizer.start",{timeout:-1})}};n.prototype.isRunning=function(){return q};var x=new n;x.setName("a.callback.synchronizer");return x};
a.callback.chainer=function(){function c(){0==u.length?(u=[],k(q),m.prototype.dispatch("a.callback.chainer.success",{})):m.prototype.start(arguments)}function b(){u=[];l.apply(this,arguments);m.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){q[b]=c}function e(b){a.isObject(b)&&(q=b)}function f(b){return a.isNull(q[b])?null:q[b]}function g(){return q}var h=[],k=function(){return!0},l=function(){return!0},u=[],q={},m=function(){};m.prototype=new a.eventEmitter;m.prototype.constructor=
this;m.prototype.setSuccess=function(b){k=a.isFunction(b)?b:k};m.prototype.setDone=m.prototype.setSuccess;m.prototype.setFail=function(b){l=a.isFunction(b)?b:l};m.prototype.setError=m.prototype.setFail;m.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,d=b.length;c<d;++c){var e=b[c];a.isFunction(e)&&(h.push(e),!0===m.prototype.isRunning()&&u.push(e))}!0===m.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};m.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)if(h[c]===b){if(!0===m.prototype.isRunning()){for(var d=u.length-1;0<=d;--d)u[d]===b&&u.splice(d,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}h.splice(c,1)}};m.prototype.start=function(){if(0==u.length){for(var k=0,l=h.length;k<l;++k)u.push(h[k]);m.prototype.dispatch("a.callback.chainer.start",{});q={};0==u.length&&c()}k=u.shift();a.isFunction(k)&&k({success:c,
done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b},arguments)};m.prototype.isRunning=function(){return 0==u.length?!1:!0};var t=new m;t.setName("a.callback.chainer");return t};a.form=function(){function c(b,c){return a.isNull(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],d=b.length;d--;)c.push(b[d]);return c}function d(b){var d=c(b,"name");if(a.isNull(d)||""===d)if(d=c(b,"id"),a.isNull(d)||""===d)d=c(b,"class");return d}function e(d){var e=d.getElementsByTagName("input"),f=d.getElementsByTagName("textarea");d=d.getElementsByTagName("select");for(var e=b(e),g=e.length;g--;){var h=c(e[g],"type");a.contains(l,h)||a.isNull(h)||e.splice(g,1)}return e.concat(b(f),
...
["number","checkbox","radio","file"]),l=h.concat(g,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=e(b);for(var f={},g=b.length;g--;){var h=b[g],k=d(h),l;l=h;var w=c(l,"type"),v=l.tagName.toLowerCase();l="input"===v||"textarea"===v?"checkbox"===w?l.checked:l.value:"select"===v?l.options[l.selectedIndex].value:void 0;null!==k&&""!==k&&(a.isNull(h)||"radio"!==c(h,"type")?f[k]=""===l?null:l:h.checked&&(f[k]=""===l?null:l))}a.console.log("a.form.get: found element list:",
3);a.console.log(f,3);return f},validate:function(b){if(!a.isNull(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=e(b);for(var l=[],m="number range text search url email password color checkbox hidden radio".split(" "),t=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),n=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),x=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),w=b.length;w--;){var v=b[w],y=v.tagName.toLowerCase();if("select"!==y&&a.isNull(c(v,"formnovalidate"))){var s=c(v,"type"),p=d(v),
r=v.value,E=c(v,"required"),D=c(v,"pattern");c(v,"multiple");var B=c(v,"min"),z=c(v,"max"),A=c(v,"step"),B=a.isNull(B)||""===B?null:parseFloat(B),z=a.isNull(z)||""===z?null:parseFloat(z),A=a.isNull(A)||""===A?null:parseFloat(A);"input"!==y||a.contains(m,s)||a.isNull(s)?"number"!==s&&"range"!==s||a.isNumber(r)?"url"!==s||t.test(r)?"email"!==s||n.test(r)?"color"!==s||x.test(r)?null!==E&&a.contains(k,s)&&(""===r||a.isNull(r))?l.push(f(v,p,"required",r)):null===D||"textarea"!==y&&!a.contains(g,s)&&!a.isNull(s)||
RegExp(D).test(r)?null===B&&null==z&&null==A||!a.contains(h,s)||(y=parseFloat(r),null!==B&&y<B?l.push(f(v,p,"min",r)):null!==z&&y>z?l.push(f(v,p,"max",r)):null!==A&&0!==y%A&&l.push(f(v,p,"step",r))):l.push(f(v,p,"pattern",r)):l.push(f(v,p,null,r)):l.push(f(v,p,null,r)):l.push(f(v,p,null,r)):l.push(f(v,p,null,r)):a.console.warn("Type "+s+" for input "+p+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(l,3);return l},validateAndGet:function(b){b=
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var d=k[b][c];if(a.isNull(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(d,e){var f=c(g,d);if(!a.isNull(f)){var s=f;if(a.isArray(e))for(var p=0,r=e.length;p<r;++p)var h=b(p+1),h=RegExp(h,"gi"),s=s.replace(h,
e[p]);else for(p in e)h=b(p),h=RegExp(h,"gi"),s=s.replace(h,e[p]);if(0<=s.indexOf("{{")&&0<=s.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],p=0,r=f.length;p<r;++p){var h=b(f[p]),l=f[p].replace("{{","").replace("}}",""),l=a.isNull(m[l])?null:m[l];a.isNull(l)||(h=RegExp(h,"gi"),s=s.replace(h,l))}return s=s.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return d}function e(b,c){a.isString(c)||(c=u);try{return b.getAttribute(c)}catch(d){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var y=[];b.querySelectorAll?(y=b.querySelectorAll("*["+u+"]"),0===y.length&&(y=b.querySelectorAll("*"))):y=b.getElementsByTagName("*");b=0;for(var s=y.length;b<s;++b)a.isNull(e(y[b]))||f.push(y[b]);y=0;for(b=f.length;y<b;++y){var p=f[y],s=e(p);if(!a.isNull(s)){var r=c(g,s),h={};a.isNull(r)&&(r=s);for(var r=r.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],k=0,t=r.length;k<t;++k){var n=r[k].replace("{{","").replace("}}",""),A=e(p,u+"-"+n);a.isNull(A)?(A="undefined"===m[n]?null:m[n],a.isNull(A)||
(h[n]=A)):h[n]=A}r=d(s,h);s=e(p,q);if(!a.isNull(s))try{p[s]=r}catch(x){}else if(p)if("INPUT"!==p.nodeName||"submit"!==p.type&&"reset"!==p.type)if("INPUT"===p.nodeName)try{p.placeholder=r}catch(F){}else if("FIELDSET"===p.nodeName)p.title=r;else if(!a.isNull(p.text)&&document.all)p.text=r;else if(a.isNull(p.childNodes))p.innerHTML=r;else if(s=p.childNodes.length,h=document.createTextNode(r),"leave"===l){for(r=!1;s--;)k=p.childNodes[s],3===k.nodeType&&(r||(p.insertBefore(h,k),r=!0),p.removeChild(k));
r||p.appendChild(h)}else{for(;s--;)p.removeChild(p.firstChild);p.appendChild(h)}else p.value=r}}}var g="en",h=["en","fr","de","sp"],k={},l="leave",u="data-tr",q="data-tr-attr",m={},t=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(t){var n=a.storage.persistent.getItem("a_language_store_language"),x=a.storage.persistent.getItem("a_language_store_allowed");a.isString(n)&&(g=n,f(document));a.isArray(x)&&(h=x)}return{setBehavior:function(b){l="erase"===b?"erase":"leave"},getBehavior:function(){return l},
...
{value:g}),t&&a.storage.persistent.setItem("a_language_store_language",g),this.translate(document,c))},getAllowed:function(){return h},setAllowed:function(b){a.isString(b)&&(b=[b]);if(a.isArray(b)){h=b;var c=0;for(b=b.length;c<b;++c)a.isNull(k[c])&&(k[c]={});t&&(a.console.log("a.language.setAllowed: set allowed language to "+h,3),a.storage.persistent.setItem("a_language_store_allowed",h))}else a.console.error("a.language.setAllowed: the allowed language must be an Array (value: "+b+")",1)},getSingleTranslation:function(b,
...
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=e:a.timer.add(e,null,50);var u=["resize","load","unload"],q;for(q in u)d(u[q],c(u[q]));d("load",function(){a.timer.add(b,null,g)});return f}();a.state=function(){function c(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=x;x===b||0>=x;)x=Math.floor(1E5*Math.random());return x}function d(b,c){var d=[],e=b.length;c=a.isFunction(c)?c:function(){return!0};for(var f=0;f<e;++f){for(var g=!1,h=0;h<e;++h)if(f!=h&&b[f].id===b[h].id&&c(b[f])){g=!0;break}g||d.push(b[f].id)}return d}function e(b){for(var c=0,d=[],e=a.state.helper.tree.selectLevel(b,l,c);0<e.length;)d.push(e),c++,e=a.state.helper.tree.selectLevel(b,l,c);
return d}function f(b){b=g(b);for(var c=n.length,d=[];c--;){for(var e=n[c].hashtagList,f=e.length,h=!1;f--&&(h=b({hash:e[f]}),!0!==h););h||(d=d.concat(n[c].itemList.slice()),n.splice(c,1))}return d}function g(b){return function(c){if(a.isObject(c)&&0<c.hash.length){if(c.hash===b)return!0;if(0<=c.hash.indexOf("{{")&&0<=c.hash.indexOf("}}")){var d=a.state.helper.parameter.extract(c.hash);c=c.hash;for(var e=d.length;e--;)c=a.state.helper.parameter.replace(c,d[e]);return RegExp("^"+c+"$","gi").test(b)}}return!1}}
function h(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function k(b,c){var d=h(c),e=g(b);return function(b){return!0===d(b)||!0===e(b)?!0:!1}}function l(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function u(b){return a.isObject(b)?b.id:-1}function q(b){return a.isObject(b)&&a.isObject(b.error)?b.error:null}function m(c){var h=a.clone(t),s=a.clone(t),p=a.clone(t),r=f(c.value),n=g(c.old),r=k(c.old,r),m=g(c.value);a.state.helper.tree.selectBranch(h,
l,r);a.state.helper.tree.selectBranch(s,l,m);a.state.helper.tree.selectBranch(p,l,g("*"));var r=a.state.helper.tree.flat(h.concat(s),l),q=d(r,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,l,m)&&!a.state.helper.tree.isInBranch(b,l,n)?!1:!0}),z=a.state.helper.tree.flat(p,l,u),h=e(h),w=e(s);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+q+" (does not mean all of them will be loaded)",3);var x=
b();a.state.helper.chainer("unload",h,q,-1,function(){a.state.helper.chainer("load",w,q,x,function(){0<p.length?(p=[p],a.console.log("a.state: wildcard allowed to proceed change: "+z+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",p,z,-1,function(){a.state.helper.chainer("load",p,z,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var t=[],n=[],x=-1,w=[];a.message.addListener("a.page.event.hash",m);a.message.addListener("a.message.clear",
function(){a.message.addListener("a.page.event.hash",m)});return{clear:function(){t=[]},tree:function(){return a.clone(t)},add:function(b,d){if(!a.isObject(b))return null;if(a.isArray(b))for(var e=0,f=b.length;e<f;++e)this.add(b[e]);else{b.hash=a.isString(b.hash)?b.hash:"";a.isObject(b.include)||(b.include={});b.include.css=c(b.include.css);b.include.js=c(b.include.js);b.include.translate=c(b.include.translate);b.include.html=a.isString(b.include.html)?b.include.html:null;for(var g=["preLoad","postLoad",
...
1),e&&a.console.warn("a.state.add : The wildcard has children (not allowed)",1),b.parent=null,k=!1,b.children=[]);g=[];e&&(g=b.children.slice());b.children=[];a.isNull(b.id)&&(b.id=1);for(;!a.isNull(a.state.helper.tree.getItem(t,l,h(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(k){k=a.state.helper.tree.getItem(t,l,h(b.parent));if(a.isNull(k))return null;k.children.push(b)}else t.push(b);k=b.id;e=0;for(f=g.length;e<f;++e)a.isObject(g[e])&&(g[e].parent=k,this.add(g[e]));"*"===b.hash&&a.state.helper.chainer("load",
[[b]],[k],-1,function(){});!0===b.bootOnLoad&&(g=a.clone(b),g.data=g.converter=g.options=null,g.preLoad=g.load=g.postLoad=null,g.preUnload=g.unload=g.postUnload=null,d=a.isFunction(d)?d:function(){},a.state.helper.chainer("load",[[g]],[k],-1,d));return k}},getById:function(b){return a.state.helper.tree.getItem(t,l,h(b))},removeById:function(b){var c=a.state.helper.tree.getItem(t,l,h(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(t,l,function(b){return b===
c?!1:!0})},loadById:function(b,f,k){var p=a.clone(t),r=a.page.event.hash.getHash(),m=a.clone(t);a.state.helper.tree.selectBranch(p,l,h(b));a.state.helper.tree.selectBranch(m,l,g(r));var q=a.state.helper.tree.flat(p,l),m=a.state.helper.tree.flat(m,l),m=d(m.concat(q)),p=e(p);k=a.isFunction(k)?k:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+m+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",p,m,-1,k);a.isNull(f)&&(f=r);b={id:b,itemList:a.state.helper.tree.flat(q,
l,u),hashtagList:c(f)};n.push(b)},unloadById:function(b,c){for(var d=this.getById(b),d=e([d]),f=[],g=n.length;g--;)f=f.concat(n[g].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+f+" (does not mean all of them will be unloaded)",3);g=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",d,f,-1,g)},forceReloadById:function(c,d){for(var f=a.isFunction(d)?d:function(){},h=n.length,k=[],m=a.clone(n);h--;)a.contains(n[h].itemList,c)&&k.push(n[h].hashtagList);
if(0<k.length)this.unloadById(c,function(){for(var b=k.length;b--;)a.state.loadById(c,k[b]);n=m;f()});else{var h=a.clone(t),q=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,l,g(q));for(var q=a.state.helper.tree.flat(h,l),B=q.length;B--;)if(q[B].id===c){var z=e([q[B]]),w=a.state.helper.tree.flat(h,l,u);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+w+" (does not mean all of them will be loaded/unloaded)",3);var x=b();a.state.helper.chainer("unload",z,w,
-1,function(){a.state.helper.chainer("load",z,w,x,f)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(t,l,g(b)):!1},__currentGeneratedId:function(){return x},__getError:function(b,c){var d=b.id;c="_"+c;var e=a.clone(t);a.state.helper.tree.selectBranch(e,l,h(d));for(var d=a.state.helper.tree.flat(e,l,q),e=[c,c.substring(0,c.length-1)+"x",c.substring(0,c.length-2)+"xx","generic","_generic"],f=0,g=e.length;f<g;++f){var k;a:{k=e[f];for(var m=d.length;m--;){var n=
d[m];if(!a.isNull(n))for(var u in n)if(u==k){k=n[u];break a}}k=null}if(!a.isNull(k))return k}return null},type:{add:function(b,c){w[b]=c},get:function(b){return a.isFunction(w[b])?w[b]:null},list:function(){return w}},helper:{tree:{},chainer:{},parameter:{}}}}();
...
{};a.isObject(e.a)||(e.a=e.appstorm={},e.a.parameter=e.appstorm.parameter={});a.isNull(b)?e=c:(e.a.parameter[b]=c,e.appstorm.parameter=e.a.parameter,a.isNull(e[b])&&(e[b]=c));d.setData("data",e);d.done()}):function(c){a.isNull(c.getData("data"))&&c.setData("data",{});(new a.ajax(f,function(d){if(a.isNull(b))c.setData("data",d);else{var e=c.getData("data");e[b]=d;c.setData("data",e)}c.done()},g)).send()}}function q(b,c){for(var d=new a.callback.synchronizer,e=b.include.css,f=b.include.js,h=b.include.html,
l=b.include.translate,m=b.data,n=b.title,q=b.options,t=b.converter,v=b.hash,w=e.length,x=f.length;w--;)d.addCallback(k("css",e[w]));for(;x--;)d.addCallback(k("js",f[x]));if(!a.isNull(a.language)&&0<l.length)for(e=l.length;e--;)d.addCallback(k("json",l[e],function(b){for(var c in b)a.language.addTranslation(c,b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),v),d.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(m)||
a.isObject(m))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(m))d.addCallback(u(null,m,q,v));else for(var C in m)a.isObject(m[C])&&a.isString(m[C].url)?(a.isObject(m[C].options)||(m[C].options={type:"json"}),d.addCallback(u(C,m[C].url,m[C].options,v))):d.addCallback(u(C,m[C],q,v));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNull(t)||t(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),
v),a.isNull(a.language)?document.title=n:document.title=a.language.getSingleTranslation(n));var d=b.data,e=b.html,d=a.isNull(d)?{}:d;a.isNull(e)?a.isFunction(c)&&c(b,null):a.page.template.get(e,d,function(d){a.isFunction(c)&&c(b,d)})});d.setFail(g);d.start()}function m(b,d){x=b;var f=new a.callback.chainer;"unload"===c?f.addCallback(b.preUnload,b.unload,b.postUnload):f.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.preLoad(c):c.done()},function(c){q(b,
function(d,f){a.isFunction(b.load)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(d.data))for(var h in d.data)g[h]=d.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.postLoad(c):c.done()},function(c){var d={id:b.id,value:b.id};a.message.dispatch("a.state.load",d);a.message.dispatch("a.state.load-"+b.id,d);c.done()});f.setSuccess(d);f.setFail(g);f.start()}function t(b,
c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){m(b,function(){c.done()})})}(b[f]);e.setSuccess(c);e.setFail(g);e.start()}var n=b.length,x=null;c="unload"===c?"unload":"load";d=d||[];var w=new a.callback.chainer;if("unload"===c)for(;n--;)w.addCallback(h(b[n]));else for(var v=0;v<n;)w.addCallback(h(b[v])),v++;w.setSuccess(f);w.setFail(g);w.start()};
