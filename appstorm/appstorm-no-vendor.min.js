...
a.loader=function(){function c(b,c){if(a.isNull(b))return!1;for(var d=0,f=e.length;d<f;++d)if(e[d]===b)return a.isFunction(c)&&c(),!0;return!1}function b(b,c,d,g,l,m){for(var s in c)b.setAttribute(s,c[s]);!a.isNull(l)&&l.id&&b.setAttribute("id",l.id);var p=!1,r=function(c){p||(p=!0,a.isFunction(d)&&d(b),(a.isNull(l)||!1!==l.cache)&&e.push(g))};b.addEventListener?b.addEventListener("load",r,!1):b.readyState?b.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||r()}:
b.onload=r;if("text/css"===c.type){var x=document.styleSheets.length;f++;var t=a.timer.add(function(){document.styleSheets.length>x+f-1&&(f--,a.timer.remove(t),r())},null,50)}document.getElementsByTagName("head")[0].appendChild(b)}function d(b,c,d,f){var l={url:b,method:"GET",type:"raw",async:!0,cache:!0,data:{},header:{}};a.console.log("a.loader: load resource (url: "+b+")",3);a.isNull(d)||(a.contains(g,d.method)&&(l.method=d.method),a.isNull(d.type)||"json"!==d.type&&"xml"!==d.type||(l.type=d.type),
a.isObject(d.data)&&(l.data=d.data),a.isObject(d.header)&&(l.header=d.header),a.isBoolean(d.cache)&&(l.cache=d.cache));f=a.isFunction(f)?f:function(){};(new a.ajax(l,function(f,g){a.isFunction(c)&&c(f,g);(a.isNull(d)||!1!==d.cache)&&e.push(b)},f)).send()}var e=[],f=0,g="GET POST PUT DELETE HEAD OPTIONS".split(" ");return{js:function(b,d,e,f){c(b,d)||this.jsonp(b,d,e,f)},jsonp:function(c,d,e,f){var g=a.isObject(e)&&e.type?e.type:"text/javascript";a.console.log("a.loader: load resource (url: "+c+")",
...
b,3);else if(!c(b,d)){a.console.log("a.loader: load resource (url: "+b+")",3);var g=document.createElement("object");g.id=e.id;g.data="data:application/x-silverlight-2,";g.type="application/x-silverlight-2";a.isArray(e.params)||(e.params=[]);e.params.push({name:"source",value:b});for(var m=0,s=e.params.length;m<s;++m){var p=document.createElement("param");p.name=e.params[m].name;p.value=e.params[m].value;g.appendChild(p)}document.getElementById(e.rootId).appendChild(g);var r=null,x=2E3,r=a.timer.add(function(){0<
x--&&!a.isNull(document.getElementById(e.id).Content)?(a.timer.remove(r),d()):0>=x&&a.isFunction(f)&&f(b,408)},null,200)}},trace:function(){return e}}}();a.callback={};
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===m?(l=!1,p.prototype.dispatch("a.callback.synchronizer.success",{}),q(s)):0>=k&&(l=m=!1)}function b(){!0===l&&(m=!0,l=!1,p.prototype.dispatch("a.callback.synchronizer.error",{}),v.apply(this,arguments))}function d(b,c){s[b]=c}function e(b){a.isObject(b)&&(s=b)}function f(b){return a.isNull(s[b])?null:s[b]}function g(){return s}var h=[],k=0,q=function(){return!0},v=function(){return!0},l=!1,m=!1,s={},p=function(){};p.prototype=new a.eventEmitter;
p.prototype.constructor=this;p.prototype.setSuccess=function(b){q=a.isFunction(b)?b:q};p.prototype.setDone=p.prototype.setSuccess;p.prototype.setFail=function(b){v=a.isFunction(b)?b:v};p.prototype.setError=p.prototype.setFail;p.prototype.addCallback=function(){for(var x=[],x=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,t=0,r=x.length;t<r;++t){var n=x[t];a.isFunction(n)&&(k++,h.push(n),!0===l&&n({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
l&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};p.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===l&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};p.prototype.start=function(x,t){if(0>=k)c();else{l=!0;s={};for(var r=0,n=h.length;r<n;++r)h[r]({success:c,done:c,getData:f,getFullData:g,setData:d,
setFullData:e,fail:b,error:b},t);a.isNumber(x)&&0<x?setTimeout(function(){var c=parseInt(x,10);p.prototype.dispatch("a.callback.synchronizer.error",{timeout:c});b({timeout:c})},x):p.prototype.dispatch("a.callback.synchronizer.start",{timeout:-1})}};p.prototype.isRunning=function(){return l};var r=new p;r.setName("a.callback.synchronizer");return r};
a.callback.chainer=function(){function c(){0==v.length?(v=[],k(l),m.prototype.dispatch("a.callback.chainer.success",{})):m.prototype.start(arguments)}function b(){v=[];q.apply(this,arguments);m.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){l[b]=c}function e(b){a.isObject(b)&&(l=b)}function f(b){return a.isNull(l[b])?null:l[b]}function g(){return l}var h=[],k=function(){return!0},q=function(){return!0},v=[],l={},m=function(){};m.prototype=new a.eventEmitter;m.prototype.constructor=
this;m.prototype.setSuccess=function(b){k=a.isFunction(b)?b:k};m.prototype.setDone=m.prototype.setSuccess;m.prototype.setFail=function(b){q=a.isFunction(b)?b:q};m.prototype.setError=m.prototype.setFail;m.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,e=b.length;c<e;++c){var d=b[c];a.isFunction(d)&&(h.push(d),!0===m.prototype.isRunning()&&v.push(d))}!0===m.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};m.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)if(h[c]===b){if(!0===m.prototype.isRunning()){for(var e=v.length-1;0<=e;--e)v[e]===b&&v.splice(e,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}h.splice(c,1)}};m.prototype.start=function(){if(0==v.length){for(var k=0,r=h.length;k<r;++k)v.push(h[k]);m.prototype.dispatch("a.callback.chainer.start",{});l={};0==v.length&&c()}k=v.shift();a.isFunction(k)&&k({success:c,
done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b},arguments)};m.prototype.isRunning=function(){return 0==v.length?!1:!0};var s=new m;s.setName("a.callback.chainer");return s};a.form=function(){function c(b,c){return a.isNull(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],e=b.length;e--;)c.push(b[e]);return c}function d(b){var e=c(b,"name");if(a.isNull(e)||""===e)if(e=c(b,"id"),a.isNull(e)||""===e)e=c(b,"class");return e}function e(e){var d=e.getElementsByTagName("input"),f=e.getElementsByTagName("textarea");e=e.getElementsByTagName("select");for(var d=b(d),g=d.length;g--;)a.contains(q,c(d[g],"type"))||d.splice(g,1);return d.concat(b(f),b(e))}function f(b,
...
"radio","file"]),q=h.concat(g,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=e(b);for(var f={},g=b.length;g--;){var h=b[g],k=d(h),r;r=h;var x=c(r,"type"),t=r.tagName.toLowerCase();r="input"===t||"textarea"===t?"checkbox"===x?r.checked:r.value:"select"===t?r.options[r.selectedIndex].value:void 0;null!==k&&""!==k&&(a.isNull(h)||"radio"!==c(h,"type")?f[k]=""===r?null:r:h.checked&&(f[k]=""===r?null:r))}a.console.log("a.form.get: found element list:",3);a.console.log(f,
3);return f},validate:function(b){if(!a.isNull(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=e(b);for(var l=[],m="number range text search url email password color checkbox hidden radio".split(" "),q=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),p=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),r=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),x=b.length;x--;){var t=b[x],w=t.tagName.toLowerCase();if("select"!==w&&a.isNull(c(t,"formnovalidate"))){var n=c(t,"type"),u=d(t),y=t.value,F=c(t,
"required"),D=c(t,"pattern");c(t,"multiple");var B=c(t,"min"),z=c(t,"max"),A=c(t,"step"),B=a.isNull(B)||""===B?null:parseFloat(B),z=a.isNull(z)||""===z?null:parseFloat(z),A=a.isNull(A)||""===A?null:parseFloat(A);"input"!==w||a.contains(m,n)?"number"!==n&&"range"!==n||a.isNumber(y)?"url"!==n||q.test(y)?"email"!==n||p.test(y)?"color"!==n||r.test(y)?null!==F&&a.contains(k,n)&&(""===y||a.isNull(y))?l.push(f(t,u,"required",y)):null===D||"textarea"!==w&&!a.contains(g,n)||RegExp(D).test(y)?null===B&&null==
z&&null==A||!a.contains(h,n)||(w=parseFloat(y),null!==B&&w<B?l.push(f(t,u,"min",y)):null!==z&&w>z?l.push(f(t,u,"max",y)):null!==A&&0!==w%A&&l.push(f(t,u,"step",y))):l.push(f(t,u,"pattern",y)):l.push(f(t,u,null,y)):l.push(f(t,u,null,y)):l.push(f(t,u,null,y)):l.push(f(t,u,null,y)):a.console.warn("Type "+n+" for input "+u+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(l,3);return l},validateAndGet:function(b){return{errorList:this.validate(b),
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var e=k[b][c];if(a.isNull(e))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return e;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(e,d){var f=c(g,e);if(!a.isNull(f)){var w=f;if(a.isArray(d))for(var n=0,u=d.length;n<u;++n)var h=b(n+1),h=RegExp(h,"gi"),w=w.replace(h,
d[n]);else for(n in d)h=b(n),h=RegExp(h,"gi"),w=w.replace(h,d[n]);if(0<=w.indexOf("{{")&&0<=w.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],n=0,u=f.length;n<u;++n){var h=b(f[n]),k=f[n].replace("{{","").replace("}}",""),k=a.isNull(l[k])?null:l[k];a.isNull(k)||(h=RegExp(h,"gi"),w=w.replace(h,k))}return w=w.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return e}function e(b,c){a.isString(c)||(c=q);try{return b.getAttribute(c)}catch(e){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var t=[];b.querySelectorAll?(t=b.querySelectorAll("*["+q+"]"),0===t.length&&(t=b.querySelectorAll("*"))):t=b.getElementsByTagName("*");b=0;for(var w=t.length;b<w;++b)a.isNull(e(t[b]))||f.push(t[b]);t=0;for(b=f.length;t<b;++t){var n=f[t],w=e(n);if(!a.isNull(w)){var u=c(g,w),h={};a.isNull(u)&&(u=w);for(var u=u.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],k=0,m=u.length;k<m;++k){var s=u[k].replace("{{","").replace("}}",""),p=e(n,q+"-"+s);a.isNull(p)?(p="undefined"===l[s]?null:l[s],a.isNull(p)||
(h[s]=p)):h[s]=p}u=d(w,h);w=e(n,v);if(!a.isNull(w))try{n[w]=u}catch(A){}else if(n)if("INPUT"!==n.nodeName||"submit"!==n.type&&"reset"!==n.type)if("INPUT"===n.nodeName)try{n.placeholder=u}catch(G){}else if("FIELDSET"===n.nodeName)n.title=u;else if(!a.isNull(n.text)&&document.all)n.text=u;else if(a.isNull(n.childNodes))n.innerHTML=u;else{w=n.childNodes.length;h=document.createTextNode(u);for(u=!1;w--;)k=n.childNodes[w],3===k.nodeType&&(u||(n.insertBefore(h,k),u=!0),n.removeChild(k));u||n.appendChild(h)}else n.value=
u}}}var g="en",h=["en","fr","de","sp"],k={},q="data-tr",v="data-tr-attr",l={},m=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(m){var s=a.storage.persistent.getItem("a_language_store_language"),p=a.storage.persistent.getItem("a_language_store_allowed");a.isString(s)&&(g=s,f(document));a.isArray(p)&&(h=p)}return{getCurrent:function(){return g},setCurrent:function(b,c){!a.isString(b)||0>=b.length?a.console.error("a.language.setCurrent: setting a non-string lang, or empty string, as default language: "+
b,1):(a.isNull(c)&&(c=!0),a.contains(h,b)||a.console.warn("a.language.setCurrent: unable to find language in available language list (value: "+b+", available: "+h.join(";")+")",2),g=b,a.isNull(k[g])&&(k[g]={}),a.console.log("a.language.setCurrent: set current language to "+g+", request update ? "+c,3),a.message.dispatch("a.language.change",{value:g}),m&&a.storage.persistent.setItem("a_language_store_language",g),this.translate(document,c))},getAllowed:function(){return h},setAllowed:function(b){a.isString(b)&&
(b=[b]);if(a.isArray(b)){h=b;var c=0;for(b=b.length;c<b;++c)a.isNull(k[c])&&(k[c]={});m&&(a.console.log("a.language.setAllowed: set allowed language to "+h,3),a.storage.persistent.setItem("a_language_store_allowed",h))}else a.console.error("a.language.setAllowed: the allowed language must be an Array (value: "+b+")",1)},getSingleTranslation:function(b,c){return d(b,c)},addSingleTranslation:function(b,c,e,d){a.isNull(k[b])&&(a.console.warn("a.language.addSingleTranslation: be carefull, the language you submit does not seems to exist in dict (value: "+
b+", dict: "+h.join(";")+")",1),k[b]={});k[b][c]=e;this.translate(document,d)},addTranslation:function(b,c,e){a.isNull(k[b])&&(k[b]={});for(var d in c)k[b][d]=c[d];this.translate(document,e)},getTranslation:function(b){return a.isString(b)?k[b]:k},translate:function(b,c){!1!==c&&f(b)},addVariable:function(b,c){a.console.log("a.language.addVariable: add global variable (key: "+b+", value: "+c+")",3);l[b]=c},getVariable:function(b){return"undefined"===l[b]?null:l[b]},removeVariable:function(b){a.console.log("a.language.removeVariable: remove global variable (key: "+
b+")",3);delete l[b]},clear:function(){k={}}}}();a.page={};
...
a.page.event=function(){function c(b,c){a.isObject(c)||(c={});return function(){a.message.dispatch("a.page.event."+b,c)}}function b(){var b=(new Date).getTime();b>h+2*g&&(a.console.log("a.page.event.hibernate: hibernate mode has been detected",3),c("hibernate")());h=b}function d(b,c){window.addEventListener?window.addEventListener(b,c,!1):window.attachEvent&&window.attachEvent("on"+b,c)}function e(b){var e=window.location.hash?window.location.hash.substring(1):null;if(k!==e){if(!0!==b){for(q.push({hash:e,
time:(new Date).getTime()});1E3<q.length;)q.shift();a.console.log("a.page.event.hash: hash change (previous: "+k+", new: "+e+")",3);c("hash",{value:e,old:k})()}k=e}}var f={},g=1E4,h=(new Date).getTime(),k=null,q=[];f.hash={getHash:function(){return window.location.hash?window.location.hash.substring(1):null},getPreviousHash:function(){return k},setPreviousHash:function(b){a.console.log("a.page.event.hash.setPreviousHash: change previous hash to "+b,3);k=b},trace:function(){return q}};e(!0);!a.isNull(window.onhashchange)&&
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=e:a.timer.add(e,null,50);var v=["resize","load","unload"],l;for(l in v)d(v[l],c(v[l]));d("load",function(){a.timer.add(b,null,g)});return f}();a.state=function(){function c(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=p;p===b||0>=p;)p=Math.floor(1E5*Math.random());return p}function d(b,c){var e=[],d=b.length;c=a.isFunction(c)?c:function(){return!0};for(var f=0;f<d;++f){for(var g=!1,h=0;h<d;++h)if(f!=h&&b[f].id===b[h].id&&c(b[f])){g=!0;break}g||e.push(b[f].id)}return e}function e(b){for(var c=0,e=[],d=a.state.helper.tree.selectLevel(b,q,c);0<d.length;)e.push(d),c++,d=a.state.helper.tree.selectLevel(b,q,c);
...
function h(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function k(b,c){var e=h(c),d=g(b);return function(b){return!0===e(b)||!0===d(b)?!0:!1}}function q(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function v(b){return a.isObject(b)?b.id:-1}function l(c){var h=a.clone(m),w=a.clone(m),n=a.clone(m),u=f(c.value),l=g(c.old),u=k(c.old,u),p=g(c.value);a.state.helper.tree.selectBranch(h,q,u);a.state.helper.tree.selectBranch(w,q,p);a.state.helper.tree.selectBranch(n,
q,g("*"));var u=a.state.helper.tree.flat(h.concat(w),q),r=d(u,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,q,p)&&!a.state.helper.tree.isInBranch(b,q,l)?!1:!0}),s=a.state.helper.tree.flat(n,q,v),h=e(h),z=e(w);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+r+" (does not mean all of them will be loaded)",3);var A=b();a.state.helper.chainer("unload",h,r,-1,function(){a.state.helper.chainer("load",
z,r,A,function(){0<n.length?(n=[n],a.console.log("a.state: wildcard allowed to proceed change: "+s+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",n,s,-1,function(){a.state.helper.chainer("load",n,s,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var m=[],s=[],p=-1,r=[];a.message.addListener("a.page.event.hash",l);a.message.addListener("a.message.clear",function(){a.message.addListener("a.page.event.hash",l)});return{clear:function(){m=
...
1),b.parent=null,k=!1,b.children=[]);g=[];d&&(g=b.children.slice());b.children=[];a.isNull(b.id)&&(b.id=1);for(;!a.isNull(a.state.helper.tree.getItem(m,q,h(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(k){k=a.state.helper.tree.getItem(m,q,h(b.parent));if(a.isNull(k))return null;k.children.push(b)}else m.push(b);k=b.id;d=0;for(f=g.length;d<f;++d)a.isObject(g[d])&&(g[d].parent=k,this.add(g[d]));"*"===b.hash&&a.state.helper.chainer("load",[[b]],[k],-1,function(){});!0===b.bootOnLoad&&(g=a.clone(b),
g.data=g.converter=g.options=null,g.preLoad=g.load=g.postLoad=null,g.preUnload=g.unload=g.postUnload=null,e=a.isFunction(e)?e:function(){},a.state.helper.chainer("load",[[g]],[k],-1,e));return k}},getById:function(b){return a.state.helper.tree.getItem(m,q,h(b))},removeById:function(b){var c=a.state.helper.tree.getItem(m,q,h(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(m,q,function(b){return b===c?!1:!0})},loadById:function(b,f,k){var n=a.clone(m),
u=a.page.event.hash.getHash(),l=a.clone(m);a.state.helper.tree.selectBranch(n,q,h(b));a.state.helper.tree.selectBranch(l,q,g(u));var p=a.state.helper.tree.flat(n,q),l=a.state.helper.tree.flat(l,q),l=d(l.concat(p)),n=e(n);k=a.isFunction(k)?k:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+l+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",n,l,-1,k);a.isNull(f)&&(f=u);b={id:b,itemList:a.state.helper.tree.flat(p,q,v),hashtagList:c(f)};
s.push(b)},unloadById:function(b,c){for(var d=this.getById(b),d=e([d]),f=[],g=s.length;g--;)f=f.concat(s[g].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+f+" (does not mean all of them will be unloaded)",3);g=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",d,f,-1,g)},forceReloadById:function(c,d){for(var f=a.isFunction(d)?d:function(){},h=s.length,k=[],l=a.clone(s);h--;)a.contains(s[h].itemList,c)&&k.push(s[h].hashtagList);if(0<k.length)this.unloadById(c,
function(){for(var b=k.length;b--;)a.state.loadById(c,k[b]);s=l;f()});else{var h=a.clone(m),p=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,q,g(p));for(var p=a.state.helper.tree.flat(h,q),r=p.length;r--;)if(p[r].id===c){var B=e([p[r]]),z=a.state.helper.tree.flat(h,q,v);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+z+" (does not mean all of them will be loaded/unloaded)",3);var A=b();a.state.helper.chainer("unload",B,z,-1,function(){a.state.helper.chainer("load",
B,z,A,f)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(m,q,g(b)):!1},__currentGeneratedId:function(){return p},type:{add:function(b,c){r[b]=c},get:function(b){return a.isFunction(r[b])?r[b]:null},list:function(){return r}},helper:{tree:{},chainer:{},parameter:{}}}}();
...
function(e){if(a.isNull(b))c.setData("data",e);else{var d=c.getData("data");d[b]=e;c.setData("data",d)}c.done()},g)).send()}}function l(b,c){for(var e=new a.callback.synchronizer,d=b.include.css,f=b.include.js,h=b.include.html,l=b.include.translate,m=b.data,p=b.title,q=b.options,r=b.converter,s=b.hash,x=d.length,E=f.length;x--;)e.addCallback(k("css",d[x]));for(;E--;)e.addCallback(k("js",f[E]));if(!a.isNull(a.language)&&0<l.length)for(d=l.length;d--;)e.addCallback(k("json",l[d],function(b){for(var c in b)a.language.addTranslation(c,
b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),s),e.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(m)||a.isObject(m))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(m))e.addCallback(v(null,m,q,s));else for(var C in m)a.isObject(m[C])&&a.isString(m[C].url)?(a.isObject(m[C].options)||(m[C].options={type:"json"}),e.addCallback(v(C,m[C].url,m[C].options,s))):e.addCallback(v(C,
m[C],q,s));else e.addCallback(function(b){b.setData("data",{});b.done()});e.setSuccess(function(b){a.isNull(r)||r(b.data);a.isNull(p)||(p=a.state.helper.parameter.extrapolate(p,a.page.event.hash.getHash(),s),a.isNull(a.language)?document.title=p:document.title=a.language.getSingleTranslation(p));var e=b.data,d=b.html,e=a.isNull(e)?{}:e;a.isNull(d)?a.isFunction(c)&&c(b,null):a.page.template.get(d,e,function(e){a.isFunction(c)&&c(b,e)})});e.setFail(g);e.start()}function m(b,d){var f=new a.callback.chainer;
"unload"===c?f.addCallback(b.preUnload,b.unload,b.postUnload):f.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.preLoad(c):c.done()},function(c){l(b,function(d,f){a.isFunction(b.load)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(d.data))for(var h in d.data)g[h]=d.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.postLoad(c):
c.done()});f.setSuccess(d);f.setFail(g);f.start()}function s(b,c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){m(b,function(){c.done()})})}(b[f]);e.setSuccess(c);e.setFail(g);e.start()}var p=b.length;c="unload"===c?"unload":"load";d=d||[];var r=new a.callback.chainer;if("unload"===c)for(;p--;)r.addCallback(h(b[p]));else for(var x=0;x<p;)r.addCallback(h(b[x])),x++;r.setSuccess(f);r.setFail(g);r.start()};
