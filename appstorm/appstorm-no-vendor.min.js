...
a.ajax=function(c,b,d){this.params={url:"",method:"GET",type:"raw",async:!0,cache:!1,data:{},header:{}};var e=a.getDefaultAjaxOptions();this.success=a.isFunction(b)?b:function(){};this.error=a.isFunction(d)?d:function(){};for(var f in this.params)f in e&&typeof e[f]===typeof this.params[f]&&(this.params[f]=e[f]),f in c&&typeof c[f]===typeof this.params[f]&&(this.params[f]=c[f]);a.isString(e.data)&&(this.params.data=e.data);if(a.isString(c.data)||a.isObject(c.data))this.params.data=c.data;this.request=
null;if(a.isNull(window.XMLHttpRequest)){c=["Msxml2.XMLHTTP.6.0","Msxml2.XMLHTTP.3.0","Msxml2.XMLHTTP","Microsoft.XMLHTTP"];for(var g in c)try{this.request=new ActiveXObject(c[g])}catch(h){}}else this.request=new XMLHttpRequest};a.ajax.prototype.parseResult=function(c,b){var d=c.type.toLowerCase();return"json"===d?a.parser.json.parse(b.responseText):"xml"===d?b.responseXML:b.responseText};a.ajax.prototype.abort=function(){try{this.request.abort()}catch(c){}};
...
a.loader=function(){function c(b,c){if(a.isNull(b))return!1;for(var d=0,f=e.length;d<f;++d)if(e[d]===b)return a.isFunction(c)&&c(),!0;return!1}function b(b,c,d,g,n,m){for(var s in c)b.setAttribute(s,c[s]);!a.isNull(n)&&n.id&&b.setAttribute("id",n.id);var q=!1,u=function(c){q||(q=!0,a.isFunction(d)&&d(b),(a.isNull(n)||!1!==n.cache)&&e.push(g))};b.addEventListener?b.addEventListener("load",u,!1):b.readyState?b.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||u()}:
b.onload=u;if("text/css"===c.type){var x=document.styleSheets.length;f++;var w=a.timer.add(function(){document.styleSheets.length>x+f-1&&(f--,a.timer.remove(w),u())},null,50)}document.getElementsByTagName("head")[0].appendChild(b)}function d(b,c,d,f){var n={url:b,method:"GET",type:"raw",async:!0,cache:!0,data:{},header:{}};a.console.log("a.loader: load resource (url: "+b+")",3);a.isNull(d)||(a.contains(g,d.method)&&(n.method=d.method),a.isNull(d.type)||"json"!==d.type&&"xml"!==d.type||(n.type=d.type),
a.isObject(d.data)&&(n.data=d.data),a.isObject(d.header)&&(n.header=d.header),a.isBoolean(d.cache)&&(n.cache=d.cache));f=a.isFunction(f)?f:function(){};(new a.ajax(n,function(f,g){a.isFunction(c)&&c(f,g);(a.isNull(d)||!1!==d.cache)&&e.push(b)},f)).send()}var e=[],f=0,g="GET POST PUT DELETE HEAD OPTIONS".split(" ");return{js:function(b,d,e,f){c(b,d)||this.jsonp(b,d,e,f)},jsonp:function(c,d,e,f){var g=a.isObject(e)&&e.type?e.type:"text/javascript";a.console.log("a.loader: load resource (url: "+c+")",
...
b,3);else if(!c(b,d)){a.console.log("a.loader: load resource (url: "+b+")",3);var g=document.createElement("object");g.id=e.id;g.data="data:application/x-silverlight-2,";g.type="application/x-silverlight-2";a.isArray(e.params)||(e.params=[]);e.params.push({name:"source",value:b});for(var m=0,s=e.params.length;m<s;++m){var q=document.createElement("param");q.name=e.params[m].name;q.value=e.params[m].value;g.appendChild(q)}document.getElementById(e.rootId).appendChild(g);var u=null,x=2E3,u=a.timer.add(function(){0<
x--&&!a.isNull(document.getElementById(e.id).Content)?(a.timer.remove(u),d()):0>=x&&a.isFunction(f)&&f(b,408)},null,200)}},trace:function(){return e}}}();a.callback={};
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===m?(n=!1,q.prototype.dispatch("a.callback.synchronizer.success",{}),l(s)):0>=k&&(n=m=!1)}function b(){!0===n&&(m=!0,n=!1,q.prototype.dispatch("a.callback.synchronizer.error",{}),v.apply(this,arguments))}function d(b,c){s[b]=c}function e(b){a.isObject(b)&&(s=b)}function f(b){return a.isNull(s[b])?null:s[b]}function g(){return s}var h=[],k=0,l=function(){return!0},v=function(){return!0},n=!1,m=!1,s={},q=function(){};q.prototype=new a.eventEmitter;
q.prototype.constructor=this;q.prototype.setSuccess=function(b){l=a.isFunction(b)?b:l};q.prototype.setDone=q.prototype.setSuccess;q.prototype.setFail=function(b){v=a.isFunction(b)?b:v};q.prototype.setError=q.prototype.setFail;q.prototype.addCallback=function(){for(var x=[],x=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,w=0,y=x.length;w<y;++w){var r=x[w];a.isFunction(r)&&(k++,h.push(r),!0===n&&r({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
n&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};q.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===n&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};q.prototype.start=function(x,w){if(0>=k)c();else{n=!0;s={};for(var y=0,r=h.length;y<r;++y)h[y]({success:c,done:c,getData:f,getFullData:g,setData:d,
setFullData:e,fail:b,error:b},w);a.isNumber(x)&&0<x?setTimeout(function(){var c=parseInt(x,10);q.prototype.dispatch("a.callback.synchronizer.error",{timeout:c});b({timeout:c})},x):q.prototype.dispatch("a.callback.synchronizer.start",{timeout:-1})}};q.prototype.isRunning=function(){return n};var u=new q;u.setName("a.callback.synchronizer");return u};
a.callback.chainer=function(){function c(){0==v.length?(v=[],k(n),m.prototype.dispatch("a.callback.chainer.success",{})):m.prototype.start(arguments)}function b(){v=[];l.apply(this,arguments);m.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){n[b]=c}function e(b){a.isObject(b)&&(n=b)}function f(b){return a.isNull(n[b])?null:n[b]}function g(){return n}var h=[],k=function(){return!0},l=function(){return!0},v=[],n={},m=function(){};m.prototype=new a.eventEmitter;m.prototype.constructor=
this;m.prototype.setSuccess=function(b){k=a.isFunction(b)?b:k};m.prototype.setDone=m.prototype.setSuccess;m.prototype.setFail=function(b){l=a.isFunction(b)?b:l};m.prototype.setError=m.prototype.setFail;m.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,d=b.length;c<d;++c){var e=b[c];a.isFunction(e)&&(h.push(e),!0===m.prototype.isRunning()&&v.push(e))}!0===m.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};m.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)if(h[c]===b){if(!0===m.prototype.isRunning()){for(var d=v.length-1;0<=d;--d)v[d]===b&&v.splice(d,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}h.splice(c,1)}};m.prototype.start=function(){if(0==v.length){for(var k=0,s=h.length;k<s;++k)v.push(h[k]);m.prototype.dispatch("a.callback.chainer.start",{});n={};0==v.length&&c()}k=v.shift();a.isFunction(k)&&k({success:c,
done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b},arguments)};m.prototype.isRunning=function(){return 0==v.length?!1:!0};var s=new m;s.setName("a.callback.chainer");return s};a.form=function(){function c(b,c){return a.isNull(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],d=b.length;d--;)c.push(b[d]);return c}function d(b){var d=c(b,"name");if(a.isNull(d)||""===d)if(d=c(b,"id"),a.isNull(d)||""===d)d=c(b,"class");return d}function e(d){var e=d.getElementsByTagName("input"),f=d.getElementsByTagName("textarea");d=d.getElementsByTagName("select");for(var e=b(e),g=e.length;g--;)a.contains(l,c(e[g],"type"))||e.splice(g,1);return e.concat(b(f),b(d))}function f(b,
...
"radio","file"]),l=h.concat(g,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=e(b);for(var f={},g=b.length;g--;){var h=b[g],k=d(h),l;l=h;var x=c(l,"type"),w=l.tagName.toLowerCase();l="input"===w||"textarea"===w?"checkbox"===x?l.checked:l.value:"select"===w?l.options[l.selectedIndex].value:void 0;null!==k&&""!==k&&(a.isNull(h)||"radio"!==c(h,"type")?f[k]=""===l?null:l:h.checked&&(f[k]=""===l?null:l))}a.console.log("a.form.get: found element list:",3);a.console.log(f,
3);return f},validate:function(b){if(!a.isNull(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=e(b);for(var l=[],m="number range text search url email password color checkbox hidden radio".split(" "),s=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),q=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),u=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),x=b.length;x--;){var w=b[x],y=w.tagName.toLowerCase();if("select"!==y&&a.isNull(c(w,"formnovalidate"))){var r=c(w,"type"),p=d(w),t=w.value,F=c(w,
"required"),D=c(w,"pattern");c(w,"multiple");var C=c(w,"min"),A=c(w,"max"),z=c(w,"step"),C=a.isNull(C)||""===C?null:parseFloat(C),A=a.isNull(A)||""===A?null:parseFloat(A),z=a.isNull(z)||""===z?null:parseFloat(z);"input"!==y||a.contains(m,r)?"number"!==r&&"range"!==r||a.isNumber(t)?"url"!==r||s.test(t)?"email"!==r||q.test(t)?"color"!==r||u.test(t)?null!==F&&a.contains(k,r)&&(""===t||a.isNull(t))?l.push(f(w,p,"required",t)):null===D||"textarea"!==y&&!a.contains(g,r)||RegExp(D).test(t)?null===C&&null==
A&&null==z||!a.contains(h,r)||(y=parseFloat(t),null!==C&&y<C?l.push(f(w,p,"min",t)):null!==A&&y>A?l.push(f(w,p,"max",t)):null!==z&&0!==y%z&&l.push(f(w,p,"step",t))):l.push(f(w,p,"pattern",t)):l.push(f(w,p,null,t)):l.push(f(w,p,null,t)):l.push(f(w,p,null,t)):l.push(f(w,p,null,t)):a.console.warn("Type "+r+" for input "+p+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(l,3);return l},validateAndGet:function(b){return{errorList:this.validate(b),
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var d=k[b][c];if(a.isNull(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(d,e){var f=c(g,d);if(!a.isNull(f)){var r=f;if(a.isArray(e))for(var p=0,h=e.length;p<h;++p)var l=b(p+1),l=RegExp(l,"gi"),r=r.replace(l,
e[p]);else for(p in e)l=b(p),l=RegExp(l,"gi"),r=r.replace(l,e[p]);if(0<=r.indexOf("{{")&&0<=r.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],p=0,h=f.length;p<h;++p){var l=b(f[p]),k=f[p].replace("{{","").replace("}}",""),k=a.isNull(m[k])?null:m[k];a.isNull(k)||(l=RegExp(l,"gi"),r=r.replace(l,k))}return r=r.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return d}function e(b,c){a.isString(c)||(c=v);try{return b.getAttribute(c)}catch(d){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var h=[];b.querySelectorAll?(h=b.querySelectorAll("*["+v+"]"),0===h.length&&(h=b.querySelectorAll("*"))):h=b.getElementsByTagName("*");b=0;for(var r=h.length;b<r;++b)a.isNull(e(h[b]))||f.push(h[b]);h=0;for(b=f.length;h<b;++h){var p=f[h],r=e(p);if(!a.isNull(r)){var t=c(g,r),k={};a.isNull(t)&&(t=r);for(var t=t.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],s=0,q=t.length;s<q;++s){var u=t[s].replace("{{","").replace("}}",""),z=e(p,v+"-"+u);a.isNull(z)?(z="undefined"===m[u]?null:m[u],a.isNull(z)||
(k[u]=z)):k[u]=z}t=d(r,k);r=e(p,n);if(!a.isNull(r))try{p[r]=t}catch(G){}else if(p)if("INPUT"!==p.nodeName||"submit"!==p.type&&"reset"!==p.type)if("INPUT"===p.nodeName)try{p.placeholder=t}catch(H){}else if("FIELDSET"===p.nodeName)p.title=t;else if(!a.isNull(p.text)&&document.all)p.text=t;else if(a.isNull(p.childNodes))p.innerHTML=t;else if(r=p.childNodes.length,k=document.createTextNode(t),"leave"===l){for(t=!1;r--;)s=p.childNodes[r],3===s.nodeType&&(t||(p.insertBefore(k,s),t=!0),p.removeChild(s));
t||p.appendChild(k)}else{for(;r--;)p.removeChild(p.firstChild);p.appendChild(k)}else p.value=t}}}var g="en",h=["en","fr","de","sp"],k={},l="leave",v="data-tr",n="data-tr-attr",m={},s=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(s){var q=a.storage.persistent.getItem("a_language_store_language"),u=a.storage.persistent.getItem("a_language_store_allowed");a.isString(q)&&(g=q,f(document));a.isArray(u)&&(h=u)}return{setBehavior:function(b){l="erase"===b?"erase":"leave"},getBehavior:function(){return l},
...
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=e:a.timer.add(e,null,50);var v=["resize","load","unload"],n;for(n in v)d(v[n],c(v[n]));d("load",function(){a.timer.add(b,null,g)});return f}();a.state=function(){function c(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=q;q===b||0>=q;)q=Math.floor(1E5*Math.random());return q}function d(b,c){var d=[],e=b.length;c=a.isFunction(c)?c:function(){return!0};for(var f=0;f<e;++f){for(var g=!1,h=0;h<e;++h)if(f!=h&&b[f].id===b[h].id&&c(b[f])){g=!0;break}g||d.push(b[f].id)}return d}function e(b){for(var c=0,d=[],e=a.state.helper.tree.selectLevel(b,l,c);0<e.length;)d.push(e),c++,e=a.state.helper.tree.selectLevel(b,l,c);
...
function h(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function k(b,c){var d=h(c),e=g(b);return function(b){return!0===d(b)||!0===e(b)?!0:!1}}function l(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function v(b){return a.isObject(b)?b.id:-1}function n(c){var h=a.clone(m),y=a.clone(m),r=a.clone(m),p=f(c.value),t=g(c.old),p=k(c.old,p),s=g(c.value);a.state.helper.tree.selectBranch(h,l,p);a.state.helper.tree.selectBranch(y,l,s);a.state.helper.tree.selectBranch(r,
l,g("*"));var p=a.state.helper.tree.flat(h.concat(y),l),n=d(p,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,l,s)&&!a.state.helper.tree.isInBranch(b,l,t)?!1:!0}),q=a.state.helper.tree.flat(r,l,v),h=e(h),u=e(y);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+n+" (does not mean all of them will be loaded)",3);var z=b();a.state.helper.chainer("unload",h,n,-1,function(){a.state.helper.chainer("load",
u,n,z,function(){0<r.length?(r=[r],a.console.log("a.state: wildcard allowed to proceed change: "+q+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",r,q,-1,function(){a.state.helper.chainer("load",r,q,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var m=[],s=[],q=-1,u=[];a.message.addListener("a.page.event.hash",n);a.message.addListener("a.message.clear",function(){a.message.addListener("a.page.event.hash",n)});return{clear:function(){m=
[]},tree:function(){return a.clone(m)},add:function(b,d){if(!a.isObject(b))return null;if(a.isArray(b))for(var e=0,f=b.length;e<f;++e)this.add(b[e]);else{b.hash=a.isString(b.hash)?b.hash:"";a.isObject(b.include)||(b.include={});b.include.css=c(b.include.css);b.include.js=c(b.include.js);b.include.translate=c(b.include.translate);b.include.html=a.isString(b.include.html)?b.include.html:null;for(var g=["preLoad","postLoad","preUnload","unload","postUnload"],k=0,e=g.length;k<e;++k)f=b[g[k]],a.isFunction(f)&&
...
1),b.parent=null,k=!1,b.children=[]);g=[];e&&(g=b.children.slice());b.children=[];a.isNull(b.id)&&(b.id=1);for(;!a.isNull(a.state.helper.tree.getItem(m,l,h(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(k){k=a.state.helper.tree.getItem(m,l,h(b.parent));if(a.isNull(k))return null;k.children.push(b)}else m.push(b);k=b.id;e=0;for(f=g.length;e<f;++e)a.isObject(g[e])&&(g[e].parent=k,this.add(g[e]));"*"===b.hash&&a.state.helper.chainer("load",[[b]],[k],-1,function(){});!0===b.bootOnLoad&&(g=a.clone(b),
g.data=g.converter=g.options=null,g.preLoad=g.load=g.postLoad=null,g.preUnload=g.unload=g.postUnload=null,d=a.isFunction(d)?d:function(){},a.state.helper.chainer("load",[[g]],[k],-1,d));return k}},getById:function(b){return a.state.helper.tree.getItem(m,l,h(b))},removeById:function(b){var c=a.state.helper.tree.getItem(m,l,h(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(m,l,function(b){return b===c?!1:!0})},loadById:function(b,f,k){var r=a.clone(m),
p=a.page.event.hash.getHash(),t=a.clone(m);a.state.helper.tree.selectBranch(r,l,h(b));a.state.helper.tree.selectBranch(t,l,g(p));var n=a.state.helper.tree.flat(r,l),t=a.state.helper.tree.flat(t,l),t=d(t.concat(n)),r=e(r);k=a.isFunction(k)?k:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+t+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",r,t,-1,k);a.isNull(f)&&(f=p);b={id:b,itemList:a.state.helper.tree.flat(n,l,v),hashtagList:c(f)};
s.push(b)},unloadById:function(b,c){for(var d=this.getById(b),d=e([d]),f=[],g=s.length;g--;)f=f.concat(s[g].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+f+" (does not mean all of them will be unloaded)",3);g=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",d,f,-1,g)},forceReloadById:function(c,d){for(var f=a.isFunction(d)?d:function(){},h=s.length,k=[],t=a.clone(s);h--;)a.contains(s[h].itemList,c)&&k.push(s[h].hashtagList);if(0<k.length)this.unloadById(c,
function(){for(var b=k.length;b--;)a.state.loadById(c,k[b]);s=t;f()});else{var h=a.clone(m),n=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,l,g(n));for(var n=a.state.helper.tree.flat(h,l),q=n.length;q--;)if(n[q].id===c){var u=e([n[q]]),A=a.state.helper.tree.flat(h,l,v);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+A+" (does not mean all of them will be loaded/unloaded)",3);var z=b();a.state.helper.chainer("unload",u,A,-1,function(){a.state.helper.chainer("load",
u,A,z,f)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(m,l,g(b)):!1},__currentGeneratedId:function(){return q},type:{add:function(b,c){u[b]=c},get:function(b){return a.isFunction(u[b])?u[b]:null},list:function(){return u}},helper:{tree:{},chainer:{},parameter:{}}}}();
...
function(d){if(a.isNull(b))c.setData("data",d);else{var e=c.getData("data");e[b]=d;c.setData("data",e)}c.done()},g)).send()}}function n(b,c){for(var d=new a.callback.synchronizer,e=b.include.css,f=b.include.js,h=b.include.html,l=b.include.translate,m=b.data,n=b.title,q=b.options,s=b.converter,u=b.hash,x=e.length,E=f.length;x--;)d.addCallback(k("css",e[x]));for(;E--;)d.addCallback(k("js",f[E]));if(!a.isNull(a.language)&&0<l.length)for(e=l.length;e--;)d.addCallback(k("json",l[e],function(b){for(var c in b)a.language.addTranslation(c,
b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),u),d.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(m)||a.isObject(m))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(m))d.addCallback(v(null,m,q,u));else for(var B in m)a.isObject(m[B])&&a.isString(m[B].url)?(a.isObject(m[B].options)||(m[B].options={type:"json"}),d.addCallback(v(B,m[B].url,m[B].options,u))):d.addCallback(v(B,
m[B],q,u));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNull(s)||s(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),u),a.isNull(a.language)?document.title=n:document.title=a.language.getSingleTranslation(n));var d=b.data,e=b.html,d=a.isNull(d)?{}:d;a.isNull(e)?a.isFunction(c)&&c(b,null):a.page.template.get(e,d,function(d){a.isFunction(c)&&c(b,d)})});d.setFail(g);d.start()}function m(b,d){var f=new a.callback.chainer;
"unload"===c?f.addCallback(b.preUnload,b.unload,b.postUnload):f.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.preLoad(c):c.done()},function(c){n(b,function(d,f){a.isFunction(b.load)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(d.data))for(var h in d.data)g[h]=d.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.postLoad(c):
c.done()});f.setSuccess(d);f.setFail(g);f.start()}function s(b,c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){m(b,function(){c.done()})})}(b[f]);e.setSuccess(c);e.setFail(g);e.start()}var q=b.length;c="unload"===c?"unload":"load";d=d||[];var u=new a.callback.chainer;if("unload"===c)for(;q--;)u.addCallback(h(b[q]));else for(var x=0;x<q;)u.addCallback(h(b[x])),x++;u.setSuccess(f);u.setFail(g);u.start()};
