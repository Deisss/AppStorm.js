...
a.loader=function(){function c(b,c){if(a.isNull(b))return!1;for(var d=0,f=e.length;d<f;++d)if(e[d]===b)return a.isFunction(c)&&c(),!0;return!1}function b(b,c,d,g,q,m){for(var s in c)b.setAttribute(s,c[s]);!a.isNull(q)&&q.id&&b.setAttribute("id",q.id);var n=!1,x=function(c){n||(n=!0,a.isFunction(d)&&d(b),(a.isNull(q)||!1!==q.cache)&&e.push(g))};b.addEventListener?b.addEventListener("load",x,!1):b.readyState?b.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||x()}:
...
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===m?(q=!1,n.prototype.dispatch("a.callback.synchronizer.success",{}),l(s)):0>=k&&(q=m=!1)}function b(){!0===q&&(m=!0,q=!1,n.prototype.dispatch("a.callback.synchronizer.error",{}),u.apply(this,arguments))}function d(b,c){s[b]=c}function e(b){a.isObject(b)&&(s=b)}function f(b){return a.isNull(s[b])?null:s[b]}function g(){return s}var h=[],k=0,l=function(){return!0},u=function(){return!0},q=!1,m=!1,s={},n=function(){};n.prototype=new a.eventEmitter;
n.prototype.constructor=this;n.prototype.setSuccess=function(b){l=a.isFunction(b)?b:l};n.prototype.setDone=n.prototype.setSuccess;n.prototype.setFail=function(b){u=a.isFunction(b)?b:u};n.prototype.setError=n.prototype.setFail;n.prototype.addCallback=function(){for(var w=[],w=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,v=0,y=w.length;v<y;++v){var t=w[v];a.isFunction(t)&&(k++,h.push(t),!0===q&&t({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
q&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};n.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===q&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};n.prototype.start=function(w,v){if(0>=k)c();else{q=!0;s={};for(var y=0,t=h.length;y<t;++y)h[y]({success:c,done:c,getData:f,getFullData:g,setData:d,
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var d=k[b][c];if(a.isNull(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(d,e){var f=c(g,d);if(!a.isNull(f)){var t=f;if(a.isArray(e))for(var p=0,r=e.length;p<r;++p)var h=b(p+1),h=RegExp(h,"gi"),t=t.replace(h,
e[p]);else for(p in e)h=b(p),h=RegExp(h,"gi"),t=t.replace(h,e[p]);if(0<=t.indexOf("{{")&&0<=t.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],p=0,r=f.length;p<r;++p){var h=b(f[p]),l=f[p].replace("{{","").replace("}}",""),l=a.isNull(m[l])?null:m[l];a.isNull(l)||(h=RegExp(h,"gi"),t=t.replace(h,l))}return t=t.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return d}function e(b,c){a.isString(c)||(c=u);try{return b.getAttribute(c)}catch(d){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var y=[];b.querySelectorAll?(y=b.querySelectorAll("*["+u+"]"),0===y.length&&(y=b.querySelectorAll("*"))):y=b.getElementsByTagName("*");b=0;for(var t=y.length;b<t;++b)a.isNull(e(y[b]))||f.push(y[b]);y=0;for(b=f.length;y<b;++y){var p=f[y],t=e(p);if(!a.isNull(t)){var r=c(g,t),h={};a.isNull(r)&&(r=t);for(var r=r.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],k=0,s=r.length;k<s;++k){var n=r[k].replace("{{","").replace("}}",""),A=e(p,u+"-"+n);a.isNull(A)?(A="undefined"===m[n]?null:m[n],a.isNull(A)||
(h[n]=A)):h[n]=A}r=d(t,h);t=e(p,q);if(!a.isNull(t))try{p[t]=r}catch(x){}else if(p)if("INPUT"!==p.nodeName||"submit"!==p.type&&"reset"!==p.type)if("INPUT"===p.nodeName)try{p.placeholder=r}catch(F){}else if("FIELDSET"===p.nodeName)p.title=r;else if(!a.isNull(p.text)&&document.all)p.text=r;else if(a.isNull(p.childNodes))p.innerHTML=r;else if(t=p.childNodes.length,h=document.createTextNode(r),"leave"===l){for(r=!1;t--;)k=p.childNodes[t],3===k.nodeType&&(r||(p.insertBefore(h,k),r=!0),p.removeChild(k));
r||p.appendChild(h)}else{for(;t--;)p.removeChild(p.firstChild);p.appendChild(h)}else p.value=r}}}var g="en",h=["en","fr","de","sp"],k={},l="leave",u="data-tr",q="data-tr-attr",m={},s=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(s){var n=a.storage.persistent.getItem("a_language_store_language"),x=a.storage.persistent.getItem("a_language_store_allowed");a.isString(n)&&(g=n,f(document));a.isArray(x)&&(h=x)}return{setBehavior:function(b){l="erase"===b?"erase":"leave"},getBehavior:function(){return l},
...
if(0<k.length)this.unloadById(c,function(){for(var b=k.length;b--;)a.state.loadById(c,k[b]);n=m;f()});else{var h=a.clone(s),q=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,l,g(q));for(var q=a.state.helper.tree.flat(h,l),B=q.length;B--;)if(q[B].id===c){var z=e([q[B]]),w=a.state.helper.tree.flat(h,l,u);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+w+" (does not mean all of them will be loaded/unloaded)",3);var x=b();a.state.helper.chainer("unload",z,w,
-1,function(){a.state.helper.chainer("load",z,w,x,f)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(s,l,g(b)):!1},__currentGeneratedId:function(){return x},__getError:function(b,c){var d=b.id;c="_"+c;var e=a.clone(s);a.state.helper.tree.selectBranch(e,l,h(d));for(var d=a.state.helper.tree.flat(e,l,q),e=[c,c.substring(0,c.length-1)+"x",c.substring(0,c.length-2)+"xx","generic","_generic"],f=0,g=e.length;f<g;++f){var k;a:{k=e[f];for(var m=d.length;m--;){var n=
...
l=b.include.translate,m=b.data,n=b.title,q=b.options,s=b.converter,v=b.hash,w=e.length,x=f.length;w--;)d.addCallback(k("css",e[w]));for(;x--;)d.addCallback(k("js",f[x]));if(!a.isNull(a.language)&&0<l.length)for(e=l.length;e--;)d.addCallback(k("json",l[e],function(b){for(var c in b)a.language.addTranslation(c,b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),v),d.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(m)||
a.isObject(m))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(m))d.addCallback(u(null,m,q,v));else for(var C in m)a.isObject(m[C])&&a.isString(m[C].url)?(a.isObject(m[C].options)||(m[C].options={type:"json"}),d.addCallback(u(C,m[C].url,m[C].options,v))):d.addCallback(u(C,m[C],q,v));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNull(s)||s(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),
...
function(d,f){a.isFunction(b.load)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(d.data))for(var h in d.data)g[h]=d.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.postLoad(c):c.done()});f.setSuccess(d);f.setFail(g);f.start()}function s(b,c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){m(b,function(){c.done()})})}(b[f]);
