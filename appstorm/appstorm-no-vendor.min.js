...
a.timer=function(){var c={};setInterval(function(){a.message.dispatch("a.timer.tick",{});for(var b in c){var d=c[b];d.current+=50;if(d.current>=d.timeout&&(d.current=0,a.isFunction(d.fct))){var e=a.isObject(d.scope)?d.scope:null;d.fct.call(e,null)}}},50);return{add:function(b,d,e){var f;for(f=Math.floor(1E6*Math.random());!a.isNull(c[f]);)f=Math.floor(1E6*Math.random());if(isNaN(parseFloat(e))||!isFinite(e)||0>=e)e=1E3,a.console.error("The timeout has not been setted properly into timer, timeout has been setted to 1000ms",
...
a.loader=function(){function c(b,c){if(a.isNull(b))return!1;for(var d=0,f=e.length;d<f;++d)if(e[d]===b)return a.isFunction(c)&&c(),!0;return!1}function b(b,c,d,g,m,l){for(var t in c)b.setAttribute(t,c[t]);!a.isNull(m)&&m.id&&b.setAttribute("id",m.id);var n=!1,r=function(c){n||(n=!0,a.isFunction(d)&&d(b),(a.isNull(m)||!1!==m.cache)&&e.push(g))};b.addEventListener?b.addEventListener("load",r,!1):b.readyState?b.onreadystatechange=function(){"complete"!==this.readyState&&"loaded"!==this.readyState||r()}:
b.onload=r;if("text/css"===c.type){var w=document.styleSheets.length;f++;var u=a.timer.add(function(){document.styleSheets.length>w+f-1&&(f--,a.timer.remove(u),r())},null,50)}document.getElementsByTagName("head")[0].appendChild(b)}function d(b,c,d,f){var m={url:b,method:"GET",type:"raw",async:!0,cache:!0,data:{},header:{}};a.console.log("a.loader: load resource (url: "+b+")",3);a.isNull(d)||(a.contains(g,d.method)&&(m.method=d.method),a.isNull(d.type)||"json"!==d.type&&"xml"!==d.type||(m.type=d.type),
a.isObject(d.data)&&(m.data=d.data),a.isObject(d.header)&&(m.header=d.header),a.isBoolean(d.cache)&&(m.cache=d.cache));f=a.isFunction(f)?f:function(){};(new a.ajax(m,function(f,g){a.isFunction(c)&&c(f,g);(a.isNull(d)||!1!==d.cache)&&e.push(b)},f)).send()}var e=[],f=0,g="GET POST PUT DELETE HEAD OPTIONS".split(" ");return{js:function(b,d,e,f){c(b,d)||this.jsonp(b,d,e,f)},jsonp:function(c,d,e,f){var g=a.isObject(e)&&e.type?e.type:"text/javascript";a.console.log("a.loader: load resource (url: "+c+")",
...
(d.version?d.version:"1.3")+"/dtfx.js",function(){javafx({archive:b,width:d.width||1,height:d.height||1,code:d.code,name:d.id})});var g=null,l=2E3,g=a.timer.add(function(){0<l--&&!a.isNull(document.getElementById(d.id).Packages)?(a.timer.remove(g),a.isFunction(e)&&e()):0>=l&&a.isFunction(f)&&f(b,408)},null,200)}},flash:function(b,e,d,f){a.isNull(d)||a.isNull(d.rootId)||a.isNull(d.id)?a.console.warn("a.loader.flash : the system need args parameters : rootId, id, setted to be able to load any flash resource... This uri will not be loaded : "+
...
b,3);else if(!c(b,d)){a.console.log("a.loader: load resource (url: "+b+")",3);var g=document.createElement("object");g.id=e.id;g.data="data:application/x-silverlight-2,";g.type="application/x-silverlight-2";a.isArray(e.params)||(e.params=[]);e.params.push({name:"source",value:b});for(var l=0,t=e.params.length;l<t;++l){var n=document.createElement("param");n.name=e.params[l].name;n.value=e.params[l].value;g.appendChild(n)}document.getElementById(e.rootId).appendChild(g);var r=null,w=2E3,r=a.timer.add(function(){0<
w--&&!a.isNull(document.getElementById(e.id).Content)?(a.timer.remove(r),d()):0>=w&&a.isFunction(f)&&f(b,408)},null,200)}},trace:function(){return e}}}();a.callback={};
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===l?(m=!1,n.prototype.dispatch("a.callback.synchronizer.success",{}),p(t)):0>=k&&(m=l=!1)}function b(){!0===m&&(l=!0,m=!1,n.prototype.dispatch("a.callback.synchronizer.error",{}),v.apply(this,arguments))}function d(b,c){t[b]=c}function e(b){a.isObject(b)&&(t=b)}function f(b){return a.isNull(t[b])?null:t[b]}function g(){return t}var h=[],k=0,p=function(){return!0},v=function(){return!0},m=!1,l=!1,t={},n=function(){};n.prototype=new a.eventEmitter;
n.prototype.constructor=this;n.prototype.setSuccess=function(b){p=a.isFunction(b)?b:p};n.prototype.setDone=n.prototype.setSuccess;n.prototype.setFail=function(b){v=a.isFunction(b)?b:v};n.prototype.setError=n.prototype.setFail;n.prototype.addCallback=function(){for(var w=[],w=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,u=0,q=w.length;u<q;++u){var s=w[u];a.isFunction(s)&&(k++,h.push(s),!0===m&&s({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
m&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};n.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===m&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};n.prototype.start=function(w,u){if(0>=k)c();else{m=!0;t={};for(var q=0,s=h.length;q<s;++q)h[q]({success:c,done:c,getData:f,getFullData:g,setData:d,
setFullData:e,fail:b,error:b},u);a.isNumber(w)&&0<w?setTimeout(function(){var c=parseInt(w,10);n.prototype.dispatch("a.callback.synchronizer.error",{timeout:c});b({timeout:c})},w):n.prototype.dispatch("a.callback.synchronizer.start",{timeout:-1})}};n.prototype.isRunning=function(){return m};var r=new n;r.setName("a.callback.synchronizer");return r};
a.callback.chainer=function(){function c(){0==v.length?(v=[],k(m),l.prototype.dispatch("a.callback.chainer.success",{})):l.prototype.start(arguments)}function b(){v=[];p.apply(this,arguments);l.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){m[b]=c}function e(b){a.isObject(b)&&(m=b)}function f(b){return a.isNull(m[b])?null:m[b]}function g(){return m}var h=[],k=function(){return!0},p=function(){return!0},v=[],m={},l=function(){};l.prototype=new a.eventEmitter;l.prototype.constructor=
this;l.prototype.setSuccess=function(b){k=a.isFunction(b)?b:k};l.prototype.setDone=l.prototype.setSuccess;l.prototype.setFail=function(b){p=a.isFunction(b)?b:p};l.prototype.setError=l.prototype.setFail;l.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,e=b.length;c<e;++c){var d=b[c];a.isFunction(d)&&(h.push(d),!0===l.prototype.isRunning()&&v.push(d))}!0===l.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};l.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)if(h[c]===b){if(!0===l.prototype.isRunning()){for(var e=v.length-1;0<=e;--e)v[e]===b&&v.splice(e,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}h.splice(c,1)}};l.prototype.start=function(){if(0==v.length){for(var k=0,r=h.length;k<r;++k)v.push(h[k]);l.prototype.dispatch("a.callback.chainer.start",{});m={};0==v.length&&c()}k=v.shift();a.isFunction(k)&&k({success:c,
done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b},arguments)};l.prototype.isRunning=function(){return 0==v.length?!1:!0};var t=new l;t.setName("a.callback.chainer");return t};a.form=function(){function c(b,c){return a.isNull(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],e=b.length;e--;)c.push(b[e]);return c}function d(b){var e=c(b,"name");if(a.isNull(e)||""===e)if(e=c(b,"id"),a.isNull(e)||""===e)e=c(b,"class");return e}function e(e){var d=e.getElementsByTagName("input"),f=e.getElementsByTagName("textarea");e=e.getElementsByTagName("select");for(var d=b(d),g=d.length;g--;)a.contains(p,c(d[g],"type"))||d.splice(g,1);return d.concat(b(f),b(e))}function f(b,
...
"radio","file"]),p=h.concat(g,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=e(b);for(var f={},g=b.length;g--;){var h=b[g],k=d(h),r;r=h;var w=c(r,"type"),u=r.tagName.toLowerCase();r="input"===u||"textarea"===u?"checkbox"===w?r.checked:r.value:"select"===u?r.options[r.selectedIndex].value:void 0;null!==k&&""!==k&&(a.isNull(h)||"radio"!==c(h,"type")?f[k]=""===r?null:r:h.checked&&(f[k]=""===r?null:r))}a.console.log("a.form.get: found element list:",3);a.console.log(f,
3);return f},validate:function(b){if(!a.isNull(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=e(b);for(var m=[],l="number range text search url email password color checkbox hidden radio".split(" "),p=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),n=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),r=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),w=b.length;w--;){var u=b[w],q=u.tagName.toLowerCase();if("select"!==q&&a.isNull(c(u,"formnovalidate"))){var s=c(u,"type"),x=d(u),z=u.value,F=c(u,
"required"),D=c(u,"pattern");c(u,"multiple");var B=c(u,"min"),y=c(u,"max"),A=c(u,"step"),B=a.isNull(B)||""===B?null:parseFloat(B),y=a.isNull(y)||""===y?null:parseFloat(y),A=a.isNull(A)||""===A?null:parseFloat(A);"input"!==q||a.contains(l,s)?"number"!==s&&"range"!==s||a.isNumber(z)?"url"!==s||p.test(z)?"email"!==s||n.test(z)?"color"!==s||r.test(z)?null!==F&&a.contains(k,s)&&(""===z||a.isNull(z))?m.push(f(u,x,"required",z)):null===D||"textarea"!==q&&!a.contains(g,s)||RegExp(D).test(z)?null===B&&null==
y&&null==A||!a.contains(h,s)||(q=parseFloat(z),null!==B&&q<B?m.push(f(u,x,"min",z)):null!==y&&q>y?m.push(f(u,x,"max",z)):null!==A&&0!==q%A&&m.push(f(u,x,"step",z))):m.push(f(u,x,"pattern",z)):m.push(f(u,x,null,z)):m.push(f(u,x,null,z)):m.push(f(u,x,null,z)):m.push(f(u,x,null,z)):a.console.warn("Type "+s+" for input "+x+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(m,3);return m},validateAndGet:function(b){var c={};c.errorList=this.validate(b);
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var e=k[b][c];if(a.isNull(e))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return e;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(e,d){var f=c(g,e);if(!a.isNull(f)){var q=f;if(a.isArray(d))for(var s=0,x=d.length;s<x;++s)var h=b(s+1),h=RegExp(h,"gi"),q=q.replace(h,
d[s]);else for(s in d)h=b(s),h=RegExp(h,"gi"),q=q.replace(h,d[s]);if(0<=q.indexOf("{{")&&0<=q.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],s=0,x=f.length;s<x;++s){var h=b(f[s]),k=f[s].replace("{{","").replace("}}",""),k=a.isNull(m[k])?null:m[k];a.isNull(k)||(h=RegExp(h,"gi"),q=q.replace(h,k))}return q=q.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return e}function e(b,c){a.isString(c)||(c=p);try{return b.getAttribute(c)}catch(e){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var u=[];b.querySelectorAll?(u=b.querySelectorAll("*["+p+"]"),0===u.length&&(u=b.querySelectorAll("*"))):u=b.getElementsByTagName("*");b=0;for(var q=u.length;b<q;++b)a.isNull(e(u[b]))||f.push(u[b]);u=0;for(b=f.length;u<b;++u){var q=f[u],s=e(q);if(!a.isNull(s)){var h=c(g,s),k={};a.isNull(h)&&(h=s);for(var h=h.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],l=0,t=h.length;l<t;++l){var n=h[l].replace("{{","").replace("}}",""),y=e(q,p+"-"+n);a.isNull(y)?(y="undefined"===m[n]?null:m[n],a.isNull(y)||
(k[n]=y)):k[n]=y}h=d(s,k);s=e(q,v);if(!a.isNull(s))try{q[s]=h}catch(A){}else if(q)if("INPUT"!==q.nodeName||"submit"!==q.type&&"reset"!==q.type)if("INPUT"===q.nodeName)try{q.placeholder=h}catch(G){}else if("FIELDSET"===q.nodeName)q.title=h;else if(!a.isNull(q.text)&&document.all)q.text=h;else if(a.isNull(q.childNodes))q.innerHTML=h;else{for(;0<q.childNodes.length;)q.removeChild(q.firstChild);q.appendChild(document.createTextNode(h))}else q.value=h}}}var g="en",h=["en","fr","de","sp"],k={},p="data-tr",
v="data-tr-attr",m={},l=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(l){var t=a.storage.persistent.getItem("a_language_store_language"),n=a.storage.persistent.getItem("a_language_store_allowed");a.isString(t)&&(g=t,f(document));a.isArray(n)&&(h=n)}return{getCurrent:function(){return g},setCurrent:function(b,c){!a.isString(b)||0>=b.length?a.console.error("a.language.setCurrent: setting a non-string lang, or empty string, as default language: "+b,1):(a.isNull(c)&&(c=!0),a.contains(h,b)||
a.console.warn("a.language.setCurrent: unable to find language in available language list (value: "+b+", available: "+h.join(";")+")",2),g=b,a.isNull(k[g])&&(k[g]={}),a.console.log("a.language.setCurrent: set current language to "+g+", request update ? "+c,3),a.message.dispatch("a.language.change",{value:g}),l&&a.storage.persistent.setItem("a_language_store_language",g),this.translate(document,c))},getAllowed:function(){return h},setAllowed:function(b){a.isString(b)&&(b=[b]);if(a.isArray(b)){h=b;
var c=0;for(b=b.length;c<b;++c)a.isNull(k[c])&&(k[c]={});l&&(a.console.log("a.language.setAllowed: set allowed language to "+h,3),a.storage.persistent.setItem("a_language_store_allowed",h))}else a.console.error("a.language.setAllowed: the allowed language must be an Array (value: "+b+")",1)},getSingleTranslation:function(b,c){return d(b,c)},addSingleTranslation:function(b,c,e,d){a.isNull(k[b])&&(a.console.warn("a.language.addSingleTranslation: be carefull, the language you submit does not seems to exist in dict (value: "+
b+", dict: "+h.join(";")+")",1),k[b]={});k[b][c]=e;this.translate(document,d)},addTranslation:function(b,c,e){a.isNull(k[b])&&(k[b]={});for(var d in c)k[b][d]=c[d];this.translate(document,e)},getTranslation:function(b){return a.isString(b)?k[b]:k},translate:function(b,c){!1!==c&&f(b)},addVariable:function(b,c){a.console.log("a.language.addVariable: add global variable (key: "+b+", value: "+c+")",3);m[b]=c},getVariable:function(b){return"undefined"===m[b]?null:m[b]},removeVariable:function(b){a.console.log("a.language.removeVariable: remove global variable (key: "+
b+")",3);delete m[b]},clear:function(){k={}}}}();a.page={};
...
a.page.event=function(){function c(b,c){a.isObject(c)||(c={});return function(){a.message.dispatch("a.page.event."+b,c)}}function b(){var b=(new Date).getTime();b>h+2*g&&(a.console.log("a.page.event.hibernate: hibernate mode has been detected",3),c("hibernate")());h=b}function d(b,c){window.addEventListener?window.addEventListener(b,c,!1):window.attachEvent&&window.attachEvent("on"+b,c)}function e(b){var e=window.location.hash?window.location.hash.substring(1):null;if(k!==e){if(!0!==b){for(p.push({hash:e,
time:(new Date).getTime()});1E3<p.length;)p.shift();a.console.log("a.page.event.hash: hash change (previous: "+k+", new: "+e+")",3);c("hash",{value:e,old:k})()}k=e}}var f={},g=1E4,h=(new Date).getTime(),k=null,p=[];f.hash={getHash:function(){return window.location.hash?window.location.hash.substring(1):null},getPreviousHash:function(){return k},setPreviousHash:function(b){a.console.log("a.page.event.hash.setPreviousHash: change previous hash to "+b,3);k=b},trace:function(){return p}};e(!0);!a.isNull(window.onhashchange)&&
(void 0===document.documentMode||7<document.documentMode)?window.onhashchange=e:setInterval(e,50);var v=["resize","load","unload"],m;for(m in v)d(v[m],c(v[m]));d("load",function(){setInterval(b,g)});return f}();a.state=function(){function c(b){return a.isArray(b)?b.reverse():a.isString(b)?[b]:[]}function b(){for(var b=n;n===b||0>=n;)n=Math.floor(1E5*Math.random());return n}function d(b,c){var e=[],d=b.length;c=a.isFunction(c)?c:function(){return!0};for(var f=0;f<d;++f){for(var g=!1,h=0;h<d;++h)if(f!=h&&b[f].id===b[h].id&&c(b[f])){g=!0;break}g||e.push(b[f].id)}return e}function e(b){for(var c=0,e=[],d=a.state.helper.tree.selectLevel(b,p,c);0<d.length;)e.push(d),c++,d=a.state.helper.tree.selectLevel(b,p,c);
...
function h(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function k(b,c){var e=h(c),d=g(b);return function(b){return!0===e(b)||!0===d(b)?!0:!1}}function p(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function v(b){return a.isObject(b)?b.id:-1}function m(c){var h=a.clone(l),q=a.clone(l),s=a.clone(l),x=f(c.value),m=g(c.old),x=k(c.old,x),n=g(c.value);a.state.helper.tree.selectBranch(h,p,x);a.state.helper.tree.selectBranch(q,p,n);a.state.helper.tree.selectBranch(s,
p,g("*"));var x=a.state.helper.tree.flat(h.concat(q),p),r=d(x,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,p,n)&&!a.state.helper.tree.isInBranch(b,p,m)?!1:!0}),t=a.state.helper.tree.flat(s,p,v),h=e(h),y=e(q);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+r+" (does not mean all of them will be loaded)",3);var A=b();a.state.helper.chainer("unload",h,r,-1,function(){a.state.helper.chainer("load",
y,r,A,function(){0<s.length?(s=[s],a.console.log("a.state: wildcard allowed to proceed change: "+t+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",s,t,-1,function(){a.state.helper.chainer("load",s,t,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var l=[],t=[],n=-1,r=[];a.message.addListener("a.page.event.hash",m);a.message.addListener("a.message.clear",function(){a.message.addListener("a.page.event.hash",m)});return{clear:function(){l=
[]},tree:function(){return a.clone(l)},add:function(b,e){if(!a.isObject(b))return null;if(a.isArray(b))for(var d=0,f=b.length;d<f;++d)this.add(b[d]);else{b.hash=a.isString(b.hash)?b.hash:"";a.isObject(b.include)||(b.include={});b.include.css=c(b.include.css);b.include.js=c(b.include.js);b.include.translate=c(b.include.translate);b.include.html=a.isString(b.include.html)?b.include.html:null;for(var g=["preLoad","postLoad","preUnload","unload","postUnload"],k=0,d=g.length;k<d;++k)f=b[g[k]],a.isFunction(f)&&
...
1),b.parent=null,k=!1,b.children=[]);g=[];d&&(g=b.children.slice());b.children=[];a.isNull(b.id)&&(b.id=1);for(;!a.isNull(a.state.helper.tree.getItem(l,p,h(b.id)));)b.id=Math.floor(1E5*Math.random()+1);if(k){k=a.state.helper.tree.getItem(l,p,h(b.parent));if(a.isNull(k))return null;k.children.push(b)}else l.push(b);k=b.id;d=0;for(f=g.length;d<f;++d)a.isObject(g[d])&&(g[d].parent=k,this.add(g[d]));"*"===b.hash&&a.state.helper.chainer("load",[[b]],[k],-1,function(){});!0===b.bootOnLoad&&(g=a.clone(b),
g.data=g.converter=g.options=null,g.preLoad=g.load=g.postLoad=null,g.preUnload=g.unload=g.postUnload=null,e=a.isFunction(e)?e:function(){},a.state.helper.chainer("load",[[g]],[k],-1,e));return k}},getById:function(b){return a.state.helper.tree.getItem(l,p,h(b))},removeById:function(b){var c=a.state.helper.tree.getItem(l,p,h(b));a.console.log("a.state.removeById: remove element (id: "+b+")",3);a.state.helper.tree.selectBranch(l,p,function(b){return b===c?!1:!0})},loadById:function(b,f,k){var s=a.clone(l),
m=a.page.event.hash.getHash(),n=a.clone(l);a.state.helper.tree.selectBranch(s,p,h(b));a.state.helper.tree.selectBranch(n,p,g(m));var r=a.state.helper.tree.flat(s,p),n=a.state.helper.tree.flat(n,p),n=d(n.concat(r)),s=e(s);k=a.isFunction(k)?k:function(){};a.console.log("a.state.loadById: element allowed to proceed change: "+n+" (does not mean all of them will be loaded)",3);a.state.helper.chainer("load",s,n,-1,k);a.isNull(f)&&(f=m);b={id:b,itemList:a.state.helper.tree.flat(r,p,v),hashtagList:c(f)};
t.push(b)},unloadById:function(b,c){for(var d=this.getById(b),d=e([d]),f=[],g=t.length;g--;)f=f.concat(t[g].itemList);a.console.log("a.state.unloadById: element allowed to proceed change: "+f+" (does not mean all of them will be unloaded)",3);g=a.isFunction(c)?c:function(){};a.state.helper.chainer("unload",d,f,-1,g)},forceReloadById:function(c,d){for(var f=a.isFunction(d)?d:function(){},h=t.length,k=[],m=a.clone(t);h--;)a.contains(t[h].itemList,c)&&k.push(t[h].hashtagList);if(0<k.length)this.unloadById(c,
function(){for(var b=k.length;b--;)a.state.loadById(c,k[b]);t=m;f()});else{var h=a.clone(l),n=a.page.event.hash.getHash();a.state.helper.tree.selectBranch(h,p,g(n));for(var n=a.state.helper.tree.flat(h,p),r=n.length;r--;)if(n[r].id===c){var B=e([n[r]]),y=a.state.helper.tree.flat(h,p,v);a.console.log("a.state.forceReloadById: element allowed to proceed change: "+y+" (does not mean all of them will be loaded/unloaded)",3);var A=b();a.state.helper.chainer("unload",B,y,-1,function(){a.state.helper.chainer("load",
B,y,A,f)});break}}},hashExists:function(b){return a.isString(b)&&""!==b?a.state.helper.tree.isInBranch(l,p,g(b)):!1},__currentGeneratedId:function(){return n},type:{add:function(b,c){r[b]=c},get:function(b){return a.isFunction(r[b])?r[b]:null},list:function(){return r}},helper:{tree:{},chainer:{},parameter:{}}}}();
...
a.state.helper.chainer=function(c,b,d,e,f){function g(b,c){var e={};a.isNull(b)||(e.resource=b);a.isNull(c)||(e.status=c);a.message.dispatch("a.state.error",e)}function h(b){return function(c){t(b,function(){c.done()})}}function k(b,c,e){return function(d){a.loader[b](c,function(b){a.isFunction(e)&&e(b);d.done()})}}function p(b,c,e){if(a.isObject(e))for(var d in e)e[d]=a.state.helper.parameter.extrapolate(e[d],b,c),p(b,c,e[d])}function v(b,c,e,d){var f=a.clone(e);e=a.page.event.hash.getHash();f.url=
...
function(e){if(a.isNull(b))c.setData("data",e);else{var d=c.getData("data");d[b]=e;c.setData("data",d)}c.done()},g)).send()}}function m(b,c){for(var e=new a.callback.synchronizer,d=b.include.css,f=b.include.js,h=b.include.html,m=b.include.translate,l=b.data,n=b.title,p=b.options,r=b.converter,t=b.hash,w=d.length,E=f.length;w--;)e.addCallback(k("css",d[w]));for(;E--;)e.addCallback(k("js",f[E]));if(!a.isNull(a.language)&&0<m.length)for(d=m.length;d--;)e.addCallback(k("json",m[d],function(b){for(var c in b)a.language.addTranslation(c,
b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),t),e.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(l)||a.isObject(l))if(a.isObject(p)||(p={type:"json"}),a.isString(p.type)||(p.type="json"),a.isString(l))e.addCallback(v(null,l,p,t));else for(var C in l)a.isObject(l[C])&&a.isString(l[C].url)?(a.isObject(l[C].options)||(l[C].options={type:"json"}),e.addCallback(v(C,l[C].url,l[C].options,t))):e.addCallback(v(C,
l[C],p,t));else e.addCallback(function(b){b.setData("data",{});b.done()});e.setSuccess(function(b){a.isNull(r)||r(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),t),a.isNull(a.language)?document.title=n:document.title=a.language.getSingleTranslation(n));var e=b.data,d=b.html,e=a.isNull(e)?{}:e;a.isNull(d)?a.isFunction(c)&&c(b,null):a.page.template.get(d,e,function(e){a.isFunction(c)&&c(b,e)})});e.setFail(g);e.start()}function l(b,d){var f=new a.callback.chainer;
"unload"===c?f.addCallback(b.preUnload,b.unload,b.postUnload):f.addCallback(function(c){a.isFunction(b.preLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.preLoad(c):c.done()},function(c){m(b,function(d,f){a.isFunction(b.load)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)&&b.load(f);var g=c.getFullData()||{};if(a.isObject(d.data))for(var h in d.data)g[h]=d.data[h];c.setFullData(g);c.done()})},function(c){a.isFunction(b.postLoad)&&(-1==e||0<=e&&a.state.__currentGeneratedId()===e)?b.postLoad(c):
c.done()});f.setSuccess(d);f.setFail(g);f.start()}function t(b,c){for(var e=new a.callback.synchronizer,f=b.length;f--;)a.contains(d,b[f].id)&&function(b){e.addCallback(function(c){l(b,function(){c.done()})})}(b[f]);e.setSuccess(c);e.setFail(g);e.start()}var n=b.length;c="unload"===c?"unload":"load";d=d||[];var r=new a.callback.chainer;if("unload"===c)for(;n--;)r.addCallback(h(b[n]));else for(var w=0;w<n;)r.addCallback(h(b[w])),w++;r.setSuccess(f);r.setFail(g);r.start()};
...
getItem:function(c){this.start();if(!0===b){var d=document.getElementById("javafxstorage").Packages.javafxstorage.localStorage.loadData(c);if(a.isNull(d)||"false"===d)return a.storage.__printGetErrorItem("javafx",c),null;d=a.parser.json.parse(d);a.storage.__printGetItem("javafx",c,d);return d}},setItem:function(c,d){this.start();!0===b&&(a.storage.__printSetItem("javafx",c,d),document.getElementById("javafxstorage").Packages.javafxstorage.localStorage.saveData(c,a.parser.json.stringify(d)))},removeItem:function(c){this.start();
!0===b&&(a.storage.__printRemoveItem("javafx",c),document.getElementById("javafxstorage").Packages.javafxstorage.localStorage.removeData(c))}}}();a.storage.temporary=function(){for(var c=["sessionStorage","cookie","memory"],b=0,d=c.length;b<d;++b){var e=c[b];if(a.storage.type[e].support)return a.console.log("a.storage.temporary: choosing storage "+a.storage.type[e].engine,3),a.message.dispatch("a.storage.temporary.change",{engine:e}),a.storage.type[e]}return null}();
