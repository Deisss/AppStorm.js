...
c)},attr:function(c,b){return this._perform(a.dom.attr,c,b)},attribute:function(c,b){if("undefined"===typeof b){for(var d=[],e=this.elementList,f=e.length;f--;)try{var g=e[f].getAttribute();a.isNull(g)||a.contains(d,g)||d.push(g)}catch(h){}return d}this.each(function(){try{this.setAttribute(c,b)}catch(d){}});return this},data:function(c,b){return this.attribute("data-"+c,b)},parent:function(){for(var c=this.elementList,b=c.length;b--;)c[b]=c[b].parentNode;return this},insertBefore:function(c){this.each(function(){this.parentNode.insertBefore(c,
...
a.callback.synchronizer=function(){function c(){k--;0>=k&&!1===m?(q=!1,n.prototype.dispatch("a.callback.synchronizer.success",{}),l(s)):0>=k&&(q=m=!1)}function b(){!0===q&&(m=!0,q=!1,n.prototype.dispatch("a.callback.synchronizer.error",{}),t.apply(this,arguments))}function d(b,c){s[b]=c}function e(b){a.isObject(b)&&(s=b)}function f(b){return a.isNull(s[b])?null:s[b]}function g(){return s}var h=[],k=0,l=function(){return!0},t=function(){return!0},q=!1,m=!1,s={},n=function(){};n.prototype=new a.eventEmitter;
n.prototype.constructor=this;n.prototype.setSuccess=function(b){l=a.isFunction(b)?b:l};n.prototype.setDone=n.prototype.setSuccess;n.prototype.setFail=function(b){t=a.isFunction(b)?b:t};n.prototype.setError=n.prototype.setFail;n.prototype.addCallback=function(){for(var v=[],v=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,u=0,A=v.length;u<A;++u){var w=v[u];a.isFunction(w)&&(k++,h.push(w),!0===q&&w({success:c,done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b}))}!0===
q&&a.console.warn("a.callback.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",1)};n.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)h[c]===b&&(!0===q&&a.console.warn("a.callback.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1),k--,h.splice(c,1))};n.prototype.start=function(v,u){if(0>=k)c();else{q=!0;s={};for(var A=0,w=h.length;A<w;++A)h[A]({success:c,done:c,getData:f,getFullData:g,setData:d,
setFullData:e,fail:b,error:b},u);a.isNumber(v)&&0<v?setTimeout(function(){var c=parseInt(v,10);n.prototype.dispatch("a.callback.synchronizer.error",{timeout:c});b({timeout:c})},v):n.prototype.dispatch("a.callback.synchronizer.start",{timeout:-1})}};n.prototype.isRunning=function(){return q};var x=new n;x.setName("a.callback.synchronizer");return x};
a.callback.chainer=function(){function c(){0==t.length?(t=[],k(q),m.prototype.dispatch("a.callback.chainer.success",{})):m.prototype.start(arguments)}function b(){t=[];l.apply(this,arguments);m.prototype.dispatch("a.callback.chainer.error",{})}function d(b,c){q[b]=c}function e(b){a.isObject(b)&&(q=b)}function f(b){return a.isNull(q[b])?null:q[b]}function g(){return q}var h=[],k=function(){return!0},l=function(){return!0},t=[],q={},m=function(){};m.prototype=new a.eventEmitter;m.prototype.constructor=
this;m.prototype.setSuccess=function(b){k=a.isFunction(b)?b:k};m.prototype.setDone=m.prototype.setSuccess;m.prototype.setFail=function(b){l=a.isFunction(b)?b:l};m.prototype.setError=m.prototype.setFail;m.prototype.addCallback=function(){for(var b=[],b=!a.isNull(arguments[0])&&a.isArray(arguments[0])?arguments[0]:arguments,c=0,d=b.length;c<d;++c){var e=b[c];a.isFunction(e)&&(h.push(e),!0===m.prototype.isRunning()&&t.push(e))}!0===m.prototype.isRunning()&&a.console.warn("a.synchronizer.addCallback : you should not add/remove callback when synchronizer is running",
1)};m.prototype.removeCallback=function(b){for(var c=h.length-1;0<=c;--c)if(h[c]===b){if(!0===m.prototype.isRunning()){for(var d=t.length-1;0<=d;--d)t[d]===b&&t.splice(d,1);a.console.warn("a.synchronizer.removeCallback : you should not add/remove callback when synchronizer is running",1)}h.splice(c,1)}};m.prototype.start=function(){if(0==t.length){for(var k=0,l=h.length;k<l;++k)t.push(h[k]);m.prototype.dispatch("a.callback.chainer.start",{});q={};0==t.length&&c()}k=t.shift();a.isFunction(k)&&k({success:c,
done:c,getData:f,getFullData:g,setData:d,setFullData:e,fail:b,error:b},arguments)};m.prototype.isRunning=function(){return 0==t.length?!1:!0};var s=new m;s.setName("a.callback.chainer");return s};a.form=function(){function c(b,c){return a.isNull(b.getAttribute)?null:b.getAttribute(c)}function b(b){for(var c=[],d=b.length;d--;)c.push(b[d]);return c}function d(b){var d=c(b,"name");if(a.isNull(d)||""===d)if(d=c(b,"id"),a.isNull(d)||""===d)d=c(b,"class");return d}function e(d){var e=d.getElementsByTagName("input"),f=d.getElementsByTagName("textarea");d=d.getElementsByTagName("select");for(var e=b(e),g=e.length;g--;){var h=c(e[g],"type");a.contains(l,h)||a.isNull(h)||e.splice(g,1)}return e.concat(b(f),
...
["number","checkbox","radio","file"]),l=h.concat(g,["color","checkbox","file","hidden","radio"]);return{skipNoValidate:!1,get:function(b){b=e(b);for(var f={},g=b.length;g--;){var h=b[g],k=d(h),l;l=h;var v=c(l,"type"),u=l.tagName.toLowerCase();l="input"===u||"textarea"===u?"checkbox"===v?l.checked:l.value:"select"===u?l.options[l.selectedIndex].value:void 0;null!==k&&""!==k&&(a.isNull(h)||"radio"!==c(h,"type")?f[k]=""===l?null:l:h.checked&&(f[k]=""===l?null:l))}a.console.log("a.form.get: found element list:",
3);a.console.log(f,3);return f},validate:function(b){if(!a.isNull(c(b,"novalidate"))&&!1===this.skipNoValidate)return[];b=e(b);for(var l=[],m="number range text search url email password color checkbox hidden radio".split(" "),s=RegExp("^[a-z]{2,}:\\/\\/([a-z0-9\\/\\.\\-_~+;:&=]{2,})$","gi"),n=RegExp("^.{2,}@.*\\.[a-z0-9]{2,}$","gi"),x=RegExp("^#([a-f]{3}|[a-f]{6})$","gi"),v=b.length;v--;){var u=b[v],A=u.tagName.toLowerCase();if("select"!==A&&a.isNull(c(u,"formnovalidate"))){var w=c(u,"type"),p=d(u),
r=u.value,E=c(u,"required"),y=c(u,"pattern");c(u,"multiple");var D=c(u,"min"),z=c(u,"max"),B=c(u,"step"),D=a.isNull(D)||""===D?null:parseFloat(D),z=a.isNull(z)||""===z?null:parseFloat(z),B=a.isNull(B)||""===B?null:parseFloat(B);"input"!==A||a.contains(m,w)||a.isNull(w)?"number"!==w&&"range"!==w||a.isNumber(r)?"url"!==w||s.test(r)?"email"!==w||n.test(r)?"color"!==w||x.test(r)?null!==E&&a.contains(k,w)&&(""===r||a.isNull(r))?l.push(f(u,p,"required",r)):null===y||"textarea"!==A&&!a.contains(g,w)&&!a.isNull(w)||
RegExp(y).test(r)?null===D&&null==z&&null==B||!a.contains(h,w)||(A=parseFloat(r),null!==D&&A<D?l.push(f(u,p,"min",r)):null!==z&&A>z?l.push(f(u,p,"max",r)):null!==B&&0!==A%B&&l.push(f(u,p,"step",r))):l.push(f(u,p,"pattern",r)):l.push(f(u,p,null,r)):l.push(f(u,p,null,r)):l.push(f(u,p,null,r)):l.push(f(u,p,null,r)):a.console.warn("Type "+w+" for input "+p+" not recognized or not supported",3)}}a.console.log("a.form.validate: found error list:",3);a.console.log(l,3);return l},validateAndGet:function(b){b=
...
3);c.reset()},clear:function(){a.console.log("a.keyboard.clear: clear all keys",3);c.reset()}}}(window.Mousetrap);a.language=function(){function c(b,c){if(a.isNull(k[b]))return null;var d=k[b][c];if(a.isNull(d))a.console.info("a.language.__getRawTranslate: unable to find hash in dictionnary (value: "+c+", language: "+b+")",3);else return d;return null}function b(b){b=""+b;0>b.indexOf("{{")&&(b="{{"+b+"}}");b=b.replace("{{","\\{\\{");return b=b.replace("}}","\\}\\}")}function d(d,e){var f=c(g,d);if(!a.isNull(f)){var h=f;if(a.isArray(e))for(var p=0,r=e.length;p<r;++p)var k=b(p+1),k=RegExp(k,"gi"),h=h.replace(k,
e[p]);else for(p in e)k=b(p),k=RegExp(k,"gi"),h=h.replace(k,e[p]);if(0<=h.indexOf("{{")&&0<=h.indexOf("}}"))for(f=f.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],p=0,r=f.length;p<r;++p){var k=b(f[p]),l=f[p].replace("{{","").replace("}}",""),l=a.isNull(m[l])?null:m[l];a.isNull(l)||(k=RegExp(k,"gi"),h=h.replace(k,l))}return h=h.replace(/\{\{[a-z\-_0-9]+\}\}/gi,"")}return d}function e(b,c){a.isString(c)||(c=t);try{return b.getAttribute(c)}catch(d){return null}}function f(b){a.isNull(b)&&(b=document);var f=[];
a.isNull(e(b))||f.push(b);var h=[];b.querySelectorAll?(h=b.querySelectorAll("*["+t+"]"),0===h.length&&(h=b.querySelectorAll("*"))):h=b.getElementsByTagName("*");b=0;for(var w=h.length;b<w;++b)a.isNull(e(h[b]))||f.push(h[b]);h=0;for(b=f.length;h<b;++h){var p=f[h],w=e(p);if(!a.isNull(w)){var r=c(g,w),k={};a.isNull(r)&&(r=w);for(var r=r.match(/\{\{[a-z0-9\-_]+\}\}/gi)||[],y=0,s=r.length;y<s;++y){var n=r[y].replace("{{","").replace("}}",""),B=e(p,t+"-"+n);a.isNull(B)?(B="undefined"===m[n]?null:m[n],a.isNull(B)||
(k[n]=B)):k[n]=B}r=d(w,k);w=e(p,q);if(!a.isNull(w))try{p[w]=r}catch(x){}else if(p)if("INPUT"!==p.nodeName||"submit"!==p.type&&"reset"!==p.type)if("INPUT"===p.nodeName)try{p.placeholder=r}catch(F){}else if("FIELDSET"===p.nodeName)p.title=r;else if(!a.isNull(p.text)&&document.all)p.text=r;else if(a.isNull(p.childNodes))p.innerHTML=r;else if(w=p.childNodes.length,k=document.createTextNode(r),"leave"===l){for(r=!1;w--;)y=p.childNodes[w],3===y.nodeType&&(r||(p.insertBefore(k,y),r=!0),p.removeChild(y));
r||p.appendChild(k)}else{for(;w--;)p.removeChild(p.firstChild);p.appendChild(k)}else p.value=r}}}var g="en",h=["en","fr","de","sp"],k={},l="leave",t="data-tr",q="data-tr-attr",m={},s=!a.isNull(a.storage)&&!0===a.storage.persistent.support;if(s){var n=a.storage.persistent.getItem("a_language_store_language"),x=a.storage.persistent.getItem("a_language_store_allowed");a.isString(n)&&(g=n,f(document));a.isArray(x)&&(h=x)}return{setBehavior:function(b){l="erase"===b?"erase":"leave"},getBehavior:function(){return l},
...
function h(b){return function(c){return a.isObject(c)&&(a.isArray(b)&&a.contains(b,c.id)||c.id===b)?!0:!1}}function k(b,c){var d=h(c),e=g(b);return function(b){return!0===d(b)||!0===e(b)?!0:!1}}function l(b){return a.isObject(b)&&a.isArray(b.children)?b.children:[]}function t(b){return a.isObject(b)?b.id:-1}function q(b){return a.isObject(b)&&a.isObject(b.error)?b.error:null}function m(c){var h=a.clone(s),w=a.clone(s),p=a.clone(s),r=f(c.value),n=g(c.old),r=k(c.old,r),m=g(c.value);a.state.helper.tree.selectBranch(h,
l,r);a.state.helper.tree.selectBranch(w,l,m);a.state.helper.tree.selectBranch(p,l,g("*"));var r=a.state.helper.tree.flat(h.concat(w),l),q=d(r,function(b){return 0<=b.hash.indexOf("{{")&&0<=b.hash.indexOf("}}")&&!a.state.helper.tree.isInBranch(b,l,m)&&!a.state.helper.tree.isInBranch(b,l,n)?!1:!0}),z=a.state.helper.tree.flat(p,l,t),h=e(h),v=e(w);a.message.dispatch("a.state.begin",c);a.console.log("a.state: element allowed to proceed change: "+q+" (does not mean all of them will be loaded)",3);var x=
b();a.state.helper.chainer("unload",h,q,-1,function(){a.state.helper.chainer("load",v,q,x,function(){0<p.length?(p=[p],a.console.log("a.state: wildcard allowed to proceed change: "+z+" (does not mean all of them will be loaded)",3),a.state.helper.chainer("unload",p,z,-1,function(){a.state.helper.chainer("load",p,z,-1,function(){a.message.dispatch("a.state.end",c)})})):a.message.dispatch("a.state.end",c)})})}var s=[],n=[],x=-1,v=[];a.message.addListener("a.page.event.hash",m);a.message.addListener("a.message.clear",
...
l=b.include.translate,m=b.data,n=b.title,q=b.options,s=b.converter,u=b.hash,v=e.length,x=f.length;v--;)d.addCallback(k("css",e[v]));for(;x--;)d.addCallback(k("js",f[x]));if(!a.isNull(a.language)&&0<l.length)for(e=l.length;e--;)d.addCallback(k("json",l[e],function(b){for(var c in b)a.language.addTranslation(c,b[c],!0)}));a.isString(h)&&(h=a.state.helper.parameter.extrapolate(h,a.page.event.hash.getHash(),u),d.addCallback(function(b){b.setData("html",h);a.page.template.get(h,{},b.done,g)}));if(a.isString(m)||
a.isObject(m))if(a.isObject(q)||(q={type:"json"}),a.isString(q.type)||(q.type="json"),a.isString(m))d.addCallback(t(null,m,q,u));else for(var C in m)a.isObject(m[C])&&a.isString(m[C].url)?(a.isObject(m[C].options)||(m[C].options={type:"json"}),d.addCallback(t(C,m[C].url,m[C].options,u))):d.addCallback(t(C,m[C],q,u));else d.addCallback(function(b){b.setData("data",{});b.done()});d.setSuccess(function(b){a.isNull(s)||s(b.data);a.isNull(n)||(n=a.state.helper.parameter.extrapolate(n,a.page.event.hash.getHash(),
